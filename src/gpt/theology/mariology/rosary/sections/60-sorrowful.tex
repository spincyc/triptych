...
St.~Cyril of Jerusalem applies Isaiah's ``I gave my back to the scourges'' to Pilate's scourging: the Passion is foreknown and freely endured (\emph{Catechetical Lecture} XIII.13). His witness supplies neither a wound count nor a warrant for concealing preventable abuse; it locates the imposed violence within Christ's voluntary saving obedience.
...
Popular devotions sometimes specify a number of lashes or detailed wounds from private revelations. Scripture and universal doctrine do not establish such counts. They must not be presented as historical facts necessary for fruitful meditation. The evangelical reserve is itself a discipline: adore the person and repent of cruelty rather than consume suffering as spectacle.
...
Calvary is the center toward which the preceding mysteries move. Jesus is executed by Roman authority after a process involving particular leaders and crowds. No collective or transhistorical guilt can be placed upon the Jewish people; sinners of every age are implicated through sin, and the Church condemns attempts to make Jews indiscriminately responsible (CCC 597--598).
