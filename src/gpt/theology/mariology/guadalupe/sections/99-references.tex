\section{Documentary and Bibliographic Guide}

The entries below identify the principal witnesses actually used. Web resources were rechecked on 16 July 2026 unless another date is stated. A link supplies access, not an endorsement of every claim elsewhere on the host site. The research records accompanying this monograph give claim-level uses, limitations, and rights notes.
...
\subsection{Citation and translation note}
