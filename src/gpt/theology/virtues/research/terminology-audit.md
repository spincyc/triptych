# Defect--Excess Terminology Audit
...
This is a lexical and relational audit, not a claim that every virtue is a
...
not received independent philosophical, classical, or theological review.
There are no project-created translations of extended source text here.
Isolated renderings and qualifiers are recorded so that a later reviewer can
reverse a lexical decision without reconstructing the research.
...
- **Mean flank**: the source analyzes the virtue, or its act, between opposed
  departures from a rational measure.
- **Named contrary**: the source names an opposed habit, vice, or characteristic
  failure, but does not thereby provide both flanks of a quantitative mean.
- **Objective justice outcome**: loss, gain, shortfall, or surplus belongs to
  the equality between parties; it is not automatically a vice habit in the
  party receiving the outcome.
...
named imprudence as a contrary and craftiness as a counterfeit.

Source accuracy overrides globally unique English labels. Exact historical
terms such as **imprudence**, **irreligion**, **disobedience**, and
**ingratitude** are retained even though they are privative formations.
Likewise, **cruelty** may recur where the sources use it under different formal
...
- **[editorial warning]** describes a recognizable danger when no dedicated
  source vice exists; it is not printed as a source-coined vice.
- **[counterfeit gloss]** names the changed object or end in concise editorial
  English.
- **[translation]** or **[transliteration]** identifies a short rendering of
  attested Greek or Latin vocabulary.
- **[act description]** identifies a departure in an intellectual act rather
  than a vice habit.

The physical defect and excess columns do not force every row into arithmetic
...
### Other strict moral virtues with secure provenance
...
These seven records control the separate qualified table. They do not add
seven coordinate habits to the strict count.
...
The following terms do not add rows to either appendix table:

| Matter or alias | Control |
| --- | --- |
| bodily decorum | Latin *modestia in exterioribus motibus corporis*, STh II--II, q. 168, a. 1. It is a specified matter under modesty. The source describes departures from reason and custom but supplies no canonical two-flank nouns. |
| modesty in dress | Latin *modestia in exteriori apparatu*, STh II--II, q. 169. Excessive care, culpable neglect, intention, and custom do not reduce to one dedicated pair. |
| purity | Latin *pudicitia*, STh II--II, q. 151, a. 4. It expresses a circumstance of chastity, especially outward signs of sexual union, and is not a distinct virtue row. |
| sobriety | It is a coordinate subjective species of temperance concerning drink, STh II--II, q. 143, a. 1 and qq. 149--150. It must not be nested beneath abstinence, whose object is food. |
| mercy | It follows the four cardinal families in the residual strict-moral section. Its treatment among effects of charity does not make it theological. |
| unnamed ordinary-honor mean | It is an independent Aristotelian mean in the residual strict-moral section. Aquinas's discussion near magnanimity does not make it a potential part of fortitude. |

## Collision and polysemy ledger

### Presumption

Latin *praesumptio* occurs in materially different relations. STh II--II,
q. 21 treats presumption opposed to theological hope; q. 130 treats presumption
relative to a person's capacity. The appendix therefore prints **salvific
presumption** and **presumption concerning capacity**, with both qualifiers
marked editorial. Neither should be shortened to bare *presumption* where the
two rows can be confused.

### Cruelty, brutality, vindication, severity, and clemency
...
Aristotle leaves the mean concerning ordinary honor unnamed, even though
*aphilotimia* and *philotimia* can receive praise or blame according to the
speaker's intended measure. Aquinas calls rightly ordered love of honor
*philotimia* a virtue. The source difference is preserved rather than
harmonized: the strict row's virtue remains **unnamed mean concerning ordinary
honor**, while the note records Aquinas's affirmative naming.

### Mercy, piety, and the gift of piety

Latin *misericordia* is mercy at another's misery. Latin *pietas* in the
justice family is the debt owed to parents and country; *pietas* can also name
a gift of the Holy Spirit. The publication must qualify these senses whenever
more than one is in view.

### Friendship and affability

Aristotle's mean in ordinary social intercourse resembles friendship but is
not complete character friendship, NE IV.6. Aquinas calls the annex *amicitia
quae dicitur affabilitas*. **Affability** is therefore the strict justice
annex, while **complete character friendship** remains a qualified reciprocal
relation.

### Modesty, shame, and sexual reserve

English *modesty* can render Aquinas's broad annex *modestia*, a mean-like
sense of shame, or current speech about dress and sexual reserve. Only the
...
Continence is a qualified imperfect state in which reason resists a
still-disordered appetite. Abstinence regulates food, sobriety regulates
drink, and chastity regulates sexual appetite. “Self-control” may gloss
continence, but it cannot replace all four formal objects or make sobriety a
subpart of abstinence.

## Rejected or restricted preferred labels

| Rejected or restricted label | Reason and permitted use |
| --- | --- |
| “too little” or “too much” plus a virtue name | It fabricates symmetry and encourages an arithmetic reading. It may occur in explanatory prose, not as an appendix term. |
| a universal ban on privative forms | It would suppress exact terms including imprudence, irreligion, disobedience, and ingratitude. Source accuracy controls instead. |
...
## Translation witnesses and rights boundary

The Greek loci are keyed to Aristotle's *Nicomachean Ethics* and *Eudemian
Ethics* by book and chapter so that they can be checked in a critical Greek
text. English alternatives were compared principally with W. D. Ross's
identified translation of the *Nicomachean Ethics* (1925), the working witness
documented in the source audit. H. Rackham's identified translation (1934) in
the [Perseus witness](https://www.perseus.tufts.edu/hopper/text?doc=Perseus%3Atext%3A1999.01.0054)
was consulted on 2026-07-16 only as a lexical comparator. This audit
incorporates no extended passage from it and makes no claim that its online
presentation is project-licensed.

The Latin loci are keyed to the *Summa theologiae* and can be checked in a
critical Latin witness. English alternatives were compared with the English
Dominican Province translation, second and revised edition (1920). Augustine
is cited by work and internal division where his terminology materially
governs a row; the source audit, not this lexical table, controls the exact
edition and any quotation.

Isolated ancient terms, names, and short translation alternatives are evidence
and are not presented as project-owned source prose. No external translation
is incorporated here in a quantity that could function as a substitute for
the source. Any later verbatim quotation must record its edition, translator,
locus, and rights status in the source audit.

## Internal verification dispositions and residual review limits

1. The strict tables above contain exactly fifty-two controlled IDs: three
   theological, eight prudential, seventeen just, seven fortitudinous, eleven
   temperate, two other strict moral, and four intellectual entries. The
   qualified table contains exactly seven IDs. This is an entry-and-dossier
...
3. The Greek entries use simplified Latin-script transliterations. Their
   ...
   remains unnamed in Aristotle; shame and righteous indignation remain
   qualified.
