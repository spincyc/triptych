...
\virtuedossier
  ...
  {\textbf{Paltriness} spoils a great work by spending beneath its fitting scale or attending to petty savings (\oppositioncode{M}). It is the terse English control for Latin \emph{parvificentia}; “meanness” is a historical alternative with thinner modern precision.}
  {\textbf{Waste} is the terse rendering of Aquinas's \emph{consumptio}; Aristotle's \emph{banausia}/\emph{apeirokalia} adds the connotation of vulgar or tasteless display (\oppositioncode{M}). Both exceed proportion to work, person, and end.}
...
\virtuedossier
  {Perseverance}
  {Annexed virtue of fortitude; Aristotle, \emph{Nicomachean Ethics} VII.7 and VII.9 by analogy and boundary; ST II--II, qq.~137--138.}
  ...
  {\textbf{Softness} (Latin \emph{mollities}) abandons the good because one cannot bear ordinary toil or loss of pleasure (\oppositioncode{M}). Yielding under an unusually overwhelming pressure does not by itself establish this vice.}
...
\begin{studybox}{\emph{Mollities}: one word, distinct classifications}
Aristotle's \emph{malakia} concerns failure to withstand pains that most people
can bear; nature, illness, and extraordinary intensity delimit that comparison.
Aquinas's \emph{mollities} in ST II--II, q.~138 receives this endurance
background as the defect opposed to perseverance. Aristotle's separate
discussion in VII.9 also prevents persistence from becoming stubborn adherence
to a false judgment.

The Greek plural \emph{malakoi} in 1~Corinthians 6:9, the Vulgate
\emph{molles}, and historical English renderings belong to a vice-list whose
translation history is disputed; verse 11 immediately turns to washing,
sanctification, and justification. Aquinas's commentary gives the term a
sexual reading there. In ST II--II, q.~154, a.~11 he again uses
\emph{mollities}, this time as an alternative name for one specifically
classified noncopulatory act within his account of lust. Neither use is the
perseverance defect of q.~138 merely because the Latin resembles it.

Penitential witnesses are likewise heterogeneous: one checked tariff uses
\emph{mollis} sexually, while another uses \emph{mollities} for inability to
bear an assigned fast. These philosophical, exegetical, moral-theological, and
juridical uses must not be fused into one transhistorical category. None
licenses labeling a person or group, inferring culpability from appearance or
one act, or mapping the historical vocabulary directly onto modern orientation,
gender, disability, temperament, or diagnosis.
\end{studybox}
