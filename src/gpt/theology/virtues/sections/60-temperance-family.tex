...
\virtuedossier
  ...
  {Chastity is not simply non-activity, bodily intactness, repression, or one vocation. Married and unmarried chastity have different fitting acts under one virtue. ``Purity'' in ST II--II, q.~151, a.~4 is not a second coordinate virtue. The distinct use of \emph{mollities} in q.~154, a.~11 belongs to Aquinas's historical classification of acts; it is neither q.~138's perseverance defect nor an identity label.}
