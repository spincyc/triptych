...
\aftermathfield Francis extended faculties for sacramental absolution in \emph{Misericordia et misera} 12 (2016), and the 2017 marriage-faculty letter still described the ``objective persistence'' of the Society's canonical irregularity; these particular faculties did not themselves supply full canonical status or a doctrinal settlement. On 13 May 2026 the DDF prefect stated that announced episcopal ordinations lacked the requisite papal mandate and, if carried out, ``will constitute'' a schismatic act, recalling the consequences of formal adherence. That statement is prospective: it does not itself establish that new ordinations occurred. No later dispositive Holy See status act was identified through 16 July 2026. The categories remain distinct: an act may be schismatic, a thesis may contradict primacy or indefectibility, and a person may be canonically irregular without every object becoming ``heresy.''
\end{heresydossier}
