...
- `make check-metadata` passed. The later 16 July 2026 exact-snapshot authorization bound the historical PDF hash recorded below and permitted the release manifest to distribute only those exact bytes; it did not change the article's source-audit or independent-review limitations.
...
- Reader-order production review completed on 17 July 2026: two settled `pdflatex` passes produced a 40-page PDF; the final log is free of fatal errors, undefined references, overflow, underfull boxes, and other layout warnings; structured metadata, PDF structure, embedded and subset fonts, and extracted text passed inspection; every rendered page was visually reviewed; and the installed PDF was byte-identical to the reviewed build, SHA-256 `121204bfc9f321967602fc8c32aea91e638e178f157fc4832a64764ff117191f`. That snapshot is superseded.
