...
Graham John Wheeler's history of the precept confirms that multiple genealogy and its changing uses. This evidence warrants a concise clarification; it does not warrant presenting Crowley's 1904 wording as a demonstrated deliberate corruption of Augustine. No source checked establishes such direct borrowing. Nor does the historical record make ``satanic corruption'' a precise account of textual transmission. That phrase would collapse genealogy, religious classification, and Catholic theological judgment into one claim and would obscure more than it clarifies.

The theological difference can be stated without overclaiming the history. Crowley denied that ``will'' meant every passing appetite and interpreted it as a person's ``True Will.'' Yet his order still is not Augustine's Christian order. Augustine begins with the God who first loves, gives charity by grace, reveals the good, and thereby heals willing; Crowley's maxim places love ``under will'' within a Thelemic system that does not accept that Christian grammar of Creator, revelation, sin, grace, and beatitude. A Catholic analysis may therefore call the two orders incompatible, and may describe their word order as an inversion, without claiming that Thelema is simply identical with Satanism or presuming the culpability of its adherents.
