\section{Appendix A: Papal, Canonical, and Dicasterial Corpus}
...
The second table contains verified adjacent sources that materially frame the controversy but are broader in subject. It is intentionally not called a complete list of every papal allusion to secret societies. Full texts or official archival witnesses are linked in the references. The summaries identify operative content; they are not substitute promulgations.
