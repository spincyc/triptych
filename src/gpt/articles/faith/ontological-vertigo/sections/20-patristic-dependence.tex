...
To ask whether the cosmos can account for its own actuality is one thing. To hear that ``life does not arise from us'' is another. The patristic witnesses gathered here bring the question within the creature's own beginning, continuance, and search for God.

\subsection{Begun and continued by another}

Irenaeus says it with unusual directness. Against the claim that a soul must be unbegotten in order to endure, he distinguishes God, who alone is without beginning, from everything made. Created things begin and continue as long as God wills them to exist. The soul is not life itself but participates in life bestowed by God; ``life does not arise from us'' (\emph{Against Heresies} II.34.2--4). His immediate subject is the soul's duration, not a later scholastic theory of \latin{esse}. Still, the asymmetry is plain: continuance is conferred; the giver does not receive continuance from the recipient.
...
If the creature is wholly from God while God is not completed by the world, what kind of relation can bear ontological weight on only one side?
