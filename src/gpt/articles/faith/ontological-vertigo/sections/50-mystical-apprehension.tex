...
Augustine later distinguishes seeing the country from possessing the way to it. He had learned where the truth lay, but not how the knower could be healed to hold and inhabit what he had seen; that passage requires the humility of Christ and grace (VII.20.26--21.27). His conversion narrative goes beyond the metaphysical argument. It nevertheless marks this article's stopping point: apprehension can be true before the knower knows how the truth can become a life.
...
\item[Adoration] Consent takes form as reverence before and service of the first principle.
...
C.~S. Lewis makes the attentional point in modern terms: genuine humility ends habitual self-occupation (\emph{Mere Christianity}, III.8). Humility therefore begins with self-knowledge and ends by ceasing to make the self the horizon. It frees attention for adoration: for the further question of what reverence and service are due to the first principle. That question is not answered merely by having undergone arrest.
