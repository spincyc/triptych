\section{The Fork: Recoil or Adoration}

A truth can be known and still be held at arm's length. Then, without adding a new premise, it becomes impossible to treat as merely someone else's problem. Patristic and mystical writers describe this interval with unusual care.

The metaphysical judgment and the spiritual reception of it must still be distinguished. A contemplative experience cannot repair an invalid inference, and no particular sensation is promised to one who understands the argument. The witnesses below illuminate what apprehension may be like; they do not make it true.
...
Augustine later distinguishes seeing the country from finding the way to it. He had learned where the truth lay, but not the way by which the knower could be healed to enter and remain in the country he had seen; making that passage requires the humility of Christ and grace (VII.20.26--21.27). His conversion narrative goes beyond the metaphysical argument. It nevertheless marks this article's stopping point: apprehension can be true before the knower knows how the truth can become a life.

\begin{studybox}{The fork in slow motion}
...
\item[Adoration] Consent takes form as reverence before the first principle and service rendered to him.
...
C.~S. Lewis makes the attentional point in modern terms: genuine humility ends habitual self-occupation (\emph{Mere Christianity}, III.8). Humility therefore begins with self-knowledge but matures into freedom from making the self the horizon. It frees attention for the question proper to adoration: what reverence and service are due to the first principle? Arrest alone does not answer it.
