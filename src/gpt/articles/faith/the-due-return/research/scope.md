...
The published argument opens with Psalm 116's impossible-return question but does not immediately interpret the psalmist's response of reception, invocation, vows, thanksgiving, and public worship. That paradox remains live through the Pauline denial of repayment and returns only after the discussion of grace and creaturely agency. The article does not display the formal governing thesis as reader-facing front matter. That thesis remains below as a research and audit control.

Each substantive section inherits an unresolved problem and begins from a human question, scriptural image, concrete objection, or recognizable phrase before introducing technical distinctions. Its conclusion supplies only the discovery earned there or exposes the next pressure; interrogative headings are varied with declarative and imagistic ones so the device does not become mechanical. This conversational design changes neither authority levels nor claim boundaries. Exact sources, claim-local qualifications, the current-law example, and the formal terminal apparatus remain controlling.
...
- Before a creature exists, its existence is not antecedently owed to it.
- Once a rational creature exists from and for God, worship and morally ordered action are due from it.

Neither proposition makes creation a contract. The due is not equivalent repayment or a benefit supplied to God. It is the fitting order of a rational creature's acts to its first principle, last end, and fellow creatures.
...
The following ordered grammar is project synthesis, grounded in the identified metaphysical, moral, and legal sources:

| Term | Controlled meaning |
| --- | --- |
| Dependence | What is true whether or not the creature consents; ontological reception is not a statute or achievement. |
...
- **What is owed can be freely loved. What is freely loved does not cease to be owed.**

## Legal scope and currentness

- Governing body of law: 1983 *Codex Iuris Canonici* as amended, universal law of the Latin Church.
- Promulgating authority: John Paul II, apostolic constitution *Sacrae disciplinae leges*, 25 January 1983; later competent amendments where applicable.
- Authoritative text: official promulgated Latin and applicable later Latin legislation. Holy See-hosted English pages are working reference renderings, not a replacement for the official text.
- Jurisdiction and persons: Latin Church only (CIC c. 1); merely ecclesiastical laws ordinarily bind those baptized in or received into the Catholic Church who have sufficient use of reason and have completed seven years unless the law provides otherwise (c. 11).
- Geography: universal law only. No episcopal-conference territory, diocese, parish, institute, or Church *sui iuris* is selected.
- Principal current canons: CIC cc. 1, 7–22, 85–93, 912–923, and 1244–1248.
...
5. Special obligations of clergy, religious, members of societies of apostolic life, officeholders, or those bound by vows or constitutions.
6. Remote, broadcast, or streamed participation and unusual liturgical situations.
7. Questions of Eucharistic reception, sacramental disposition, intercommunion, irregular status, or denial of Communion.
8. Canonical penal attribution or any claim that ordinary failure under c. 1247 is by itself a specified canonical delict.
...
1. Scripture is read at exact locus and within covenantal, Pauline, and Johannine contexts; short wording is checked against the Holy See-hosted NAB witness.
...
1. Divine non-need does not make worship fictitious or optional. Worship acknowledges real divine excellence and orders the worshipper to truth.
...
9. Sunday Mass participation and Sunday rest are separate duties in c. 1247; their excuses are not mechanically identical.
...
- Completed for the current source: profile routing; exact-locus Scripture, patristic, Thomistic, catechetical, conciliar, and universal Latin current-law audit; jurisdiction, authority, culpability, and negative-claim boundary drafting; rights review; source-consistency review of the delayed Psalm 116 ring; and trilogy-wide dramatic-architecture and series-coherence review.
- Production state: the present source received repeated settled builds; clean log, PDF-structure, embedded/subset/Unicode-font, metadata, extracted-text, and pagination checks; correction of a sparse final spill page; and a forced deterministic rebuild. The resulting 14-page build PDF has SHA-256 `09c8bd4cd51ef25a885a25b3ad8bd5e97ad1628425a9b389000e4af7fbaf3556`. Fresh bounded-raster and all-page visual review remains outstanding. The artifact remains under `build/` only and has not been installed or release-cleared; the predecessor remains the installed PDF.
