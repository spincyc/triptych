\section{When the Giver Commands}

\subsection{The command begins with deliverance}
...
The obligation to worship does not by itself tell a reader which day and liturgical act current law requires, whom it binds, what exceptions it recognizes, or which authorities are competent. Metaphysics establishes no hidden canon. Which part of an observance belongs to moral substance, which to revelation, and which to ecclesiastical determination? Until those are separated, ``I have to'' remains dangerously imprecise.
