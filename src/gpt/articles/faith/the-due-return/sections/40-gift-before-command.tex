...
This is the first example of a pattern that will govern the legal analysis. A general moral due can be stable while its revealed and juridical determination requires additional sources. The obligation to worship does not by itself tell a reader which day, liturgy, subjects, exceptions, and competent authorities current law identifies. Metaphysics establishes no hidden canon. The due becomes concrete through several ordered forms of law.
