...
Participation in a Mass celebrated in any Catholic rite on Sunday or the preceding evening satisfies the Mass precept (c.~1248 \S1). Reception of Holy Communion is a distinct sacramental and juridical question; the Sunday precept does not require reception at every Sunday Mass. Serious reason, impossibility, and competent dispensation are also real. The \emph{Catechism} names illness and care of infants as examples of serious reason; the Code treats impossibility and permits competent dispensation or commutation in defined circumstances (CCC 2181; CIC cc.~1245 and 1248 \S2). None of these distinctions is self-dispensation, and no general article can decide facts it does not possess.
