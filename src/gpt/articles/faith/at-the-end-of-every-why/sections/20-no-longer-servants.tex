...
Obligation can still be experienced as alien even when the intellect recognizes the good it protects. Charity does not remove the command. It begins to remove the distance between the will and the good. The friend obeys because, by grace, the command now points to a good already beginning to be loved.
