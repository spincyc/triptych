...
structure. Permit ten new content-word lookups per five hundred words on the
first local capstone and five on the delayed second capstone. A repeated
lookup of a word already in the ledger counts twice. Proper names do not count,
but failing to identify their case does. The separate terminal transfer gate
sets its own aid conditions.
...
Record each domain separately during practice. Exact sampling floors and the
two selected capstone assignments belong to the post-worksheet assessment,
where a failed domain directs remediation rather than disappearing into an
average. Familiar teaching material may diagnose a skill, but it cannot prove
the unfamiliar transfer required by the separate EL-GATE-III publication.
\end{courseunit}
