...
\newcommand{\ModuleSessionOne}{Build the gift-and-sign role grid and complete Worksheet III.13.}
\newcommand{\ModuleSessionTwo}{Compare genre expectations, complete Worksheet III.16, and justify reference and semantic-role decisions from the Latin.}
\newcommand{\ModulePrintedPractice}{Worksheets III.13 (gift, sign, and antecedent, Variant A) and III.16 (genre discrimination, Variant D), with terminal keys}
...
\newcommand{\ModuleReferenceFocus}{\begin{itemize}
  \item offered gift, sign, reception, present effect, and future fruition;
  \item antecedent tracking through gender and number;
  \item perfect, present, and future orientation in prayer prose; and
  \item sacrificial and reception vocabulary recorded by construction.
\end{itemize}}
\newcommand{\ModuleContrast}{Genre supplies a hypothesis about a prayer's movement; only printed forms, dependencies, and local vocabulary establish the actual analysis.}
