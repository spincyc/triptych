...
\newcommand{\ModuleSessionOne}{Diagram the Preface frame and complete Worksheet III.29.}
\newcommand{\ModuleSessionTwo}{Trace Canon commands, objects, predicates, and destinations in Worksheet III.32, then explain how the printed period suspends and resolves.}
\newcommand{\ModulePrintedPractice}{Worksheets III.29 (Preface frame, Variant A) and III.32 (Canon command and destination, Variant D), with terminal keys}
...
\newcommand{\ModuleReferenceFocus}{\begin{itemize}
  \item predicate frame plus anticipated infinitive or substantive act;
  \item relative chain, main petition, and coordinated object series;
  \item predicate accusatives and command plus passive infinitive; and
  \item destination expressed by contrasting uses of \Latin{in}.
\end{itemize}}
\newcommand{\ModuleContrast}{A long period is not a sequence of independent phrases. Its rhetorical suspension can be described only after the grammatical completion and every dependent have been found.}
