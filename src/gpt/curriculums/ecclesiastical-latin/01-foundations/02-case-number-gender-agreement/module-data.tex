...
\newcommand{\ModuleSessionOne}{Learn the case map and the difference between morphology and function, then complete Worksheet I.5 as the guided application.}
\newcommand{\ModuleSessionTwo}{Retrieve the syncretism decision tree, apply agreement and government without English cue-word guessing, complete Worksheet I.8 independently, and record each deciding rule.}
\newcommand{\ModulePrintedPractice}{Worksheets I.5 (guided Variant A) and I.8 (independent Variant D), with terminal keys}
...
\newcommand{\ModuleReferenceFocus}{%
  \begin{itemize}
    \item nominative, genitive, dative, accusative, ablative, and vocative core functions;
    \item case, number, and gender as morphological coordinates distinct from clause function;
    \item agreement in case, number, and gender, even when noun and adjective use different endings; and
    \item government by a verb, adjective, preposition, or construction.
  \end{itemize}}
\newcommand{\ModuleContrast}{Case is a form category; function is the form's work in its clause. An English cue such as \English{of}, \English{to}, or \English{with} may suggest a question, but only the Latin construction and ending establish the analysis.}
