...
\newcommand{\ModuleSessionOne}{Build factual-versus-characteristic evidence-scale pairs and parse every relative pronoun's case, then complete Worksheet II.37 as the guided application.}
\newcommand{\ModuleSessionTwo}{Separate characteristic from relative purpose, cause, and concession in context, compose contrasting clause types, and complete Worksheet II.40 independently.}
\newcommand{\ModulePrintedPractice}{Worksheets II.37 (guided Variant A) and II.40 (independent Variant D), with terminal keys}
...
\newcommand{\ModuleReferenceFocus}{%
  \begin{itemize}
    \item factual relative clauses versus clauses characterizing a class or kind;
    \item negative, indefinite, or class-defining antecedents as characteristic evidence;
    \item relative purpose, cause, and concession; and
    \item relative-pronoun antecedent agreement and internal clause case before use classification.
  \end{itemize}}
\newcommand{\ModuleContrast}{Indicative commonly asserts a fact about an identified referent; subjunctive can characterize a kind or express another dependent relation. Mood is evidence, but antecedent type, governor, and discourse relation remain necessary.}
