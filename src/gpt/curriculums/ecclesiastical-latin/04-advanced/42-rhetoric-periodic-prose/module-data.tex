...
\newcommand{\ModuleSessionOne}{Diagram a complete period and complete Worksheet IV.14.}
\newcommand{\ModuleSessionTwo}{Analyze an unfamiliar chant and prayer in Worksheet IV.16, connecting each figure to syntax and function without overclaiming.}
\newcommand{\ModulePrintedPractice}{Worksheets IV.14 (period diagram, Variant B) and IV.16 (rhetoric gate, Variant D), with terminal keys}
...
\newcommand{\ModuleReferenceFocus}{\begin{itemize}
  \item anaphora, parallelism, antithesis, tricolon, climax, chiasm, and hyperbaton;
  \item finite spine, subordination, suspension, resolution, and framing order;
  \item sound or rhythm described cautiously from observable form; and
  \item figure, grammatical proof, development, and local function.
\end{itemize}}
\newcommand{\ModuleContrast}{A rhetorical label is not analysis. The reader must identify exact corresponding forms, prove their syntax, and show what their arrangement contributes in this sentence.}
