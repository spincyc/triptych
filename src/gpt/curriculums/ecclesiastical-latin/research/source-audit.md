...
The canonical THOM-LEON4 transcription preserves the source comma after
*salutem*. The shared course macro omits that comma under its declared
punctuation normalization; it is received normalized text rather than a
diplomatic reproduction of the Leonine page.
