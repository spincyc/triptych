...
eucharistic horizon for the whole, without making every use of bread in the
readings an exhaustive sacramental definition.

\subsection*{Two alternative endings}
...
protection and eternal redemption, but they do so differently. Both are printed
options, mutually exclusive rather than one sequence.
