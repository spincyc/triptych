...
\begin{studybox}{The question beneath the readings}
...
the same night; Colossians locates life in the risen Christ. Those distinctions are the measure of every later reading.
\end{studybox}
...
received enjoyment as gift; this cut therefore does not condemn work or created pleasure absolutely. It condemns their conscription as
guarantees against mortality.

The discontinuous lection also creates a risk: the refrain can swallow the
specific labor argument. The lection holds both: everything cannot be mastered, and here the concrete proof is work transferred beyond the
worker's control.
...
Christological horizon. His numerical constructions are his own, not definitions of the psalm's Hebrew. The most important liturgical effect is
simpler: mortality does not make work worthless. It makes wisdom, mercy, and
divine establishment necessary.

The official occurrence page marks the response “(1)” beneath Psalm~90, but
the response words come from Psalm~95:8, not Psalm~90:1. Their imperative
“today” intensifies the numbered-days petition. The printed U.S. Lectionary, a
protected book, has not been collated at typography level, so whether it
carries the same marker is unverified.
...
self-enclosed abundance, but their reconstructed settings are theirs, not Luke's unnamed harvest.
...
slander, and abusive speech; unproclaimed, they still
belong to the passage's context. Greed is idolatry not because matter is evil but
...
and the kingdom. It is not reducible to involuntary material deprivation, and it blesses no condition that
denies food, housing, wages, or protection. Nor does “spiritual” poverty erase
the Gospel's material warning. The beatitude names humble receptivity before God; Luke tests whether
...
relational. Yet the two are alternatives, and neither proves an
...
attention, and isolation. The interior is Rembrandt's, not a record of first-century storage.
...
\begin{threestable}{Tension}{Resolution}{Distortion}
