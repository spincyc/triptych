...
The complete proper of \latin{DOMINICA NONA post Pentecosten},
\latin{II classis}, follows from the 1962 Vatican typical Missal, printed
pp.~388--389. Its Latin is collated against the facsimile. Scriptural
English is the public-domain
...
official translation of the 1962 book. Either may depart from the missal's
Latin; each departure is named at its element.
...
the psalm's opening causal particle. The doxology belongs to the Ordinary,
not to the psalm the Douay translates.}
...
not the English, therefore carries the petition's grammar.}
...
words, and the Douay has no English for the missal's addition.}
...
one continuous biblical sentence. The Douay--Rheims translates the psalm
continuously and has no stitched English for the cento, so its complete verses
stand above with the four fragments emphasized.}
