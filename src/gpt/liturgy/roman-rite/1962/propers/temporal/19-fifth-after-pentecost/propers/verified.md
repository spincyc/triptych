# Fifth Sunday after Pentecost — Verified Propers

## Provenance

- **Missal edition:** *Missale Romanum*, editio typica (Vatican City: Typis Polyglottis Vaticanis, 1962).
- **Printed formulary heading and rank:** `DOMINICA QUINTA post Pentecosten`; `II classis`.
...
- **Printed and digital locations:** the focused public OCR excerpt in `retrieved.txt` came from downloaded-text lines 57,975–58,121, with embedded page headers 377–378. The baseline facsimile places the formulary on printed pages 383–384, PDF pages 464–465.
...
- **Stored focused-excerpt SHA-256:** `0611201d71349f9bbda92f6ab311ffa8e5c920a42bf0edc88f7040b261f6695a` (`retrieved.txt`, with trailing whitespace removed).
...
**Reference:** Psalm 26:7, 9, with psalm verse 26:1 (Vulgate/Septuagint numbering; Psalm 27 in most modern Bibles).
...
**Reference:** Psalm 20:1 (Vulgate/Septuagint numbering; Psalm 21 in most modern Bibles).
...
**Reference:** Psalm 15:7–8 (Vulgate/Septuagint numbering; Psalm 16 in most modern Bibles).
...
**Reference:** Psalm 26:4 (Vulgate/Septuagint numbering; Psalm 27 in most modern Bibles).
