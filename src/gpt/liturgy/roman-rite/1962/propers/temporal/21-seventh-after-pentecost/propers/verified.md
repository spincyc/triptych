# Seventh Sunday after Pentecost — Verified Propers

## Provenance

- **Missal edition:** *Missale Romanum*, editio typica (Vatican City: Typis Polyglottis Vaticanis, 1962).
- **Printed formulary heading and rank:** `DOMINICA SEPTIMA post Pentecosten`; `II classis`.
...
- **Printed and digital locations:** the public OCR excerpt is stored in `retrieved.txt` and came from downloaded-text lines 58,289–58,424, whose embedded page headers are 380–381. The verification facsimile places the formulary on printed pages 386–387, PDF pages 467–468.
...
- **Stored focused-excerpt SHA-256:** `4f8027b9ae481b058318921f26e8768c4752d8c698b2b11d7be8b233835773c6` (`retrieved.txt`, with trailing whitespace removed).
...
Deus, qui legálium differéntiam hostiárum uníus sacrifícii perfectióne sanxísti: áccipe sacrifícium a devótis tibi fámulis, et pari benedictióne, sicut múnera Abel, sanctífica; ut, quod sínguli obtulérunt ad maiestátis tuæ honórem, cunctis profíciat ad salútem. Per Dóminum.
