...
The witnesses read the angelic promise itself in several ways. Basil treats
...
explanation begins with a created angel (pp.~91--92). Their readings
...
(PG~80:1639--1640). Hugh's Invitatory and Theodoret's Josiah give the psalm a
use and a voice; its composition Theodoret assigns to David.
...
(Ps.~33.9). Augustine therefore reads the tasting most directly as sacramental,
while the psalm's invitation remains wider than sensory pleasure.
...
Independent witnesses transmit the orations together. Wilson's
...
Augustine explains this through the divine physician. God may give
...
Its teaching on use and loss illuminates the Gospel that the two
arrangements share.
