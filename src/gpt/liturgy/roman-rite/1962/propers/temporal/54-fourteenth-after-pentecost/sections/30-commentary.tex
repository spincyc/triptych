...
attributes personal composition of these prayers (Wilson, introduction
...
W.~Holmes's SBLGNT v1.2 at Gal.~5:22--23 enumerates nine. Chrysostom's Greek text has nine;
...
penitence. His distinction between continence and chastity depends on that
twelve-term Latin list. The sermon labeled Fourteenth Sunday has Luke~17 and
...
words (\emph{Enarr. Ps.}~94 §§1--4). Hugh applies the verse morally to the
...
(PG~80:1639--1640). His Josiah setting gives the psalm a voice; its
composition he assigns to David. The praise sung before the Gospel calls the
...
treats temporal loss as a possible trial. He opens by reading the two
masters morally as reason and sensuality; Matthew names God and mammon. His
...
tasting at 2:3 and the psalm's ethical teaching at 3:10--12. Augustine
therefore receives the invitation at the offering explicitly as Eucharistic,
beside the other witnesses' distinct readings; its spiritual fruit is not
measured by bodily sweetness.
...
Those witnesses name no personal composer of the prayer.
