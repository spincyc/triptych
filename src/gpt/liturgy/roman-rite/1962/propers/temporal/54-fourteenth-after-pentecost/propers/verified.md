...
- **Identity and boundary:** `DOMINICA DECIMA QUARTA POST PENTECOSTEN`, `II
  classis`; marginal nos. 1572–1581 between the Thirteenth Sunday's
  Postcommunion and the Fifteenth Sunday heading. Green follows the general
...
### 1. Introit — Ps. 83:10–11, 2–3 — no. 1572
...
The antiphon stops in v. 11 before the lowest-place comparison. The psalm
