...
The formulary printed above gives its Latin as collated from the facsimile
images, not as normalized Bible Latin: the Introit retains
...
witnesses do not carry those differences.
...
the Son's obedient prayer. It does not define the final relation
...
Exodus 32 stands within the covenant narrative. Israel has received
...
sings the text she received, not its later Vulgate form.
...
English changes both order and agency, and the syntax traced above is the
Latin's alone.
...
crimes and sins. The Secret's positive claim therefore carries its full
weight. These offerings, taken into Christ's action, really are the
...
Across the propers, Moses has pleaded a prior promise for
