...
supplement XXXIIII, p.~174. Their headings and chant associations change
from witness to witness (see Source-Grounded Synthesis). Schuster's account of the Collect likewise
...
When prosperity and apparent injustice coexist, Bellarmine addresses what
can be seen, Augustine the conditions endured, and Theodoret the praise
offered continually. Their readings strengthen the Epistle's perseverance,
whose eternal harvest is not an immediate favorable outcome.
...
named gods (PG~80:1641A--1642A). His text thus agrees with the Missal's
form.
...
Gospel's particular mercy a universal horizon. Augustine's Psalm~46 exposition
and Theodoret's Psalm~94 lemma are distinct witnesses; neither gives a
...
joy (O'Sullivan's English, which omits philological discussion,
Psalm~XLVI, edition v.~2, p.~144). Aquinas distinguishes universal
dominion, eternal duration and authority over kings; God's transcendence
does not exclude his care of earthly affairs (\emph{Super Psalmo}~46,
n.~2, modern electronic Latin transcription, unit [87252]). These direct
expositions of the parallel clause give universal kingship concrete force:
the Lord whose mercy meets one mother also governs the whole earth.
...
Ambrose affirms the literal compassion for the widow before opening the
ecclesial reading. Her tears become Mother Church's intercession; the
touched wood signifies salvation through the cross, and the Church
intercedes for each sinner as for an only son (\emph{Expositio in Lucam}
V.89--92, continuous Latin transcription of the commentary). Bede develops
conscience awakened, compunction and visible renewed life. Return to the
mother explicitly becomes reunion with the Church's communion through
priestly judgment (II.7, PL~92:418A--D, continuous Latin transcription of
the commentary). His argument
...
that conclusion, and the Vatican edition is the typical one.
...
participation. He distinguishes the resurrection of all from the
blessed life of the holy: the gift given for the world assures no
recipient of beatitude automatically.
