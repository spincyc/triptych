...
voice received as gift while the narrator's silence stays unbroken: their
thanksgiving is their own participation in praise, not the boy's
unreported words recovered.}
...
Offertory praise; it does not set the narrative's unspecified speech
beside the worshipper's voice.}
...
(\emph{Super Galatas} 6.2) and Schuster on this Sunday
(III, pp.~139--141) offer temporal analogues; neither states the full
...
\pfield{What separate treatment misses}{How mercy attends to need that is
not only spoken: prayer, perception and
concrete assistance enter the same encounter. Thanksgiving beside
unreported words is a different question (the second proposal).}
...
own voice and the community's thanksgiving. Embodied attention and prayer
join here, and each keeps its own form.}
