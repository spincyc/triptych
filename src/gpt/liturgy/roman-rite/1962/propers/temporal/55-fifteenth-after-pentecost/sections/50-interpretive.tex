...
\pfield{What separate treatment misses}{Mercy here attends to need that is
not only spoken: prayer, perception and
concrete assistance enter the same encounter. Thanksgiving beside the
restored son's unreported words is a different question.}
