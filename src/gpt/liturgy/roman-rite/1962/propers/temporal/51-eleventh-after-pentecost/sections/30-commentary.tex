...
originally fixed Sunday interpretation. Within the named inspected loci, the
Veronese witnesses early forms of the other two orations separately, while the
Gelasian is the first witness checked here that joins the complete set. No
earlier source for the Collect is inferred from that bounded comparison.
...
confess. His inherited application of the deaf man to rejected Israel is not
adopted; \emph{Nostra aetate}~4 and the \emph{Catechism} §§839--840 govern the
present Catholic account of Israel.
