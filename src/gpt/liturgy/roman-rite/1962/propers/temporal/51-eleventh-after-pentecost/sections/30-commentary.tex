...
The antiphon is a liturgical centonization rather than a continuous biblical sentence. It joins the close of
...
Origen's homily on Psalm~67 follows the psalm's procession as the ascent of
Christ and of those whom he frees; Hilary sees the divine march from Egypt and
Sinai reach its ecclesial fulfillment; Augustine hears Christ arise and
unbelief yield before the Gospel. The Introit selects the fruit of that victory
before returning to the opening cry in its psalm verse. God's arising creates a
holy dwelling: alienation gives way to household, captivity to strength, and a
scattered multitude to a people.
...
wording. The Douay accordingly translates complete Clementine verses and has
no English for the chant's centonization.
...
and firmness of faith on the road to eternal reward. The two readings are
different, not a consensus. Both nevertheless forbid reading
``strength'' as domination by the gathered household. The divine power is the
life by which bodies rise, faith endures, captives go free, and the Church
becomes God's peaceable home. This prepares Paul's persecutor-made-apostle:
divine victory can conquer an enemy by incorporating him into the witness.
...
The verbs disclose the prayer's spiritual order. \latin{Excedis} names God's
transcendence over every reckoning of merit and desire; \latin{effunde} asks
that this superabundance descend as mercy; \latin{dimittas} seeks release from
the evil conscience fears; and \latin{adicias} asks for a positive increase the
creature could not originate. Pardon and perfection are one movement. The
sinner is not merely returned to a neutral balance but drawn beyond fear into
the good for which grace enlarges prayer.
...
alignment places it at the Eleventh. The set's Sunday therefore moved in
transmission and was not fixed from the first. Among the named loci, the
Veronese witnesses early forms of the other two orations separately, while the
Gelasian is the earliest checked witness that joins the complete set; none of
those loci shows an earlier source for the Collect.
...
sources support the conclusion that mercy does not merely erase a deficit but bestows a good
beyond the petitioner's measure. They do not
identify exactly what temporal good will be given or guarantee felt
consolation.

The Collect answers the Introit's house at the level of the soul. Concord is
not produced by denying conscience, and holiness is not achieved by confident
self-measurement. God forgives the feared debt and adds the unpresumed gift,
forming worshippers able to stand together before him. The Postcommunion will
name the added good sacramentally as the fullness of heavenly remedy for mind
and body.
...
and its first paragraph is itself a miniature rule of Christian tradition.
...
The repeated ``according to the Scriptures'' places the Pasch within God's one
economy with Israel rather than treating Resurrection as a marvel without
promise. ``For our sins'' gives the death its saving purpose; burial confirms
its reality; the third day declares divine victory; appearances establish that
the risen one entered the history and testimony of chosen witnesses. The
Corinthians are saved not by admiring the list but by standing in and holding
...
Chrysostom also preserves the ecclesial texture of the witnesses. Peter is
named first as the restored chief apostle; the five hundred prevent the event
from being reduced to a private vision; James and the apostolic body show the
same risen Christ gathering distinct ministries into one testimony. The women
who first receive the Easter announcement in the Gospels are not erased by
Paul's compressed list: it serves his Corinthian argument and does not claim to
narrate every appearance. The Church receives both canonical forms of witness.
...
scribal or explanatory form. The Missal's \latin{undecim} governs the Epistle
as this Mass reads it, and the Greek's ``twelve'' stands beside it in the
textual history. The appearances to James and ``all the apostles'' likewise extend beyond narrated
...
and its threefold analysis is one reading among the several that Paul's
metaphor attracts. All preserve the contrast between undeserved
calling and real apostolic witness. Paul does not hide that he persecuted the
Church, yet neither does he make remorse the last word. Grace makes him what he
is and sends him to preach what he once opposed. The Introit's enemies, the
Collect's accusing conscience, and the Epistle's persecutor thus meet within a
single economy of mercy: sin is judged truthfully, forgiven freely, and
overcome fruitfully in apostolic service.

The last sentence is cut within its verse. The liturgical lesson
...
grace transforming a persecutor and not becoming empty, while Scripture
states Paul's labor one clause later.

\subsection*{Gradual: help, renewed flesh, and feared silence\enspace\properrefs{Grad.}}

The Gradual reverses the psalm's order: v.~7 is sung before v.~1. Liturgically,
the answer is sung before the remembered cry. Its body
...
The added \latin{ne discedas a me} corresponds exactly to Clementine
Psalm~34:22. The Gradual therefore intensifies the fear expressed by silence:
the petitioner asks not only that God speak but that he remain present. Yet the
main verse has already confessed help. The chant holds memory and petition
together, so that renewed flesh does not abolish dependence and former help
becomes the ground of a new cry.
...
Theodoret preserves the literal-historical horizon. In his exposition of Psalm~27 he reads
David's recovered vigor after the dangers associated with Saul, Doeg, and the
Ziphites; the flourishing is restored health and courage. Augustine,
Cassiodorus, and Aquinas unfold the same words Christologically. Catholic
exegesis receives both senses in order: historical restoration grounds the
image, while its spiritual fullness is Christ's risen flesh and the members
who will flower in him. In the Mass, this resurrection hope moves toward Mark's
heavenward groan and effective word; after the Gospel, Psalm~29 will answer the
same \latin{clamavi} with \latin{et sanasti me}.
...
describing every word actually sung. The larger psalm remains integral to the
spiritual movement: Israel is delivered from bondage, commanded to hear, and
promised that God will fill the mouth opened toward him.
...
with human acts. Theodoret remains close to the historical festival and the
orchestra attested in Chronicles. The literal festal setting and the
moral-spiritual senses are complementary: created music truly praises God,
while its ordered harmony figures the union of the received Word with embodied
works. In the Sunday sequence, the Alleluia's audible praise precedes the
command that ears and tongue be opened. The Church sings because grace has
summoned her; she then hears how the Lord creates the hearing and speech her
praise requires.
...
The sequence of acts begins with the historical healing and opens naturally
into the Church's spiritual senses. Others bring the man;
...
man hears and speaks rightly. The bodily particularity manifests the Creator's
care for the person and the goodness of the senses. Because the same incarnate
Word heals body and soul, the historical restoration can bear ecclesial,
sacramental, and moral senses without ceasing to be a bodily good.
...
Gregory a privileged witness to received Sunday interpretation. His spiritual
reading is ordered upon Mark's concrete healing: the Spirit who signifies
through Christ's fingers opens the inner ear, divine Wisdom forms the tongue,
and Christian teaching becomes right when conduct gives it bodily credibility.
...
Its attribution is uncertain; it is not Jerome's secure work.
...
The Church's baptismal rites receive the gestures in another ritual register.
Ambrose, \emph{De mysteriis} I.3--4, and the traditionally Ambrosian
\emph{De sacramentis} I.1.2--3 (authorship disputed) describe the opening of
ears and nostrils through \emph{Ephpheta} so the candidate may hear and answer.
...
saliva and the command. Mark narrates a healing, not this later rite, and the
Mass's Gospel does not itself perform it.

Saint Anthony of Padua's sermon on this Gospel (§§3, 8--14) reads the two ears as hearing the Old
...
gestures, baptism, hearing, and confession. For Lawrence, the acclamation
recognizes in Christ the Creator who once saw that all he had made was very
good and who now restores creation through redemption. Fingers signify the
Spirit, saliva the savor of Wisdom, the upward gaze the descent of grace, and
withdrawal from the crowd the recollection in which the soul hears God. His
enduring moral truth is that every human heart requires grace to hear and
confess. His inherited application of the deaf man to rejected Israel differs
from the present Catholic account of Israel, which \emph{Nostra aetate}~4 and
the \emph{Catechism} §§839--840 govern.
...
joins this Gospel directly to the appointed 1~Corinthians~15:9--10: Christ does
not destroy the persecutor but remakes him by grace into an apostle. Romero
reads the concrete gestures within an integral healing of bodily, spiritual,
social, and eternal life, a line that reaches naturally toward the
Postcommunion's help of mind and body. Pope John Paul~II on 10 September 2000 reads \emph{Ephphatha} as
...
and together form no patristic consensus.

\subsection*{Offertory: the healed singer offers praise\enspace\properrefs{Off.}}

The Offertory takes two verses from an individual thanksgiving and answers the
Gradual with exact verbal force. There the Church sang \latin{Ad te, Domine,
clamavi}; here she sings \latin{Domine, clamavi ad te, et sanasti me}. Between
the cry and its answer stands Christ's healing word. Psalm~29
...
lets the assembly appropriate the healed man's wonder as thanksgiving while
the gifts are placed upon the altar.
...
Postcommunion's salvation of body and mind. Christology governs it:
...
death. The Offertory is therefore both eucharistic in the broad sense of
thanksgiving and paschal in its deepest object: the Church extols the Father
for upholding Christ's humanity from the grave and for promising the same
incorruption to his members.
...
Trinity Preface follows by rubric; it is not another variable proper but
belongs to the Ordinary.

The nouns describe the sacrificial relation. \latin{Servitus} is creaturely
worship; \latin{munus}, the oblation; \latin{subsidium}, aid returning from
divine acceptance to human weakness. The gift moves Godward as homage and
returns as remedy. Because \latin{propítius} names divine favor and both
results remain petitions under \latin{sit}, divine favor remains the source
of both effects.
...
transmission and real variation, not the prayer's author.
...
The Secret also binds the Pauline and sapiential movements. Grace did not
remain empty in Paul but issued in apostolic office; firstfruits will honor God
from the worshipper's substance. Here action and possession enter the altar as
service. Their truth is not denied, yet their acceptability and fruit are
received anew from God. The Church offers because grace has made her capable of
offering, and she receives help precisely through the service she renders.

\subsection*{Communion: firstfruits returned in justice\enspace\properrefs{Comm.}}
...
The early reception makes that moral formation concrete. A Greek catena
fragment transmitted under Origen's name interprets honor as sharing, rejects
wealth gathered by robbery and greed, and extends firstfruits from harvest to
virtue, waking prayer, and the day's first psalmody. \emph{Apostolic
Constitutions} IV.9.2 quotes both verses while directing righteous earnings to
food, clothing, captives, and the persecuted. Pseudo-Basil and
Pseudo-Chrysostom likewise insist that an offering taken from injustice cannot
honor God: restitution and mercy belong to the gift's truth before it reaches
the altar.

Bede, \emph{In Proverbia Salomonis} I on 3:9--10, gives three ordered senses. His
...
The substantially identical passage printed at PL~111:693C--694A is a
misattributed duplicate of Bede, not an independent commentary by Rabanus.
...
Christian tradition reads material abundance beside almsgiving, the
...
liturgical link, not a record of the Communion's first assignment.

Aquinas's treatment of firstfruits in \emph{Summa theologiae} II--II,
q.~86, aa.~3--4 gives the same structure doctrinal precision: only lawfully
possessed goods can be offered, and firstfruits confess that increase was God's
gift before it became human possession. At Communion this confession becomes
personal. The Lord honored from substance is the Lord sacramentally received;
the communicant's property, labor, virtue, and mercy are summoned into the same
self-return. Bede's heavenly barns lead directly to the Postcommunion's
fullness of heavenly remedy.

\subsection*{Postcommunion: one salvation of mind and body\enspace\properrefs{Postcomm.}}

The assembly asks that sacramental reception aid mind and body, save both, and
lead it to glory in the heavenly remedy's fullness. Cummiskey reverses the
Latin order to ``body and mind'' and renders \latin{plenitudine gloriemur} as
enjoying the remedy's full effect. Those features belong to the quoted
nineteenth-century witness, not to the Latin's movement from perception
through aid and salvation to glory.

\latin{Sentiamus} asks that sacramental fruit be known in lived effect, not
merely possessed by external reception. \latin{Tui perceptione sacramenti}
names Communion as the instrumental occasion; \latin{in utroque salvati}
holds the mental and bodily dimensions inside one saved person; and
\latin{plenitudine gloriemur} moves beyond present assistance into an
eschatological fullness already tasted as glory. The prayer is at once
sacramental, anthropological, and anagogical.
...
raising. Though Schuster writes long after the texts, the day's propers
match his reading closely: Paul's risen Christ, the Gradual's
...
Irenaeus supplies the deeper patristic grammar: created bread and wine become
Eucharist, nourishing flesh destined to rise, because Christ's own flesh and
blood communicate incorruptible life. The Postcommunion does not add a
disembodied spiritual sequel to the bodily Gospel. It gathers the real man
whose senses Christ restored, Paul's confession of the risen body, and the
Church's sacramental reception into the one salvation of the whole creature.
