...
It matches the identified CMAA facsimile, and its surviving pre-1962 text
keeps its received, unmodernized form. Scriptural
...
liturgical text. Where a chant differs from the Clementine text the Douay
translates, the Douay has no English for the difference, and the gap is named
at the element.
...
verses expose those differences and give no English for the composite antiphon.}
...
attain.'' The distinction between loving the command and attaining the
promise therefore rests on the Latin.}
...
to Ps.~88:51. The Missal nevertheless cites Ps.~73. The Douay gives
Ps.~73:22's own words.}
...
the NABRE, and Ps.~31:14--15 when the title is unnumbered. The Douay's English
therefore keeps ``my lots.''}
...
labour,'' and recasts both closing phrases. The Douay therefore gives the
complete biblical verse and has no English for the chant's form.}
...
noun implicit; the Latin keeps both.}
