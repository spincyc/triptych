...
\begin{massbox}{Source text, later reader, and 1962 sequence}
...
Three things therefore stay distinct at every stage: what the source text says
in its own literary setting; what a later reader adds; and what the 1962
sequence lets the assembled Church hear, a juxtaposition no checked witness
ascribes to a compiler.
\end{massbox}
...
\begin{threestable}{Reception}{What it contributes}{What it does not supply}
