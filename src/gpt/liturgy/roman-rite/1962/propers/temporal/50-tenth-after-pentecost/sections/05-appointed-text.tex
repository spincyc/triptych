...
thee. Hear, O God, my prayer, and despise not my supplication.
\end{fulltextenglish}
\fulltextgap{The English prints all of verse 19; the chant keeps only
\latin{ab his qui appropinquant mihi}.}
...
\end{fulltextenglish}
\fulltextgap{The English prints the complete source verse; the chant omits
both ``then''s and the calves and adds \latin{Domine}, and the Douay has no
English for the antiphon's form.}
