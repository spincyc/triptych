...
Status: **bounded Low-Mass core alpha with books-and-supports family**
...
smaller: it renders ten source-audited records already present in the
...
1. Compact Alpha title and exact ten-object boundary.
...
10. Source notes, scope and qualifications, generation metadata, and rights
   colophon.
...
and Lavabo objects, Communion plate, vesture, sung or
