...
particular throne arrangement. The Lavabo basin and towel enter as ordinary supporting
...
ornament, dimensions, or a universal handwashing arrangement. The three altar cloths enter as ordinary altar
...
markings, folds, edge drop, or arrangement. The incense boat and spoon enter as ordinary supporting
objects rather than pontifical insignia or distinct pontifical forms. Their
...
source-bounded four-chain figure and non-operational safety note prescribe no
material, ornament, handoff,
...
insigne, a distinct pontifical form, or an operating method.
...
handle, left-right arrangement, or Latin headword.
...
one-handle morphology is a dated exemplar, and its isolated figure avoids
duplicating the separately admitted priest's paten.
...
unlit, footless figure retains a non-operational safety boundary. The processional cross now enters only as an ordinary
...
cross-or-image alternative and the bell's local-practice boundary.
...
creating a morphology, transfer, or handling prescription.

The Epistle and Gospel books enter as ordinary supporting books, not
pontifical insignia or distinct pontifical forms. Their exact-source
TeX-native graphite symbols teach only
