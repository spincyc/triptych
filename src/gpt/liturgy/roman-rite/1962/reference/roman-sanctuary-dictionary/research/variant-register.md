...
material difference in construction, identification, ritual use, status, or
handling. Ornament, fabric pattern, workshop style, or incidental proportions
alone do not create a substantive variant.

| Candidate family | Question to resolve | Evidence required | State |
| --- | --- | --- | --- |
| Chasuble forms | Which named forms are materially distinct and historically appropriate at the 1962 horizon? | Dated construction evidence plus competent liturgical status evidence | Unreviewed lead |
| Mitre forms | Which varieties differ in rank, ceremony, or use? | Pontifical/ceremonial loci and dated morphological references | Unreviewed lead |
| Chalice, ciborium, and monstrance forms | Which shapes aid identification without implying ritual difference? | Material-culture evidence; separate ritual-use evidence | Unreviewed lead |
| Dalmatic and tunicle | Which visual distinctions are stable, and when are terms or forms interchangeable? | Official terminology plus dated textile evidence | Unreviewed lead |
| Surplice, cotta, and rochet | Which construction, rank, and use distinctions are material? | Ceremonial and jurisdiction-specific evidence | Unreviewed lead |
| Pall construction | What forms are substantively distinct rather than decorative? | Rubrical/ceremonial and textile evidence | Unreviewed lead |
...
Parent object ID; variant ID; preferred names; distinguishing features;
status; period; ceremonies; source loci; evidence state; artwork IDs;
confusables; and explicit reason the distinction is substantive.
