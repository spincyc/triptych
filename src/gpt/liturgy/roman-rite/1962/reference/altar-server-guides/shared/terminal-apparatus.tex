...
\begingroup
\ifLowMassGuide\footnotesize\else\scriptsize\fi
...
\columnbreak
\TerminalNote{Authority, training, and alpha state}{This is an Alpha study and
rehearsal aid, not an official liturgical book, parish directive, certificate
of competence, or statement of present authorization. Alpha records the
publication gate for this snapshot; it does not mean final, complete, official,
or ecclesiastically approved. The priest and master of ceremonies govern the
actual function. \GuideSafetyStatement}

\TerminalNote{Rights}{Project-created teaching matter falls within the
