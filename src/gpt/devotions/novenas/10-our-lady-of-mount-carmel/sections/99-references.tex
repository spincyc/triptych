...
\item Kenelm Digby Best, C.O., \textit{A Priest's Poems} (Burns \& Oates; Benziger Brothers, 1902), p.~136, for the public-domain English short \textit{Flos Carmeli}. Best supplies only the first two stanzas. No complete English witness with both adequate provenance and clear reuse rights was located.
\end{itemize}

\subsection{Editorial boundary}

The nine daily Latin collects, common Latin formulas, feast collect, and \textit{Flos Carmeli} are received third-party texts and are not relicensed under the project's CC BY 4.0 license. The daily collects are reproduced devotionally from the 1987 \textit{Collectio}; their abbreviated endings are completed with the exact governing formulas in GIRM 54, and their approved 2012 English is cited but not reproduced. The printed English prayers are received public-domain texts from Lefebvre and Best. No project-authored or project-translated vocal prayer remains. No facsimile, OCR layer, modern proprietary English Missal, Office, ritual, Carmelite proper, or Bible translation is incorporated. This guide has received no imprimatur, Carmelite authorization, liturgical approval, enrollment faculty, or independent specialist review.
