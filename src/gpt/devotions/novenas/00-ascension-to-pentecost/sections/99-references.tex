...
\item \textit{Missale Romanum}, editio typica (Vatican City: Typis Polyglottis Vaticanis, 1962): Easter Thursday, p.~336; Sunday after Ascension, p.~353; Pentecost Tuesday and Ember Wednesday, pp.~360--361; Ember Friday, p.~365; Ember Saturday's shorter form, p.~370; Annunciation, p.~495; \textit{Orationes diversae} 29, p.~[113]; and \textit{Pro fidei propagatione}, p.~[86], \sourceurl{https://media.churchmusicassociation.org/pdf/missale62.pdf}{typical-edition facsimile}. These govern the nine daily prayers; their standard conclusions are supplied in full.
\end{itemize}
...
English prayers are public-domain received forms or project translations. Caswall's 1849 hymn translations are public domain, not approved liturgical translations. The nine daily Latin collects come from the 1962 \textit{Missale Romanum}; they are reproduced devotionally with project English translations, and their historical approval does not extend to this arrangement. The project license covers the translations, selection, arrangement, and exposition, not the third-party Latin. Indulgence history and current claims follow the fourth \textit{Enchiridion}, checked 13 July 2026. This guide has received no imprimatur, liturgical approval, or independent specialist review.
