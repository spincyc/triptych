...
% Generation provenance is stored in each document leaf and rendered through
% these shared commands.  The separate contribution command permits a future
% document to retain materially different model/runtime contributors without
% duplicating or weakening known qualifiers.
\newcommand{\AIGenerationDate}[1]{\textbf{Generated:} #1\\}
