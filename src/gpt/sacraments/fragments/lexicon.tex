...
\term{Teleology}{Every nature and action is intelligible through an end (\latin{telos}). The proximate ends differ, but every sacrament is ordered through charity and the Eucharist to resurrection, communion, and the vision of God (ST III, q.~65, a.~3).}
