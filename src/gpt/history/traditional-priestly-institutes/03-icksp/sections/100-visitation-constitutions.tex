...
An ICKSP page records that the Holy See definitively approved the Institute's constitutions on 29 January 2016, the feast of Saint Francis de Sales. It reports a thanksgiving \emph{Te Deum} and says Bacqué, identified as the former apostolic visitor, would celebrate a pontifical Mass at Gricigliano on 2 February. The full constitutions and approval decree were not public in the checked set.

The sequence strongly supports movement from the five-year experimental code to definitive proper law. It does not show which provisions changed, whether every recommendation was adopted, or whether definitive approval should be described as the visitation's ``verdict.'' Bacqué's participation in thanksgiving shows an institutional relationship; it is not a published report.
...
\claimcheck{``The 2014 visitation cleared the Institute and led to approval in 2016.''}{The public record shows an ordinary visitation and, later, definitive constitutional approval. Without the mandate, report, approval act, or an official causal statement, the stronger claim invents both a verdict and a documented causal chain.}
