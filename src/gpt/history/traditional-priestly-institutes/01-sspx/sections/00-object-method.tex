...
This discipline is especially important because popular descriptions---``approved,'' ``suppressed,'' ``excommunicated,'' ``in full communion,'' ``valid,'' or ``traditional Mass''---often collapse distinct persons, acts, and periods. The history that follows assigns each term a date, an authority, and a defined object.
