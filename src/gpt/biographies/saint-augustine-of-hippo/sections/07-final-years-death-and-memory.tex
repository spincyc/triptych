...
day in the surviving narrative. The received date is 28 August 430, but the
chronicle locus commonly invoked for that date was not directly collated for
this revision. The distinction is small but exemplary: death and burial are
secure in the near-contemporary witness, while the exact day remains received
evidence whose source attribution still requires verification.
...
Possidius gives burial in the setting of besieged Hippo. An itinerary through
Sardinia to Pavia is proposed in later tradition, but the relevant
early-medieval witnesses and a current shrine record were not directly
collated for this revision. The responsible chain here therefore stops with the
near-contemporary burial report. The later itinerary remains a research lead,
not an asserted custody history.

Augustine's memory was never limited to one tomb. The received 28 August
