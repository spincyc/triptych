...
Catholic side. The uncollated conference and opponent dossiers are required
before reconstructing Donatist self-understanding in equal detail. Terms such
...
Imperial policy shifted toward suppression. Augustine's own position changed.
...
An imperially convened conference at Carthage in 411 brought Catholic and
Donatist bishops before the commissioner Marcellinus. Possidius treats the
event as decisive for the Catholic campaign (\emph{Life} 13). This revision has
not collated the surviving \emph{Gesta collationis}; it therefore does not use
that record to supply attendance totals, reconstruct the procedure, or quote
the judgment. The imperial setting and the coercive policy surrounding the
conference prevent its description as a neutral theological dialogue.
...
corrective.}
{Letters 93.5.17--19 and 185.6.21--7.30; Possidius, \emph{Life} 9--14. The
surviving conference record and imperial laws require separate collation.}
