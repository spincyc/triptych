\section{Chronological orientation}\label{sec:peter-orientation}
...
single date. The current 29 June solemnity is an official liturgical
commemoration, not a surviving civil death certificate; this edition does not
use an uncollated ancient calendar to date its origin. The familiar years 42
