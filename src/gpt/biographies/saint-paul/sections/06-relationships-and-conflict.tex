...
The dispute concerned whether Gentiles in Christ had to become Jews and what
shared meals embodied; it was not a verdict that Jewish observance itself was
hypocrisy. Paul circumcised neither Titus nor all Gentiles. Acts says he did
circumcise Timothy, whose mother was Jewish, in a different pastoral setting.
Whether every detail can be synchronized is less important than preserving the
different questions.
...
polemic. Labels such as ``Judaizers'' can flatten different Jewish and Gentile
actors into a hostile type and have fed anti-Judaism; this publication instead
names the concrete demand where known.
