...
These claims cannot be turned into the caricature that Jews tried to earn
salvation while Christians discovered grace. Grace, covenant, election,
obedience, and mercy all arise within Israel's Scriptures. Nor may ``faith
apart from works'' be used against Paul's own demand for a faith working
through love, a Spirit-formed life, care for the poor, and patient endurance.
Catholic teaching receives justification as entirely initiated by grace and
as a real transformation that bears fruit, not a human achievement or an idle
label.
...
of ``all Israel will be saved'' is debated; it cannot responsibly mean that
the Church is licensed to despise, coerce, or declare Jews abandoned. The
Second Vatican Council's \emph{Nostra aetate} and the Pontifical Biblical
Commission make the anti-supersessionist boundary explicit in Catholic
reception.
