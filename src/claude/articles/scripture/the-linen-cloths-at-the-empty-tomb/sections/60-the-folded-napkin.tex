...
\begin{threestable}{Query}{Total hits}{Comment}
...
Antiquities} (1875), s.v.\ ``Mantele,'' read on 25--26 July 2026 at the
LacusCurtius transcription,
\texttt{penelope.uchicago.edu} (LacusCurtius, Smith's \emph{Dictionary}, s.v.\ Mantele).
This article was read by a delegated researcher and its wording is reported
here at a checked-transcription ceiling.} An object each diner brings and takes
away is the least available thing at a Roman table to serve as the host's
signal.
...
LacusCurtius transcription,
\texttt{penelope.uchicago.edu} (LacusCurtius, Suetonius, \emph{Nero}).}
