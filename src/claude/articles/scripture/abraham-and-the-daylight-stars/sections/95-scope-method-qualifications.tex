...
Two collations were performed. The Latin of Genesis 15 was read from a page
image of the Hetzenauer printing rather than from a transcription. Abarbanel's
...
Masoretic Bible or a manuscript facsimile.

\textbf{Not reached.} Jubilees 14; the Genesis Apocryphon and any other Qumran
witness to Genesis 15; Targum Neofiti and the Fragment Targums; the Samaritan
Pentateuch; the Peshitta; Jerome's \textit{Hebrew Questions on Genesis};
Ambrose's \textit{De Abraham}; Chrysostom's homilies on Genesis; Theodoret's
\textit{Quaestiones in Genesim}; the Glossa ordinaria; and the sixteenth-century
Catholic commentators a Lapide names. Any of the first five could contain a
