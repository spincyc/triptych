...
\item Rudolf Kittel and Paul Kahle, eds., \textit{Biblia Hebraica}, Genesis 15,
Kittel--Beer 1909 printing. The controlling loci were checked against the
identified page images. Public domain.
\item Syriac Peshitta Genesis 15, dated peshitta.eu delivery. The textual base
is unidentified; used only as delivery-specific comparison evidence.
\end{itemize}
...
\item Flavius Josephus, \textit{Antiquitates Judaicae} I.10.3, trans.\ William
...
both public domain.
\item Ambrose, \textit{De Abraham} II.8.48, Latin in \textit{Patrologia
Latina} 14. Exact locus inspected; public domain.
\item John Chrysostom, \textit{Homilies on Genesis} 36.13 and 37.3--6.
Copyrighted English consulted for verification only; no wording reproduced.
\item Ephrem the Syrian, \textit{Commentary on Genesis} XII.2--5.
Copyrighted English consulted for verification only; no wording reproduced.
\item Theodoret of Cyrus, \textit{Questions on Genesis} 66--67. Consulted only
for the bounded local negative reported in the text.
\item \textit{Jubilees} 14, in R.~H. Charles's 1913 public-domain English;
treated as rewritten Scripture, not as a version of Genesis.
\end{itemize}
