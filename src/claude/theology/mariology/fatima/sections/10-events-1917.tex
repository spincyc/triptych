\section{The Events of 1917 in Their Nearest Witnesses}\label{sec:events}
...
writings, treated in \S\ref{sec:memoirs}. The contemporaneous records are the
...
``never simple `photographs' of the other world''
(\S\ref{sec:interp2000}, \S\ref{sec:mode}).  A
