\section{The Diocesan Process and the 1930 Judgment}
...
2024 (\S7).\endnote{Diocesan restoration and the bishop's role: the
...
(Sanctuary seer chronology; canonization records, \S7).}
...
credence (\S8). The act's own argumentative sections---on the solar
