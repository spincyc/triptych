...
and 15--16 (= 1 Chronicles). This study prints both and harmonizes neither.
Where they differ, the differences are themselves evidence.
...
belongs to a later panel. Here it is enough to see what the texts insist
on: the second procession will change exactly one thing, and it is the
...
in the chapter still waiting for its full answer. This study will meet it
again, on other lips, before the end.
