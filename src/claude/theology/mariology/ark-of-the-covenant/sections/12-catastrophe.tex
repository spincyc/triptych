...
great divine title --- the Lord enthroned upon the cherubim, the title
that binds the throne to the box --- and so it must be read. The verse's second clause is as ominous as its first is majestic.
...
on which everything that follows will turn: the ark taken \emph{is} the
glory departed. Israel's own Scripture never treats the loss at Aphec as
the loss of a treasured object. It treats it as an eclipse. And the
equation is no later devotion: it is the narrative's own first-generation
verdict, put in the mouth of a woman with nothing left to lose. The glory is departed. That is what the box meant.
...
--- but either way the shape of the episode is the same.
...
and on plausibility. That is a strong case; but it is a reconstruction,
and a text quoted as printed must not be emended under the reader's feet.
...
bare ``because they had seen'' means, the philology cannot settle. What
the deaths mean --- what kind of thing holiness is, that joy and
irreverence can stand this close together --- is a question that must wait
until the whole journey is told; it will not be rushed. The men of
Bethsames themselves ask it first, in almost those words: who shall be
able to stand before this holy Lord? (6:20). Their
...
it has Israel \emph{lamenting} after him --- a nation either at peace
under the parked Presence or homesick for it. Both moods can stand; the
note says which witness carries which.
