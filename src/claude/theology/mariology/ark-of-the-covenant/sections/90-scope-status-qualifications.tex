...
under the repository's Mariology profile: the narrative panel follows the
repository's evidence discipline for historical accounts, and the
philological panel reads each witness at its own locus and preserves
...
in the toll-gate section. (2) Defined dogma touched here: the divine
...
evidence on the warrant stated in the toll-gate section: dated acts of
...
the overture and stated formally at the toll-gate: facts exact, framework
...
\texttt{evidence-map.md} (the narrative panel's evidence map); and
