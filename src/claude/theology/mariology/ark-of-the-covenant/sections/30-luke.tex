...
The road climbs into the hill country of Juda, and a philological claim
waits at the top. Philological claims can be tested.
...
months' stay answer, point for point, the processions of 2~Kings~6. If that is true, it is true in Greek---in the vocabulary
...
note: the Greek Bible files the books that modern Bibles call 1--2 Samuel and
1--2 Kings as 1--4 Kingdoms; the Douay-Rheims calls the same sequence 1--4
Kings.  Thus 2~Kingdoms~6 in the Septuagint and 2~Kings~6 in the Douay-Rheims
are both modern 2~Samuel~6.
...
\input{theology/mariology/ark-of-the-covenant/figures/fig-overlay}
\end{minipage}\par
...
Two deflationary facts are also visible, and they belong in print. The
...
Here an honest negative must be printed, because the popular form of this
...
allusive weight, and none is assigned to it. What carries weight is the
...
not been confirmed at first hand.} The argument's form is the cumulative one
weighed a chapter ago: convergent, with no single echo claimed as proof. The claim is that so many independent contacts within
...
above forbids it. Two verdicts, two premises; the two-axis rule
holds the space between them: attestation is not reception, and the
absence of either is not falsity. The philology is what it is. What
