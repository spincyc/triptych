...
The claim to be examined in this section is philological, and philological
claims can be tested. It is said that St.~Luke composed the Visitation
narrative on the pattern of the ark's journey to Jerusalem---that Mary goes
up into the hill country of Juda as David went up, that Elizabeth's cry and
her question and John's leap and the three months' stay all answer, point
for point, the second panel of the story told in section~13. If that is
true, it is true in Greek: in the vocabulary of the Septuagint, the Greek
Old Testament whose idiom the infancy narrative everywhere speaks, set
against the Greek of Luke's own sentences. The words can be counted, and
for this study they have been counted---every concordance claim below rests
on a lemma-level search of the whole Rahlfs corpus, run and then
adversarially re-run for the study's research records, not on secondary
lists.\endnote{The Septuagint concordance results in this section were
...
Rahlfs--Hanhart remains on the study's open queue (section~90).} One
naming note, once: the Greek Bible files the books of Samuel as 1--4
Kingdoms, and the Douay-Rheims files them the same way as 1--4 Kings, so
2~Kings~6 (=~2~Samuel~6) is the chapter in question under either name.
...
\term{episkiazein}, and its Old Greek career is short: it occurs exactly
four times in the Septuagint. Twice it is the Psalter's protective shadow
(Ps~90:4; 139:8 LXX), once it is wealth's glory in Proverbs (18:11), and
once---the one theologically laden use---it is the cloud at the completion
of the tabernacle: Moses could not enter the tent of meeting, because the
cloud overshadowed it (\term{epeskiazen ep' autēn hē nephelē}) and the
tabernacle was filled with the glory of the Lord (Ex~40:35 LXX). The
Douay reader should know that this link lives only in the Greek: the
English of Douay Exodus reads ``The cloud covered the tabernacle\ldots\ the
cloud covering all things'' (Ex~40:32--33, the verses numbered 40:34--35 in
Hebrew-ordered Bibles), while the English word ``overshadow'' surfaces at
the New Testament end, at Lk~1:35 and again at Heb~9:5, ``the cherubims of
glory overshadowing the propitiatory.''\endnote{Douay Ex~40:32--33 read at
...
the simple \term{skiazō} (and once \term{skepazō}), not the compound.} And
Luke himself tells us what the verb means to him: he uses it again at the
...
glory-cloud, not mere shelter. That internal
control is the strongest single piece of evidence that Lk~1:35 intends
Shekinah imagery.
...
within the tent (Ex~40:20--21). Strictly taken, the figure Lk~1:35 supports
is Mary as the overshadowed tabernacle, the place of the glory-cloud; the
ark is one step further in. Second, that step is shorter than it once
appeared. The adversarial re-run of the whole shadow-verb family for this
study found the simple verb \term{skiazein} sitting directly on the ark
...
at Ex~38:8 LXX the two cherubim \term{skiazonta} over the propitiatory,
with the veil that shadows the ark for the march at Num~4:5 and the
cloud that shall shadow Mount Sion at Isa~4:5.\endnote{1~Par~28:18 LXX
...
Septuagint. Both facts belong in print. The soberest critic of this
parallel, Marie Isaacs, granted the verb and denied the inference: ``it
cannot be assumed that Luke is employing a typology whereby Mary represents
the tabernacle in whom the Shekinah resides''---her stated ground being
that the Shekinah was not confined to the tabernacle or the ark, with the
Psalter's protective usage as her supporting observation.\endnote{Marie
...
The critics have a rival text, and it deserves its place in the body of
this study, not a footnote. Raymond Brown observed that when David comes to
...
from its table of contents.} The rejoinder, pressed by Jan Kozłowski, is
about content rather than syntax: Araunah's question is court courtesy to
a superior, while David's question and Elizabeth's are the only two shaped
as numinous unworthiness---the creature asking how the bearer of the
Lord's presence can enter a private life.\endnote{Jan M.~Kozłowski, ``Mary
...
is that this is a genuine motif-parallel with partial verbal support---an
allusion at most, never a quotation---and that at this single point the
debate is genuinely open.
...
Testament, and in the whole Septuagint it occurs exactly five times, every
one of them in Paralipomenon, every one of them a Levite's liturgical
acclamation, and four of the five in ark ceremonies: the procession that
brings the ark up to Jerusalem (1~Par~15:28), the ministers appointed
before the ark (1~Par~16:4--5), the cultic music of Heman and Idithun
(1~Par~16:42, the one occurrence with no ark in the verse), and the ark's
installation in Solomon's temple (2~Par~5:13)---where the acclamation ends
with the house filled with the cloud of the glory of the Lord, the same
...
Luke adding only ``about''---and the Douay English adds a small bonus of
its own, the same verb ``abode'' in both verses. The blessing motif stands
beside it: the Lord blessed (\term{eulogēsen}) all Obededom's house because
of the ark, and Elizabeth pronounces Mary blessed and the fruit of her womb
blessed (\term{eulogēmenē\ldots\ eulogēmenos}, Lk~1:42)---though the text
of Luke never says Zachary's house was blessed, and honesty keeps that
difference visible.
...
2~Kings~6:11 remains the closer parallel to Lk~1:56, because in both a
...
never claimed the same verb: he glossed John's leap from Malachias and the
Psalter---leaping at the coming of the Lord---and listed the joyful bounds
of David and of John together as a shared motif; the lexical equation is a
popular overreach beyond what he wrote. And the motif equation itself has
an ancient, if late, witness. In the second century after Christ the
...
link. What Symmachus shows is something smaller and still real---that an
ancient translator, independent of the Church, found ``leaping'' the
natural Greek for what David did before the ark. The equation of the two
...
destination house, a sacred burden. And here the Greek Bible offers one
curious texture. The Septuagint of 2~Kingdoms~6:2 has lost the
place-name: where the Hebrew has David set out from Baale-Juda (that is,
Kiriath-jearim), the Greek translator read the noun as a common one,
...
(composed between about 518 and 530), which gives a distance only:
...
grace of that election. The minimalist answer is verbal: the only word
Lk~1:28 exactly shares with Sophonias is \term{chaire} itself, which is
also the everyday Greek greeting; ``the Lord is with thee'' belongs to the
call-formula spoken to Gedeon and by Booz (Judg~6:12; Ruth~2:4), not to
the Zion oracles; and Isaacs judged the verbal parallels ``are, in fact,
slight,'' the womb-for-midst equation ``wholly far-fetched''---while
allowing that the Daughter-of-Zion personification ``may have influenced
Luke.''\endnote{Soph~3:14--17; Zach~9:9; Joel~2:21; Judg~6:12 (Codex
...
the Lord indwells, the second makes her the vessel that carries the
Presence from place to place. The Church's own prayer has fused them---the
Catechism, in its commentary on the Ave Maria, calls Mary the daughter of
Zion in person, the ark of the covenant, the place where the glory of the
Lord dwells (CCC 2676), and Ratzinger fuses them deliberately, handing the
ark title finally to Christ with Mary as bearer. That fusion is an act of
...
The modern argument has a genealogy, and stating it plainly costs nothing.
Eric Burrows first developed the tabernacle-and-ark reading of Luke~1 in
essays published in 1940; Stanislas Lyonnet argued the Daughter-Zion
reading of the greeting in 1939; and René Laurentin built both into the
classic statement, \work{Structure et théologie de Luc I--II} (1957),
...
not been confirmed at first hand.} The argument's logical form should be
noticed: it is cumulative and convergent. No single echo is claimed as
proof; the claim is that so many independent contacts within the eighteen
verses of one pericope (Lk~1:39--56) are unlikely to be accident.
...
of Heaven and Earth''---so that the child
in the womb is acclaimed in Creator's language; and if the burden is the
Lord, the bearer is what the ark was. To this he added the corrected
concordance facts for \term{anaphōnein} set out above. From the Reformed
side, Jacobus de Koning argued the typology in 2020 from 2~Kings~6 with
the Chronicles acclamation texts, noting that it is ``grootliks
afwesig''---largely absent---from the mainstream commentaries, and
proposing it as a challenge for Protestant rethinking of
Mariology.\endnote{Jacobus d.~W. de Koning, ``Maria as anti-tipe van die
...
commentary tradition (Bock, Fitzmyer, Green) stands at his p.~10.} And
behind both stands an identifiable Catholic school with institutional
addresses---Aristide Serra at the Marianum, whose Old Testament
prefigurations of Mary include ``the tent of the ark of the covenant'';
André Feuillet at the Institut Catholique de Paris; Ignace de la Potterie
at the Biblicum, for whom the Daughter-of-Zion promises are realized in a
definite woman---whose loci this study cites as reported, not as texts
opened at first hand.\endnote{A.~Serra, \work{La Donna dell'Alleanza:
...
Name the divide honestly and it names itself: it is methodological, not
...
above forbids it. The two verdicts follow from two premises, and the
study's named distinction holds the space between them: attestation is not
reception, and the absence of either is not falsity. The philology is what
it is; what the Church has made of the reading is a separate question with
separate evidence, and it occupies the next two sections.
