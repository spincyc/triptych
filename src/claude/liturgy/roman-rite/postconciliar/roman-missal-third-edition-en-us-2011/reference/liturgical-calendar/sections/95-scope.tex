...
\textbf{Notification Prot.\ n.\ 2671/98/L} & Latin, 8 December 1998. The original Claude research
reported it from the Secretariat's 2026 calendar after not reaching the official act on 25 July
2026. An independent subsequent check on 26 August 2026 read the complete notification in the
official Vatican web delivery and in \emph{Notitiae} 35 (1999), 157. The notification makes both
coinciding obligatory memorials optional for that year; the resulting choice and weekday rest on
\loc{nualc}~14 and 16\,c and table places 12 and 13.\\
...
\item \textbf{The original failure to reach two Roman acts was later partly superseded.} The Claude
research did not reach the 1998 notification on the Immaculate Heart, Prot.\ n.\ 2671/98/L, or the
decrees inserting post-2002 additions into the General Roman Calendar at the Holy See paths tried on
25 July 2026, and originally reported both from the Secretariat's calendar. The notification was
subsequently read in two official states by an independent check on 26 August 2026. The inserting
decrees remain outside that later check.
