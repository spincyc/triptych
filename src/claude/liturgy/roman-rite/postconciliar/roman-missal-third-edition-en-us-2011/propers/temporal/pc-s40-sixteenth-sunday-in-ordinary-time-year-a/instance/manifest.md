...
This is the authoritative identity and resolution record for the publication leaf `pc-s40-sixteenth-sunday-in-ordinary-time-year-a`.
...
| Full publication slug | `pc-s40-sixteenth-sunday-in-ordinary-time-year-a` |
