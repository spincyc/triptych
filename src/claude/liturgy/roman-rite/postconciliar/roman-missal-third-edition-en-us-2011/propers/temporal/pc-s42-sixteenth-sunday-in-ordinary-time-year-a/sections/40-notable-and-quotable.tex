...
Four later uses redirect wording from this Sunday's appointed Scripture, each
a phrase from the Gospel---present in both the longer and the shorter
form---turned to another purpose. Straight exegesis and devotional reception
of the same phrases stand in the commentary above. Each later text stands in
a public-domain edition or transcription at the locus given.
...
introduces pull in opposite directions. Priestley does not cite chapter and
verse, and the phrase governs his manner, not his programme; he continued to
press for disestablishment. The 1771 work is public domain; its text here is
the Wikisource transcription of the second edition.
...
removal becomes one that begins with rescue. The passage is a scriptural
claim inside another religious body's canon, and its reuse of Matthew is the
whole of its place in this gallery. Its text is the Wikisource transcription;
the 1832 revelation and its nineteenth-century printings are public domain.
...
being spent on vandalism. The wording is the King James version's, not the
Lectionary's, and Wodehouse signals no source; the verbal match is exact and
the sentence is distinctive enough to make dependence plain, but this is
allusion, not quotation with attribution. The 1907 novel is public domain in
the United States; its text is the Wikisource transcription.
...
coincidence the lexicographers do not exploit; the observation is not
theirs. The identification of \incipit{zizania} with \incipit{Lolium
temulentum} is the standard lexical judgment, not a demonstrated botanical
fact of first-century Galilee; both reference works are public domain, and
their text is that of the Wikisource transcriptions.
