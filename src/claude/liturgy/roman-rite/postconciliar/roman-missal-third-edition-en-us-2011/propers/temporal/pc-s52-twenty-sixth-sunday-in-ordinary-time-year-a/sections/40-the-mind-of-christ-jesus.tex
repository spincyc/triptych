...
softens and subdues the proud and the obstinate'' and then guides them (on
Ps~24:9). The acclamation names the disciple's part: ``they follow me''.
...
(\work{Homiliae in Evangelia} 14.4). The Son's obedience and his love for the
sheep are, in Gregory's sentence, one act.
...
ad~3); Schuster's word is that God, bridging the abyss that separates him from
evil, ``descends into it to draw forth the sinner'' (\work{The Sacramentary},
vol.~3, p.~121). The petition asks
...
\item[Allegorical.] Christ is the Son who obeyed the Father and so honoured him
(Chrysostom); the lowly God who found proud man (Augustine); the shepherd who
lays down his life, whose body and blood are received at the ruler's table
(Augustine).

\item[Moral.] Count others better than yourself, by the image of God in them if
by nothing else (Aquinas); obey against your own inclination (Aquinas); begin to
lay down your life by giving of your means to a brother in need (Augustine); do
not glorify Christ rightly and live wrongly (Chrysostom).

\item[Anagogical.] Exaltation follows humility (Aquinas, on Philippians;
Hilary, on the servant's lowliness); the communicants ask to be fellow heirs in
glory with the one whose death they proclaim; where the longer form is read,
