...
Five later uses of wording from today's appointed Scripture, each verified in a primary text at the locus given, and each one \emph{changes} what the words are doing rather than merely repeating them.

\subsection*{1. A royal petition becomes a constitutional argument}

\textbf{Trigger:} 1 Kings 3:9, the request for a hearing heart to discern between good and evil.\par\noindent
...
\textbf{Trigger:} Matthew 13:46, the one pearl of great price bought with everything the merchant had.\par\noindent
...
\textbf{Trigger:} Matthew 13:45--46, the merchant who sells all and buys.\par\noindent
...
\textbf{Trigger:} Romans 8:28, that to them that love God all things work together unto good.\par\noindent
...
\textbf{Trigger:} Matthew 13:52, the householder who brings forth new things and old.\par\noindent
