...
\subsection*{Communion Antiphon: two alternatives, unresolved}

The Missal prints two antiphons joined by \emph{Vel}, and one is sung unless an approved chant replaces both. They pull in different directions, and the difference matters because it changes what the communicant is given to say.
...
\subsection*{Where the euchology and the readings meet}
...
Two apparent contacts do \emph{not} hold. The Collect's ruler-and-guide language is not a comment on Solomon's kingship: it is addressed to God about the petitioners, not about a monarch. And the Entrance antiphon's ``house'' is not the field of the parable; they are different images from different books.
