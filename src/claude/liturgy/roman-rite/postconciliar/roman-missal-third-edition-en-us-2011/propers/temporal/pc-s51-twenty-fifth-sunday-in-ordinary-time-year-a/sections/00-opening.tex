...
in nothing, and the wage is finally the giver himself. What each
interpretation's witnesses say of their own passages supplies it: the
parable, the prophecy, the two psalms, the letter, the story of Lydia and the
discourse of the shepherd. None of these witnesses expounds this Mass as a
whole. All the appointed elements have a place in each interpretation, and
four senses of its own, literal, allegorical, moral and anagogical, close
each. The three hold much in common.
