...
Gregory the Great's \emph{Pastoral Rule} is the obvious candidate: a whole treatise on the government of souls, written by a man who had been a prefect. In all four books Solomon appears sixteen times, every time as the tag attached to a quotation from Proverbs, Ecclesiastes or Sirach, and Gibeon does not appear at all. The nearest approach is Book III's warning that Solomon, granted such wisdom, fell because no discipline of tribulation guarded it -- the grant presupposed, the petition never invoked.
...
The psalm keeps its own horizon. These are the words of an Israelite whose delight is in \emph{torah}, and Christian reception does not annul that literal sense. The Old Testament is proclaimed in this liturgy as Scripture in its own right, not as a cipher awaiting decryption, and the two Fathers quoted above both treat it that way even where their conclusions are Christological.
