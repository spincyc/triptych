...
\item \textbf{The Lateran dedication as a \latin{festum Domini}.} The calendar page does not
mark the category, but the final alphabetical index of the same 1962 typical Missal expressly
lists the 9 November dedication under \latin{Festa Domini}. That controlling internal index
resolves the 2008 occurrence: line 14 and \rn{16}\,a put the feast above the II-class Sunday,
without commemoration of the Sunday.
