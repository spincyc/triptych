...
and readings.
\item \textbf{The enumeration fixes nominal slots before occurrence is resolved.} The phrases
\latin{dominica XXIV erit}, \latin{XXV, quae inscribitur}, and \latin{XXVI, quae
inscribitur} assign each formulary to a numbered place. If a feast wins occurrence in one
place, \rn{14} leaves that nominal Sunday impeded; the later assignments do not slide
backward. Computation must therefore record the nominal formulary first and the occurring
winner second.
\end{enumerate}
