...
\textbf{9 November: the Missal's own index resolves the category.} The twenty-sixth place
nominally carried the Fifth Sunday left over after the Epiphany. The date was also the
Dedication of the Archbasilica of the Most Holy Saviour, a feast of the II class. The final
alphabetical index of the 1962 typical Missal expressly lists that dedication under
\latin{Festa Domini}. It therefore stands at line 14, above Sundays of the II class at line 15,
and by \rn{16}\,a takes the Sunday's place without its commemoration. The Fifth is impeded;
the Sixth remains at its independently assigned twenty-seventh place on 16 November. This is
occurrence applied after the nominal slot map, not a compression of the resumed sequence.
