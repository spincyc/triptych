...
\item \textbf{Which resumed Sunday after Epiphany is lost when Christ the King
occupies its slot} --- \rg{18}'s numbered assignment against its closing
``omissis, si opus sit, ceteris.'' Case 5.
\end{itemize}
