...
Evangelium tuum digne valeam nuntiare. Per Christum Dominum nostrum. Amen.\par
\vspace{0.35em}
\upshape(The deacon then asks: \latincue{Iube, domne, benedicere}. The priest
answers:)\itshape\par
Dominus sit in corde tuo et in labiis tuis: ut digne et competenter annunties
Evangelium suum: In nomine Patris, et Filii, \misscross\ et Spiritus Sancti.
Amen.
\end{appointed}

\begin{appointed}{1028 $\cdot$ At a Mass without sacred ministers}
Munda cor meum, \upshape as above, and\itshape\ Iube, Domine, benedicere.
...
de caelis. \upshape(Hic genuflectitur)\itshape\ Et incarnatus est de Spiritu
...
This is the creed of Nicaea as completed at Constantinople, with
\latincue{Filioque}, and it is the only text in the Ordinary that a general
council composed. That fact governs how it should be read. Its clauses are not
prayer but definition, and several of them are polemical in origin:
...
The two ceremonial marks are the deepest commentary the book offers. At
\latincue{Et incarnatus est} the whole assembly kneels, and stays kneeling for
one clause only --- through \latincue{et homo factus est}. The rite thereby
identifies the sentence at which the creed stops being an account of God and
becomes an account of history. And at \latincue{Et vitam venturi saeculi} the
priest signs himself with the cross, as he does at a blessing and as he does at
the last line of the \latincue{Gloria}: the profession ends with a gesture
asking that what has been professed be true of the man professing it.
