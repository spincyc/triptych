...
DECIMA TERTIA post Pentecosten} (no.\ 1562). Everything between those
boundaries follows below. It appoints no Tract, Sequence, second oration, blessing or
...
and located in the Venice Missal of 1570, both of them public-domain
witnesses; the basis and its bounds are set out in full in the
terminal appendix. No rights are claimed in this text, and none of it has been
composed, translated, modernised, conflated or adapted. Every form below was
visually collated against the CMAA facsimile of the Vatican
...
for this edition. Two chants of this
...
wording at several points; each gap stands at its element, unfilled.
...
faithful,'' as ``thy people.'' The Latin, not the English, therefore carries
the prayer's grammar.}
...
Vulgate the Douay translates, so the three verses are printed whole above,
and none of those verses matches the chant. Four gaps stand. The
...
\englishgap{The 1861 book prints no incipit for this Secret; its clauses
answer the Latin one by one --- ``the offerings we lay on thy holy altar'' to
\latin{quas sacris altáribus exhibémus}, ``to the honour of thy name, by
obtaining pardon for us'' to \latin{nobis indulgéntiam largiéndo, tuo nómini
dent honórem} --- and the orations on either side of it in that book are the
eleventh and thirteenth Sundays', so its filing does not slip by one. The
English reverses the Latin's order of honour and pardon and makes ``look
down'' of \latin{propítius inténde}, ``favourably attend''; the order that
makes pardon the mode of honour stands only in the Latin.}
...
stated, since no registered English follows that path.}
...
has the singular \latin{huius \dots\ mystérii}. Only the Latin carries the
pair as one bestowal.}
