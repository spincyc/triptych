...
\newcommand{\latinpolicynote}{The complete appointed Latin stands above, in
\textit{The Appointed Formulary in Full}, in liturgical order and beside the
same English; below, it returns only where an argument turns on the wording.}
...
% Attributions the checked sources do not bear out: the claim the standard
% delivery invites, what the checked sources actually show, and the proper the
% evidence sits at.
...
\toprule
\textbf{The claim the standard delivery invites} & \textbf{What the checked sources show} & \textbf{Proper}\\
\midrule
\endhead}
{\bottomrule\end{longtable}}
