...
% Attributions the sources do not bear out: the claim as usually made, what
% the checked sources actually show, and the proper the evidence sits at.
...
\toprule
\textbf{The claim as usually made} & \textbf{What the checked sources show} & \textbf{Proper}\\
\midrule
\endhead}
{\bottomrule\end{longtable}}
