...
The checked witnesses and the collated texts together support what follows
once the ten elements are read as one book-order, and they support no more;
the proposals that go further stand in \textit{Interpretive Possibilities}.
The line between the two is real: three of the four relations below were
reached by comparing sources that disagree.
...
merely the deed but the interior act. The link is Schuster's, not new
here: his commentary on this Sunday quotes that verse of 2 Corinthians against any
...
and the postconciliar Missal still says it. Nothing shows that anyone
assembled the three for this reason. The Hadrianum witness shows the
...
separate texts; the liturgical juxtaposition is the missal's, and it shows no
compiler's motive.
