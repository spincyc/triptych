...
Read as one book-order, the ten collated texts and their checked witnesses
support the four relations that follow, and three of the four rest on
witnesses that disagree; connections that go further are the exploratory
proposals of \textit{Interpretive Possibilities}.
...
salvation. That is more than a resemblance; it is the same noun and the
...
What that convergence does \textit{not} license, the tradition itself
refused. Ambrosiaster reads \latin{líttera enim occídit}
...
merely the deed but the interior act. The link is Schuster's own: his
...
and the postconciliar Missal still says it. The Hadrianum witness shows the
chants and the orations already travelling together for this Sunday.
...
Both expositors wrote on the psalm alone; its juxtaposition with the Gospel is
the missal's.
...
``the pains of all human nature after sin.'' Neither reading absorbs the
other. Both leave the chant doing the same liturgical work: a cry
...
of the people'' --- and that is one witness, not a consensus, though
preaching commonly attributes it to the tradition at large.
...
vivíficat} in the lesson, \latin{Vivíficet nos} over the sacrament. Two
collated texts share the vocabulary, and the sharing proves nothing further;
but what the prayer asks with that verb answers the
...
That position is drawn from the texts as the book assembles them and from
their checked reception; the Hadrianum's cue line pairing \latin{Deus in
adiutorium}, \latin{Benedicam dominum}, \latin{Precatus est moyses} and
\latin{De fructu operum} shows that the four chants were joined early. And
Bede's rule governs the
allegory throughout --- the parable specially designates the Son of God
\textit{and} teaches that everyone who shows mercy is a neighbour, and the
rules of allegory must not \latin{moralia mutuae fraternitatis instituta
\dots\ extenuare et auferre}. Bede's own prohibition rules out making this
Sunday only a doctrine of grace. The imperative is the last thing the Gospel
says.
