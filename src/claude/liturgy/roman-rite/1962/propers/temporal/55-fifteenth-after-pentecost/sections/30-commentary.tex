...
Benziger \latin{editio iuxta typicam} of the same year, in its uncorrected
optical layer and allowing for that layer's accent substitutions, the two agree, apart from the differences enumerated next, through
the Introit, the Collect, the body of the Epistle, the Alleluia, the Offertory,
the body of the Secret and the Communion --- including \latin{ad me} and
...
of Gal. 5:25--6:10 matches the tracked Clementine word for word, five
differences in all standing across its twelve verses --- two capitalisations, one
...
Five further sacramentary witnesses number this Mass, beyond the Hadrianum's
\latin{DOMINICA .XVI.} above, and they do not agree. Wilson's
...
Pamelius at one, where the Hadrianum's heading already stands.} The page image
settles what the optical layers lose: the second
...
Menard do not have it, and the three prayers all five of them carry
...
The 1909 printing of Dom Lucien Fromage's continuation of Guéranger's \work{The
Liturgical Year} shows the formulary before the 1960 change, printing the
...
hilaritatis et origo laetitiae, ab illa scilicet parte qua servus est.} His
numbering runs level with the Vulgate's here, Ps.~85 counting its inscription
inside v.~1, so his \latin{Vers.~1} is the Vulgate's v.~1.
\end{witnessnote}
...
Within the tracked 1962 registry, a finding aid derived from the book, Ps.~85:3
opens the Sixteenth Sunday's Introit, which sings v.~5 with it
...
continuation a week later; at C3 of the synthesis the pair stands beside the two
Offertories' Ps.~39.
...
Three phrases of it reach into the rest of the Mass. \latin{Miserátio
...
consístere} denies the Church any standing of her own; that denial stands with
the Postcommunion's in the first unit of the thematic movement. \latin{Tuo semper múnere} makes the
Church's governance a gift; Augustine, expounding the Gradual's own psalm, uses
the same noun to deny that any progress is a merit, in his own words at the
second unit of the thematic movement.
...
\subsubsection*{The lesson's vocabulary}
...
(PG~61, 673--680), in the nineteenth-century English of the Nicene and
...
charity, only it shows a greater care for its own household.'' His words are
quoted in nineteenth-century English, so his distinction between ``fulfil'' and ``complete''
...
directly beneath it on p.~396 begins \latin{Bonum est confitéri Dómino}. The
Greek and the unsung verses both narrow the catchword. In the Greek the lesson uses \emph{kalon} at 6:9
...
\textbf{The Latin quoted from Hilary is that of a poor optical layer of a scan
...
\begin{witnessnote}
\wlocus{Cassiodorus, \work{Expositio Psalmorum} on Ps.~94 (PL~70)} On the
same verse Cassiodorus also has \latin{super omnes deos} and
...
\subsubsection*{The pericope's wording}
...
subject the sentence needs. With the connective goes the pair Luke makes, a
servant healed at a distance for a Gentile who asks and then a son raised at close
quarters for a widow who does not; and \latin{mortui resurgunt} at
...
quotation, and the quotation is visible in the Greek alone. Two weaker agreements stand beside it: the gate-and-widow agreement at
3~Kingdoms 17:10 against Luke 7:12 uses cognate but different nouns, and
4~Kings~4 shares the raising and the restoring but no verbal formula. Luke's
own text points to the Elias figure most strongly at 4:25--26,
...
and \latin{est etiam forma}, offered as a reading and not as a demonstration.
\end{witnessnote}
...
``annihilates the influence of death and corruption.'' The words are an English
translation of an ancient Syriac version of a Greek original that
...
in the nineteenth-century English of the Nicene and Post-Nicene Fathers,
...
\latin{Ambrosius} is not in Ambrose's Luke commentary}: the scheme's own terms
stand in the complete critical text at V.86 and VI.64 only, and neither passage
carries it; it may stand in another work of his, or be Ps.-Ambrose,
...
consolation. \textbf{One heading of the same catena disagrees with the work it
lemmatises}: its \latin{Cyrillus in Ioannem} at this chapter stands over a
passage that is in Cyril's Luke commentary, and Payne Smith's own footnote at
vol.~1, p.~135 records Aquinas and Cramer's catena manuscript attributing the
neighbouring fragment to Cyril as well.
...
dominis servire}. His Fifteenth Sunday and the missal's share an ordinal and
not a Gospel.}
...
Sunamitess's son; Schuster and Fromage both name that Lenten Thursday
...
and his exposition of Ps.~69 stands there; his expositions quoted here are those
of Pss.\ 39, 85, 91 and 94. Within the tracked registry the antiphon also stands at the
...
congregation and no longer the Church, one step of the narrowing across the
three orations traced in the fourth unit of the thematic movement.
...
257--260), in nineteenth-century English} ``By bread He means here either His
...
does not reach \latin{dédero}}, and his exposition of the universality
of the effect does not reach \latin{sǽculi} either.
\end{witnessnote}
...
manducandum?} The modern label of Cyril's chapter, 6:51--58, therefore stands
one verse below the missal's reference.}
...
scans alone, while no such control stands for the Bobbio Missal. No source opened for this formulary dates or
