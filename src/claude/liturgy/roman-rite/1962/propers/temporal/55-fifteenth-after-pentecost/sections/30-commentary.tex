...
7:14 --- with one word form that runs the other way: those same layers show
\latin{Adolescens} with the Clementine, and the \emph{u} of \latin{Aduléscens}
...
substance: pointing at the joins, where the Introit runs \latin{exáudi me: salvum
fac} and the Gradual \latin{Altíssime. ℣.~Ad annuntiándum} across what the
Clementine sets as sentence ends; orthography and word division, \latin{huiúsmodi}
...
in the Gregorian Hadrianum as Wilson prints it: section CXXXIIII, heading
...
Guéranger's 1900 volume shows the formulary before the 1960 change, printing the
...
Sunday of the widow of Naim.'' He prints at p.~355, under Vespers, the Magnificat
...
Clementine give Asaph at 72--82, \latin{filiis Core} at 83, 84 and 86, Eman the
Ezrahite at 87, Ethan the Ezrahite at 88, and
...
saeculi extenditur}; and the ground of the petition is that \latin{Humilem
respicit Deus, superbum repellit} (§2). At v.~4 he turns the psalm verse into an
...
witness reaching the same reading independently: \latin{Ex forma servi (sicut
...
book --- Ps.~85:3 is also the Sixteenth Sunday's Introit incipit and Ps.~85:1 its
psalm verse, while Ps.~85:2 \latin{Salvum fac servum tuum} is the Gradual of the
Ember Friday in the first week of Lent. \textbf{This Sunday takes the head of the
psalm and the next takes its continuation}, and the same holds of Ps.~39 at the
two Offertories; shared psalm stock across neighbouring Sundays is what a chant
repertory produces of itself.
...
Mass's first word of duration. \latin{Sine te non potest salva consístere} denies
the Church any standing of her own, and the same denial returns at the
Postcommunion in the first person plural. \latin{Tuo semper múnere} makes the
Church's governance a gift; Augustine, expounding the Gradual's own psalm, uses
the same noun to deny that any progress is a merit --- \latin{quia munera ipsius
sunt, non merita tua}.
...
two-sided confession reached independently: confession is of sins and of benefits,
...
and the chant takes the verse at the hinge, carrying in the summons and not the
warning. The warning half is what Hebrews quotes at length, at Heb.\ 3:7--11, 3:15, 4:3,
...
\textbf{Of the seven scriptural elements this is the one whose appointed wording
no checked witness expounds}; the three composed orations have no exposition of
their text at all. The chant reads \latin{et Rex magnus super omnem
terram} where every Bible witness opened here reads \emph{above all gods} ---
...
sung. His §6 reading of the neighbouring \latin{in manu eius fines terrae} of
Christ joining two peoples is adjacent in sense to the chant's wording and belongs
...
two forms; the Latin does not preserve the identity with Deut.\ 18:15, which reads
\latin{suscitabit}.
...
est} (Ps.\ 5:10), and \latin{fleat pro te mater ecclesia, quae pro singulis
...
For the flesh of the Almighty Word is the body of life \dots\ as iron, when
brought into contact with fire, produces the effects of fire,'' so that it
...
the heart's chamber but published abroad, \latin{quasi per civitatis ostia
propalantem}, and the only son is mother Church, \latin{licet e multis collecta
personis, una sit perfecta et immaculata virgo}, with Gal.\ 4:19 quoted in
support; the gate is one of the bodily senses, closing with \latin{Obsecro, Domine
...
Gregory the Great has nothing on this pericope. Within Luke 7 the \work{Catena
aurea} cites \latin{Gregorius in Evang.} only at lect.~6, on the sinful woman of
Lk.\ 7:36--50; counted over the whole chapter the lemma frequencies are Ambrose
twenty-five, Bede twenty, Cyril eleven, Chrysostom eight, Titus five, Theophylact
three, Eusebius two and Gregory two plus one \latin{in Evang.}, and both bare hits
are the lect.~6 ones. Gregory's \work{Homiliae in Evangelia} treat Luke~7 only at
Homily~33, on the same pericope of the sinful woman.

\textbf{The eight-resurrections scheme the \work{Catena aurea} attributes to
\latin{Ambrosius} is nowhere in Ambrose's Luke commentary}, whose complete
critical text carries the raisings only at V.86 and VI.64 and the scheme at
neither: it may stand in another work of his, or be Ps.-Ambrose, or be a Glossa
attribution. Three further attributions in the same catena at this chapter have no
...
dative is Augustine's point, and his lemma is not the antiphon's: \latin{Ergo et
...
congregation and no longer the Church, and the objects continue to narrow at the
Postcommunion.

\textbf{No exposition of this prayer's text stands in any source opened for this
formulary}, and patristic and medieval exegesis of a composed euchological text is
not a category of writing. What the prayer asks to be defended from is named in
...
Read across the three orations, the objects narrow --- \latin{Ecclésiam tuam},
then \latin{nos}, then \latin{mentes nostras et córpora} --- while the verbs move
from cleansing and fortifying, through guarding and defending, to possessing and
going before. \textbf{Each oration's object is largely determined by its ritual
slot}, so the narrowing is as much a property of the euchological genre as of this
formulary.

\subsection*{The three orations, and the exposition that does not exist}
...
medieval work opened for this formulary. Exegesis of a composed euchological text
is not a genre the Fathers and Doctors wrote in.
...
scans alone; the Bobbio Missal carries no count of any of the five, and an optical
