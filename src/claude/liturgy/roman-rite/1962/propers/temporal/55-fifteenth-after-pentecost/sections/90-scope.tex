...
resting any negative search on them; the Pustet's classifies its layer prose
Latin and bounds that prohibition to searches over its accented text, and all
three admit quotation only through a checked passage. It is not a
page-image collation and
nothing is quoted from any of the three: where
\ifdefined\TriptychSynthesisEdition
the commentary reports one of their readings, a spelling or a point,%
\else
...
\ifdefined\TriptychSynthesisEdition
No English here is composed, translated, adapted or paraphrased. This edition
carries two registered English witnesses. The scriptural English is the
Douay--Rheims as revised by Bishop Challoner, in the tracked Project Gutenberg
e-text of that revision, with psalm loci resolved from the tracked numbering
concordance and not by arithmetic; what this edition quotes of it is the
Ps.\ 39:2--4 rendering in the notable-and-quotable gallery and the Douay
wording the commentary reports at the places it names. The English of the three
orations is \work{The Roman Missal translated into the English language for the
...
pp.~427--429 and found word for word the tracked transcription; of that book
this edition quotes the Alleluia versicle's own rendering at printed p.~428,
while the complete appointed text, with the Douay at every scriptural element
and this book at all three orations, stands in the canonical full edition and
not here.%
\else
...
use of the laity}, first revised edition (Philadelphia: Eugene Cummiskey, 1861),
which this audit read on the page images of the registered scan at printed
pp.~427--429 and found word for word the tracked transcription.%
\fi{} \textbf{That
...
identified historical English witness on that footing.
\ifdefined\TriptychSynthesisEdition
Where the registered English does not answer the Latin, this edition has no
appointed-text section in which to say so at the element: the four gaps that
follow and the missal's untranslated cues beside them are declared at the
element in the canonical full edition and recorded in full in
\texttt{propers/verified.md}.%
\else
Where the registered
English does not answer the Latin, the appointed-text section says so at the
element and leaves the gap open.%
\fi{} At four sung elements the Douay has no
...
untranslated. Of the four only the Alleluia's gap is closed, the 1861 book
rendering \latin{super omnem terram} at its printed p.~428. That book answers
the Offertory's \latin{hymnum} and not \latin{et respéxit me}, and at \latin{et
exaudívit deprecatiónem meam} it takes the Douay's verb with the missal's number
and so answers the missal's reading in number alone. \ifdefined\TriptychSynthesisEdition
\latin{Et respéxit me} is answered by neither the Douay nor the 1861 book, and
the Introit's added \latin{ad me} by the Douay;%
\else
\latin{Et respéxit me} is
answered by neither of the two Englishes printed at the Offertory, the Douay's
and the 1861 book's, and the Introit's added \latin{ad me} by the Douay, the one
English printed there;%
\fi{} the Communion's two readings are rendered distinctly by
none of the five English witnesses examined.
...
read at an exact locus in a named edition; that is every patristic, medieval and
liturgical citation here, each carrying its locus at the point of use in
\work{The Propers: Detailed Commentary} and, for the quotations the earlier
pages carry, in \work{References}. Source-grounded synthesis is an
...
Ambrosiaster, Theodoret, Marius Victorinus, Theophylact, Haymo of Halberstadt,
Peter Lombard, the \work{Glossa ordinaria}, Nicholas of Lyra, Denis the
Carthusian, Cornelius a~Lapide and William Estius; on the Gospel, Theophylact,
Titus of Bostra, Euthymius Zigabenus, Albert the Great, Bonaventure, Denis the
Carthusian, Hugh of Saint-Cher and Maldonado; on the Communion's verse, Hilary's
\work{De Trinitate} VIII, Irenaeus, Theophylact, Rupert of Deutz, Albert the
Great and Maldonado. Bonaventure's exposition of the Communion's verse was
located in a tracked public-domain volume and not read. Godfrey of Admont's
\work{Homilia LXXXII}, PL~174:575A--580C, and \work{Homilia LXXXIII},
PL~174:580C--583D, reach this formulary only as loci recorded in the preceding
Sunday's leaf; PL~174 was not opened, so what those two homilies say of these
passages is not established here.
...
the Cummiskey of 1861, the Lasance of 1945, Shepherd's English of Fromage's
continuation of Guéranger as printed in 1909 --- renders
either distinctly.
...
verse of the appointed Epistle; no Graduale, Liber usualis, Cantatorium or Latin
psalter other than the Clementine is registered at all, and the one Antiphonale
registered is Hesbert's \work{Antiphonale Missarum Sextuplex}, at catalogue level
with no artifact, so that no chant book's text is reachable here. No
...
this repository alone, over the tree at the commit \texttt{research/scope.md}
records: the 669 proper-guide files that search swept across both providers and
both calendars, the 628 article files it swept, both providers' theology and
history trees, the 1962 Ordinary and reference works beside this series, and the
tracked 1962 calendar registry and commentary corpus index. Those are the
sweep's extent at that commit and not the collection's present size. The open
web, external sermon and homiletic databases, printed chant repertories and any
universal literature search lie outside it, so \emph{not located in the checked
corpus} says only that this bounded corpus, fixed at that commit, does not hold
the conjunction.
