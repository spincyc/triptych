...
to the Corinthians, ``that you all speak the same thing and that there be no
schisms among you'', the verse that stands two verses after this Sunday's
Epistle ends.
...
Hilary reads the verse otherwise, and the difference is worth keeping. For him
peace and strength are joined but not identical: \latin{pax atque uirtus domus
huius conexa sunt sibi}. Nothing can be strong except out of peace, and
\latin{pax enim ecclesiae et unitas uirtutem nobis firmitatemque praestat}, the
Church's peace and unity give us strength and firmness (in Ps.~121, 13). For
Augustine and Cassiodorus the city's strength is its charity; for Hilary it is
...
at the right hand belong. Each is a reading of the same clause, and they
remain three allegories, not one.
...
The Gospel's ``his own city'' enters this reading through St Hilary, as St
Thomas Aquinas reports him in the \work{Catena aurea}. Christ, rejected by
Judaea, returns to his own city, and \latin{Dei civitas fidelium plebs est: in
hanc ergo introivit per navim, idest Ecclesiam, vectus}: the city of God is the
people of the faithful, and he entered it carried in the boat, which is the
Church. Aquinas himself, in his lectures on Matthew, gives the same kind of
reading beside his harmony of the Gospels: \latin{Et venit in civitatem suam,
...
have entered the courts.

\subsection{The earthly city rebuilt, and the strongest objection}
...
The reading therefore takes the return from exile as the literal sense of the
Gradual and the heavenly city of Augustine, Hilary and Cassiodorus as its
allegorical sense. St Robert Bellarmine holds both in that order: the psalm is
...
commentators on the Mass carry the same division into the chant. Honorius and
Sicard read all its chants of the people returned from captivity and give them
no heavenly city.
...
peace which they preach to the people'' (121, 13). The propositions this reading
takes from them stand without that setting: the city's peace is its charity,
the courts into which the faithful enter are one, and those who enter are
built into the house.

A third objection is that the chants are simply four psalm verses, each chosen
for a word, \latin{pacem}, \latin{domum}, \latin{gentes}, \latin{hostias}, and
that they describe no movement at all. One fact about the formulary tells
...
it carried in the boat of the Church, and the city he enters is the people of
the faithful (Hilary, as Aquinas reports him).
