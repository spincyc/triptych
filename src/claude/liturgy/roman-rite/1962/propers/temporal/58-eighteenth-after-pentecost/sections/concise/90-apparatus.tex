...
in the study; the map and the dossier's explanatory rows condense the study's. The joins between elements are the
...
and is never cited as Guéranger's. The history of the formulary's texts in
the early sacramentaries, chant books and lectionaries is given in the
expansive study, not here.
