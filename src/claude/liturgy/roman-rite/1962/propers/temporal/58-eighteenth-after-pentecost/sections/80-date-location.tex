...
answers the element's two loci separately. At the antiphon's verse, Ecclus
36:18, it dates the composition of the Book of Ecclesiasticus twice, with a
preferred interval and an alternate approximate year, both from the \work{Catholic
Encyclopedia}'s article ``Ecclesiasticus'' (1909) under the traditional
Catholic profile. The psalm verse, Ps 121:1, carries the Psalter's critical
boundary already given with the Gradual. Neither answer holds at both loci, so
the Date cell gives the element no single date. The antiphon's wording is
