...
Jerusalem, and for the fulfilment of the prophets' words. The Date cell prints
no date because the antiphon's book and its psalm verse have different answers
in the chronology record, and no one answer covers the element. The antiphon's
wording is liturgical: at its opening and its close it is neither the Vulgate's
nor the Greek's.}
\midrule
