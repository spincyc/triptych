...
quoted. St Hilary's commentary on Matthew was not reached; his reading of the
Gospel is given only as St Thomas Aquinas reports it in the \work{Catena aurea}
and in his lectures on Matthew. No patristic commentary on Ecclus 36:18 or at
the Offertory's cited verses of Exodus was located; the Introit and the
Offertory are read by the liturgical commentators on the Mass, whose books are
named with their own Gospels where they are first used. Anthony of Padua's
...
Mass as a whole except the liturgical commentators, and those whose Mass had
another Gospel are cited only for the elements it shares with this one.
...
and for the Introit no single answer. The Gospel's narrated event is undated.
...
of Aquinas on First Corinthians and the Marietti text of the \work{Catena aurea}
are modern presentations and are quoted briefly. The New American Bible
introduction and the dated Ordos are cited, not reproduced.
...
\item St Hilary of Poitiers, \work{Tractatus super Psalmos}, ed. A. Zingerle, CSEL 22 (Vienna, 1891): in Ps.~121, 1--5 and 13--14 (pp.~570--573, 578--579).
\item St Jerome, \work{Commentarii in Matthaeum} I, on 9:1--8 (Migne, PL 26, cols.~54--56).
\item St John Chrysostom, \work{Homilies on Matthew} 29, Nicene and Post-Nicene Fathers, 1st ser., vol.~10 (CCEL text).
...
\item St John Chrysostom, \work{Expositio in Psalmum CXXI} (Migne, PG 55, cols.~347--351).
...
\item St Thomas Aquinas, \work{Catena aurea in Matthaeum} c.~9, lect.~1 (Corpus Thomisticum text): the lemmata of Hilary and Rabanus.
...
\item Rupert of Deutz, \work{De divinis officiis} XII.18--19 (Migne, PL 170, cols.~326--327).
\item William Durandus, \work{Rationale divinorum officiorum} VI.135--136 (Lyon, 1612), vol.~2.
\item Honorius Augustodunensis, \work{Gemma animae} IV.84--86 (Migne, PL 172, cols.~722--724).
\item Sicard of Cremona, \work{Mitrale} VIII.18--19 (Migne, PL 213, cols.~599--600).
