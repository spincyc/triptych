...
earth, and confesses in its Collect that without God we cannot please God. It opens with \latin{Da pacem}, a request, and a destination: ``We shall
...
verse of the Clementine Vulgate. Its word for those who pray is
\latin{sustinentibus te}, those who wait for thee: the verb is patient
endurance, and what the antiphon asks is what waiting cannot produce. The psalm verse is the opening of Ps~121, a
...
\latin{sine te} ``without thy help''. The prayer asks for one thing, and the
verb of it is God's: his mercy does the directing, and the hearts it directs are
ours. It is the Mass's only collect, and the Mass's other petitions are of the
same kind, that God should do in us what we cannot begin.
...
thanked for its riches is the church about to be told of its parties. In these
five verses the Corinthians do nothing but receive and wait. The grace ``is
given'' them, they ``are made rich'', the testimony of Christ ``was confirmed''
in them, and the confirming to the end is Christ's. Every gift the lesson names, their utterance and their knowledge
among them, is one they did not make, and the thanks for it go to God.
...
gives, ``For the Lord hath built up Sion''. Both chants sing of the house the
Introit's verse set out for. The Gradual stands the pilgrims inside the walls
of Jerusalem and prays for her peace; the Alleluia sets the nations and their
kings before a Sion the Lord has had mercy on and built, so that the peace
asked for at the entrance is already a city before which the nations fear the
Lord's name.
...
sings the antiphon alone. In it every finite verb has Moses for its subject: he
hallows the altar, offers the holocausts, immolates the victims and makes the
evening sacrifice, and the people are named only at the end, as those in whose
sight it is done.
...
\latin{assequamur}: the knowing is indicative and already given, the attaining
subjunctive and asked for; and the Missal directs the Preface of the Most Holy Trinity
...
hostias, et introite in atria eius}. Its two commands come in order: the
sacrifices are brought first, and then the courts are entered. Where the
Vulgate has \latin{in atrio sancto
eius}, the Missal sings \latin{in aula sancta eius}. The Postcommunion begins \latin{Gratias tibi referimus},
...
perficias}. It gives thanks before it asks: the gift has been received, thanks
are returned for it, and only then does the prayer ask that the communicants be
made fit for what they have already been given. The Mass whose Epistle begins
\latin{Gratias ago} ends its prayers with thanks.
...
length in the expansive study. The first hears the formulary from its chants,
...
earned, with a man at its centre who was carried. They differ in emphasis, as
three governing questions put to one set of texts; each accounts for
something the others leave aside, and they answer several of the same
questions differently, the crowd's praise at the end of the Gospel among
them, where two of them part over whose judgement of it to follow.
