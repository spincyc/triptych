...
atmosphere of the heavenly Jerusalem.'' The first reading takes the same
order: the return from exile is the Gradual's literal sense and the heavenly
...
evangelistarum} II.25.58). Nothing in the text settles the town, and neither
reading needs it settled: the allegory holds whichever town is meant, and the
...
of \work{The Liturgical Year} (Dom Lucien Fromage). Read after the September
Ember ordinations, the gifts for which Paul gives thanks are above all ``the
powers conferred by the imposition of the bishop's hands on the ministers of the
Church''. That is the continuation's reading of the lesson on this Sunday, and
the second reading uses it as such. The three uses do not conflict. Chrysostom
...
Christ's already on earth. And he raises the objection the second reading must
face: the verse seems not to prove Christ's divinity, \latin{quia etiam ipsi
...
The Collect says outright what the Gospel shows. \latin{Quia tibi sine te
...
acceperis?} (1 Cor 4:7). The other two readings each find room for the
Collect: the first because a city no one can build for himself is still the city
to which the people go up, the second because the power at work in the Mass is
expressly not ours.
...
and must be raised. On Hilary's it closes as the Epistle opens, with God
glorified for what men have been given; the join of that praise to the
Epistle's \latin{Gratias ago} is the editor's, not Hilary's.

The second reading reports Chrysostom's judgement first and Hilary's after it,
and takes its own sense of the verse from neither. That sense is Bl.\ Ildefonso
...
comments, does not contain the words. The ministerial sense stands in four
places, and the second reading names them. Ambrose, glossing the scribes'
...
continuation places it in the keys and in Penance, which is why the second
reading does not make the altar the place where that power absolves.
...
Eucharist. The second reading joins the altar to the Gospel's power only through
that blood. Schuster regrets that the Missal has cut the antiphon to a single
...
The Communion's \latin{Tollite hostias} divides its witnesses over what the
sacrifices are, and the division runs between the second and third readings.
Augustine names the one present a creature can bring: ``Confession is a present
...
\latin{prius posuit, tollite, et sic introite}: first bring, and so enter. On
that reading the third reading rests. Theodoret reads instead the rational
sacrifices ``we see continually offered and sacrificed by the priests'', the
expositions under St Athanasius's name the spiritual sacrifices of the
churches' ``priests, I mean, and presidents'', and Bellarmine gives the contrite
heart first and then the Eucharistic sacrifice offered ``through the hands of
the priests of the New Testament''. On that reading the second rests. The
continuation holds both: the Communion ``is addressed to the priests, and, at
...
covertly accusing them'', marking them as still wavering; for Aquinas,
Ambrosiaster and Cornelius a Lapide it is a promise of perseverance, \latin{sine
crimine} being \latin{sine peccato mortali}. On either reading the confirming is
...
Pressed too far, the third reading would become quietism, and the formulary
refuses that: the Secret's \latin{dignis moribus assequamur}, the Communion's
