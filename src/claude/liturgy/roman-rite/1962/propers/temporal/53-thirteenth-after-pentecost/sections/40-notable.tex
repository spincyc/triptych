...
Straight exegesis, devotional reuse and bare quotation keep the phrase in its
own register, and the exegesis and reuse stand in the commentary above. Two of
the four rise from the same chant clause, and the pairing is telling: of
everything these
...
convergence, not a chain of dependence.
\end{afterlife}
