...
% them together with the escape clause that licenses them. The first is the
...
%
% Measurement note. THREE of the profile's fixed page-2 measurements are varied
% on this sheet, and these are all of them:
%
...
%       recorded as one.
%   D3. Spanning-row width. Profile 0.92\linewidth; here 0.93\linewidth.
%
% The profile provides for all three and states the condition: change its fixed
