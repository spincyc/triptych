...
% Tables and the fixed page-2 dossier keep their own declared widths. The web
% arm preserves the same text without emitting Pandoc fenced-div wrappers.
...
\else
\newenvironment{proposal}[1]{%
  \begin{studybox}{Editorial proposal --- #1}\small}{%
  \end{studybox}}
\fi
