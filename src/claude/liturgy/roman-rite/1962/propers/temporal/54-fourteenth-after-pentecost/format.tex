...
\newenvironment{proposal}[1]{%
  ...
  \begin{proposalbox}{Editorial proposal --- #1}\small}{%
  \end{proposalbox}\par}
\else
\newenvironment{proposal}[1]{%
...
% A targeted whole-entry variant remains available for short gallery entries;
% longer entries use the breakable environment above.
\ifdefined\TriptychPrintEdition
