...
\pfield{Mechanism}{The formulary states one choice in three grammatical
...
serve two masters, you cannot serve God and mammon. \textbf{The Gospel stands
in the comparative and the exclusive alike}, its \latin{Ideo} making the
exclusive premise the ground of the comparative argument, and the comparative
register is what keeps the exclusive one from reading as contempt for created
goods. \textbf{The Collect states the same preference in a third grammar},
neither comparative nor
exclusive: its one \latin{et \dots\ et} asks by the same help that the Church be
drawn back from what harms and steered toward what saves, \latin{et
abstrahátur a nóxiis, et ad salutária dirigátur} --- goods ordered by a single
instrument rather than set against each other.}
...
the chants look like decoration around two hard sayings. Read together, the
three registers are doing different grammatical work on the same choice.}
...
comparative evidence reaches only part of the anchor set --- \textbf{the
Communion and the Collect are thematic members here and not comparative ones},
and that is said rather than blurred. Thirdly, this must not be built as ``the chants soften
...
adjici}; and Christian of Stavelot supplies its elided object with its limit,
...
the fifteen formularies this guide has collated: the substantive
...
\pfield{Fruit}{On this reading the formulary's chief coherence is a boundary
its excerpts share, visible in the texts and not a theme laid over them. It
also gives the Gradual, the day's
...
vir, qui sperat in eo}. Across twenty-one collated texts of fifteen 1962
formularies, \latin{sperat in eo} stands in the appointed Latin of
...
formulary's own arrangement stages; and a way to hold
the Offertory's angel between Augustine's christological identification and
the creaturely readings.}
...
Augustine's text differs from the missal's at the following verb, \latin{eruet}
...
scholarship and that question was not swept. \textbf{And the strongest
alternative is a variant in the printed books at the Offertory's own opening
verb and subject}: 1962 reads \latin{Immíttet Angelus Dómini}, making the angel
of the Lord encamp; the Roman antiphonary of \work{Patrologia Latina}~78 reads
\latin{Immittet angelum Dominus}, making the Lord send an angel; and the Sarum
books read the present \latin{Inmittit}, making it a standing fact rather than a
promise. \textbf{On the antiphonary's reading the Offertory names no angel of
the Lord at all}, and the cross-chant identity this proposal turns on does not
arise in the form stated. Which of the three each reception witness had before
