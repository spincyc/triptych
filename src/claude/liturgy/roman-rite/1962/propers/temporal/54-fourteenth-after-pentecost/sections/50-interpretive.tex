...
\textbf{the Gradual alone sings it outright}. Three appointed excerpts stop
short of the same formula and a fourth sings it. \textbf{The Introit belongs
because the formula lies beyond both its boundaries, not because it uses hope
vocabulary --- which it does not:} the \latin{sper-} and \latin{confid-} stems
occur in the Gradual block only, twice each, and not at all in the Introit.}
...
eo} --- and an accent-normalised sweep over the twenty-one collated text
records covering fifteen distinct 1962 identities, the denominator
\textbf{Appendix: Scope and Qualifications} states, finds \latin{sperat in eo}
in the appointed Latin of the \textbf{Eighth Sunday only}, and \latin{gustate}
in the Eighth and the Fourteenth only --- a count over those collated records
and not over the Missal. So the beatitude of the one who hopes is not absent
from the repertory; it is assigned to the other Mass.}
...
assigns it to the \emph{offertory}. At the \textbf{Gradual} the excluded second
term is escalated to \textbf{good angels}, ``for angels also are called
princes,'' making the exclusion absolute rather than moral --- against
