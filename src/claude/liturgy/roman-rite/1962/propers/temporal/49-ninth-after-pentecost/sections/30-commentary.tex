...
Each appointed element stands below under its Latin incipit, its printed
heading and reference, and the missal's marginal number, with its text in the
English of an identified public-domain witness, and then its evidence.
\latinpolicynote
...
Latin, each gap stands at its element, unfilled.
...
facsimile of the Vatican \latin{editio typica} (printed pp.~388--389), and
independently against the page images of the Benziger \latin{editio iuxta
typicam} of the same year (printed pp.~382--383). The two books are not two
photographs of one page; they are two editions, and they differ. The typical
edition governs every form printed here, and no form mixes the two; every
...
prints the contracted \latin{eícere} where Benziger and the Clementine Vulgate
print the uncontracted form. Neither changes a meaning. Both show that ``the
1962 Latin'' is not a single artefact, and that a reading cited without its
witness does not tell the reader what was checked.

\subsubsection*{Ten places where the appointed text is not the Bible's text}

The more consequential collation is against the Clementine Vulgate itself.
At ten places, verified directly, the printed missal and the printed Vulgate
read differently. All ten are gathered once, in the table below, and
each recurs later at the element where it bears on an argument. Because an
argument about wording cannot be conducted in translation, the Latin stands on
the page here.

\begin{receptiontable}{Proper and locus}{Appointed text}{Clementine Vulgate}
1. \cue{Int.} Ps. 53:6 & \latin{Ecce Deus ádiuvat me} & \latin{Ecce enim Deus adjuvat me} --- the antiphon drops \latin{enim}, and the Douay's ``For behold'' renders the word the missal does not sing\\
2. \cue{Int.} Ps. 53:3 & \latin{et in virtúte tua líbera me} & \latin{et in virtute tua judica me} --- a different verb, and the one every checked expositor of the psalm comments on\\
3. \cue{Int.} Ps. 53:7 & closing \latin{protéctor meus, Dómine} & no counterpart anywhere in Ps. 53:6--9; the vocative is the antiphon's own\\
4. \cue{Ep.} 1 Cor. 10:6 & \latin{Fratres: Non simus concupiscéntes malórum} & the lesson opens mid-verse; the missal's \latin{Fratres:} stands where the Clementine has \latin{Hæc autem in figúra facta sunt nostri}\\
5. \cue{Ep.} 1 Cor. 10:8 & \latin{vigínti tria mília} & \latin{millia} --- orthographic; see the edition table above\\
6. \cue{Gosp.} Lk. 19:41 & \latin{In illo témpore: Cum appropinquáret Iesus Ierúsalem} & \latin{Et ut appropinquávit} --- the liturgical incipit supplies a subject and an object the evangelist does not name here, and the Douay accordingly has neither\\
7. \cue{Gosp.} Lk. 19:45 & \latin{cœpit eícere} & \latin{cœpit ejicere} --- orthographic\\
8. \cue{Off.} Ps. 18:9--12 & one continuous antiphon & a centonisation of vv.~9a, 10c, 11b and 12a; the missal prints four verse numbers rather than a range because the text is built, not quoted\\
9. \cue{Off.} Ps. 18:12 & \latin{nam et servus tuus custódit ea} & \latin{Etenim servus tuus custodit ea} --- a different connective, invisible in English, where the Douay reads ``For'' either way\\
10. \cue{Comm.} Jn. 6:57 & \latin{in me manet, et ego in eo, dicit Dóminus} & \latin{in me manet, et ego in illo} --- a different pronoun, and \latin{dicit Dóminus} is the liturgy's attribution formula, absent from the verse\\
\end{receptiontable}

Two negative results complete that table. The Gradual (Ps. 8:2) and the
Alleluia verse (Ps. 58:2) match the Clementine psalter word for word, and are
the only appointed scriptural texts of the day of which that is true without
qualification. Nothing in the list is a defect in the missal: the Roman Church
used an older Latin psalter before Jerome's Gallican recension displaced it in
the Bible, and the 1910 \work{Catholic Encyclopedia} records that the Roman
recension ``remained in use in Rome for a considerable time, and at the
present day is still used in the Divine Office chanted at St.~Peter's.'' That
is the natural explanation of a chant text older than the Bible text beside
it. Each divergence is verified on the page; the derivation is not
established here, because no \work{Psalterium Romanum} witness was collated
for it.

\subsubsection*{Four attributions the sources do not bear out}

Each of these is a claim the standard delivery of the source invites, and each
is wrong. The four stand together in this table, and the evidence for each
stands at the proper it belongs to.

\begin{correctionstable}
``Aquinas on 1 Corinthians 10 \dots'' & The exposition of this chapter circulating inside the Thomistic corpus is Peter of Tarantaise's. Corpus Thomisticum's own editorial note says the \latin{lectura} from chapter~10 is lost and the gap filled from him; Larcher's English prints a bracket in place of the text & Epistle\\
...
``Bede's exposition of this pericope \dots'' & Bede's Lucan exposition of Lk. 19:41--47 is substantially Gregory's Homily 39, close enough that whole clauses recur verbatim. What is Bede's own is the Exodus 12 typology at the end & Gospel\\
\end{correctionstable}

\elementguard
\subsection*{Introit \cue{Int.}}

\elementid{Ecce Deus ádiuvat me}{\latin{Ant. ad Introitum} --- Ps. 53, 6-7, with \latin{Ps. ibid.,} 3}{1522}

\begin{namedtranslation}{English: Douay--Rheims (Challoner), Ps. 53:6--7 and 53:3}
\textbf{Antiphon} (vv.~6--7): For behold God is my helper: and the Lord is the
protector of my soul. Turn back the evils upon my enemies; and cut them off in
thy truth.

\textbf{Psalm verse} (v.~3): Save me, O God, by thy name, and judge me in thy
strength.
\end{namedtranslation}

That English is the English of the psalm, and at three points it is not the
English of the antiphon.

\englishgap{\textit{First}, the antiphon's closing vocative \latin{protéctor
meus, Dómine} has no counterpart in Psalm 53 and therefore none in the
Douay--Rheims. Nothing in the registered public-domain English answers it, so
the vocative stands here without English. What it asks is plain enough
to describe: after the imprecation, the singer turns and addresses God directly
by the title the psalm had used of him in the third person a line earlier.
\textit{Second}, at the psalm verse the missal sings \latin{líbera me} where
the Clementine reads \latin{judica me}; the Douay renders the Clementine, ``and
judge me in thy strength,'' so it cannot be quoted for the missal's verb, and
no other registered public-domain witness carries this chant's text. The
English printed above therefore has the Clementine's verb, not the chant's.
\textit{Third}, and least
consequentially, the Douay's opening ``For'' at v.~6 renders the \latin{enim}
the antiphon drops, so the English printed above begins one word longer than
the antiphon does.}

\textbf{The consequence for reception.} The Fathers and
...
disperde illos}, and he expounds \latin{virtus}; the Introit sings \latin{in
veritáte tua}. At v.~3 Augustine, Aquinas and Bellarmine all read and gloss
\latin{iúdica me}, not the Introit's \latin{líbera me}. Quoted for the
Introit's psalm verse without saying so, their exegesis becomes a comment on
words they did not have.
...
that they be cut off at all --- \latin{orate pro persequentibus} --- and
...
might pray it. He reads the opening clause as confidence in help coming before
long. Alone among the four witnesses here he reads \latin{in veritáte tua} ---
the Introit's own text --- and takes it, strikingly, as addressed to the Holy
Spirit. Theodoret was consulted in Robert Hill's modern English translation,
which is in copyright; he is therefore summarised and not quoted, and the PG column numbers above are those printed inline in that
translation, not read off a Migne scan.
\end{witnessnote}

\elementguard
\subsection*{Collect \cue{Coll.}}

\elementid{Páteant aures misericórdiæ tuæ}{\latin{Oratio}, composed oration}{1523}

\begin{namedtranslation}{English: Cummiskey, \work{The Roman Missal \dots\ for the use of the laity} (Philadelphia, 1861), Collect of this formulary, printed p.~414}
...
\textbf{That English changes the subject.} The 1861 rendering ``that they may succeed in their desires'' has a different
grammatical subject from the Latin it translates. The missal's
\latin{ut peténtibus desideráta concédas} makes God the agent --- that
\textit{thou} mayst grant to those who ask the things they desire --- and the
petitioners the recipients. The 1861 English is the registered public-domain
witness for this formulary, and at this point it will not bear the weight of
the argument. The Latin carries the argument, and for that reason it stands
here.
...
on the imperative that follows it, \latin{fac eos, quæ tibi sunt plácita,
postuláre}, and the printed semicolon marks the join. God is asked to do
something to the petitioners before he does anything about the petition.

Two features of the Latin are worth holding, and neither survives into the
1861 English. \latin{Páteant} is not ``open thine ears'' but ``let thine ears lie
open'': a state, not an act, and the metaphor is of a door already ajar. And
\latin{desideráta} --- the things desired --- is left deliberately
unqualified, so that the prayer never says the things desired are good. It
says only that they are desired, and then asks that what is desired be made to
coincide with what pleases God.

That is why this Collect reads so pointedly in front of this Epistle. The wilderness
generation of 1 Corinthians 10 did not lack petitions; Numbers 11 is a
narrative of granted requests. The Epistle's ``that we should not covet evil
things'' is its way of saying what the Collect asks God to prevent.

\textit{No commentary on the wording located.} No patristic or medieval
commentary on this oration's wording was located; composed Roman collects of
this type carry no ancient commentary tradition comparable to that on the
Scriptures. The printed Latin, its punctuation, and its juxtaposition are
therefore the whole basis of the analysis above, and no located commentary
stands behind it.

% The Epistle's heading, reference line and English box must share a page.
\Needspace{18\baselineskip}
\subsection*{Epistle \cue{Ep.}}

\elementid{Fratres: Non simus concupiscéntes malórum}{\latin{Léctio Epístolæ beáti Pauli Apóstoli ad Corínthios} --- 1 Cor. 10, 6-13}{1524}

\begin{namedtranslation}{English: Douay--Rheims (Challoner), 1 Cor. 10:6--13}
\textbf{[v.~6, first clause: Now these things were done in a figure of us ---
the words the missal replaces with its own address \latin{Fratres:}]} \dots\
that we should not covet evil things, as they also coveted. Neither become ye
...
by the destroyer. Now all these things happened to them in figure: and they
are written for our correction, upon whom the ends of the world are come.
Wherefore, he that thinketh himself to stand, let him take heed lest he fall.
Let no temptation take hold on you, but such as is human. And God is faithful,
...
\latin{Fratres:} is the missal's, not Paul's, and the bracket above marks
exactly what it displaces. The pericope opens mid-sentence at v.~6 --- so the
assembly does not hear vv.~1--5, where the sea and the cloud are read as a
baptism and the rock is Christ --- and it closes at v.~13, so the assembly
does not hear v.~14, where Paul's ``Wherefore'' leads straight from divine
faithfulness to ``fly from the service of idols'' and then, at vv.~16--17, to
the cup, the bread, and the many who are one body. The Sunday will get to the
one bread; it will get there through the Communion and the Postcommunion
rather than through the lesson.
...
``there fell in one day three and twenty thousand'' (v.~8) & Numbers 25: Baal-Peor & Numbers 25:9 reads \latin{viginti quattuor milia} --- four and twenty thousand --- and so do the Hebrew and the Greek. No witness to Numbers gives twenty-three thousand: the difference is Paul's own, and it stands in his text\\
``perished by the serpents'' (v.~9) & Numbers 21:5--6 & The complaint there is disgust at the manna --- \latin{anima nostra iam nausiat super cibo isto levissimo} --- which is why the clause can be chained to a Eucharistic warning at all\\
``destroyed by the destroyer'' (v.~10) & The murmuring cycles & Speech is added to appetite and act. The referent is genuinely unsettled: \latin{exterminator} has no lexical counterpart in the Vulgate of either chapter, and the two Latin commentators anchor it differently --- Ambrosiaster at Numbers 14, Peter of Tarantaise at Numbers 16:41\\
\end{receptiontable}
...
comment on the verse, do not raise the question at all. The difference itself
stands in Paul's text, and both explanations remain Peter of Tarantaise's.
...
``issue'' that God makes with the temptation he is concrete to the point of
arithmetic: God will either give strength or cut the trial short, ``so that he
who is known to be able to endure no more than three days is not allowed to
suffer on the fourth.'' The passage was read in the Migne text of the 1845
printing, where the embedded column marks put the passage at
coll.~144--145; other Migne printings of the same work carry a different
column system, and CSEL 81/2 was not consulted.
\end{witnessnote}

\begin{witnessnote}
\wlocus{Correction 1: the commentary on this chapter is Peter of Tarantaise, not Aquinas}
...
supplied by Peter of Tarantaise]'' in place of the text. Cited as Aquinas at
a Marietti number, this material is a text his editors flag as someone
else's. What the passage actually contains
...
\latin{qui non habent ventum superbiae}. \textbf{Correction 2 travels with
it:} its maxim \latin{Augustinus: propter Christum pati humana tentatio est}
is verbatim Ambrosiaster, quoted just above; it is a gloss-transmission
misattribution, not a saying of Augustine.
\end{witnessnote}

\textit{Augustine on v.~13.} Two loci were verified in which
...
suffices. His lemma reads \latin{exitum}, not the Vulgate's
\latin{provéntum}. No Augustinian citation of v.~12 was found in the works
searched; the \work{Enarrationes} and \work{Sermones} were not exhaustively
searched for it, so a citation remains possible.
...
isolated sufferer, a fact the Douay's ``you'' cannot show and the modern
reader's ``you'' actively hides. And it says that God \textit{makes} something
with the testing, a \latin{provéntum}: an outcome, an issue, a way through,
which is supplied rather than found. The Douay renders it ``issue.'' What the
verse does not say is that every affliction has been measured to what one
person can privately bear.

\elementguard
\subsection*{Gradual \cue{Grad.}}

\elementid{Dómine Dóminus noster}{\latin{Graduale} --- Ps. 8, 2}{1525}
...
Here the chant and the Vulgate agree exactly, and the Douay silently shows how
the chant is built: the whole Gradual, respond and verse together, is one verse
of the Douay--Rheims, printed as a single sentence. The division into respond and verse falls on the \latin{quóniam}
that the Douay renders ``For,'' so that the responsorial form itself carries a
logical relation: the wonder, then its reason.
...
smallness under a sky, and its continuation --- ``What is man, that thou art
mindful of him?'' --- is quoted verbatim in Hebrews 2:6--8, where the argument
turns on the fact that we do not yet see all things subject to him. The
Gradual quotes only v.~2, and v.~2 is all of the psalm that this Mass sings.
But the appointed verse comes from a poem whose next move is exactly
the move the Epistle has just demanded: stop estimating your own standing.

\elementguard
\subsection*{Alleluia \cue{All.}}

\elementid{Eripe me de inimícis meis}{Alleluia, no separate heading --- Ps. 58, 2}{1526}

\begin{namedtranslation}{English: Douay--Rheims (Challoner), Ps. 58:2, between the chant's own \latin{Allelúia} acclamations}
Alleluia, alleluia. ℣. Deliver me from my enemies, O my God; and defend me
from them that rise up against me. Alleluia.
\end{namedtranslation}

The appointed verse matches the Clementine psalter word for word --- one of
only two appointed scriptural texts of which that is true --- so the Douay
answers it directly and leaves no gap. Augustine, however, was
reading an Old Latin text: his lemma runs \latin{Erue me de inimicis meis,
Deus meus, et ab insurgentibus super me redime me}, with different verbs in
both halves. His exegesis is of that text.

\textbf{An independent convergence.} The psalm's title
...
\textit{No Thomistic exposition.} Aquinas wrote no commentary on this psalm. His
...
\elementid{Cum appropinquáret Iesus Ierúsalem}{\latin{✠ Sequéntia sancti Evangélii secúndum Lucam} --- Luc. 19, 41-47}{1527}

\begin{namedtranslation}{English: Douay--Rheims (Challoner), Lk. 19:41--47a}
\textbf{[The missal opens \latin{In illo témpore: Cum appropinquáret Iesus
Ierúsalem} --- naming a subject and a city the evangelist does not name here,
and which the Douay accordingly does not carry.]} And when he drew near,
seeing the city, he wept over it, saying: If thou also hadst known, and that
in this thy day, the things that are to thy peace: but now they are hidden
from thy eyes. For the days shall come upon thee: and thy enemies shall cast a
trench about thee and compass thee round and straiten thee on every side, And
beat thee flat to the ground, and thy children who are in thee. And they shall
not leave in thee a stone upon a stone: because thou hast not known the time
of thy visitation. And entering into the temple, he began to cast out them
that sold therein and them that bought. Saying to them: It is written: My
house is the house of prayer. But you have made it a den of thieves. And he
was teaching daily in the temple.
\end{namedtranslation}

The appointed reading ends there. The Douay's v.~47 continues ``And the chief
priests and the scribes and the rulers of the people sought to destroy him'';
the missal cuts before it, and so does the English above. The break is the
missal's, and it is the single most consequential editorial act in the
formulary.

The \latin{Credo} is printed on its own line immediately after this Gospel.
...
11:17 keeps \latin{omnibus gentibus}; Luke does not, and the Douay's ``My
house is the house of prayer'' shows the shortened form as plainly as the
Latin does. The Roman Office, as the continuation of Guéranger's \work{The
Liturgical Year} (Dom Lucien Fromage) prints it, restores the fuller form in
its Magnificat antiphon for this Sunday --- \latin{domus orationis est cunctis
gentibus} --- which is a liturgical conflation of Luke with Mark and Isaiah,
not Luke's text.
...
overcome after years of chastity. The only English translation of this
homily is modern and in copyright; the Latin is
...
plain demonstration of it.'' The things that are to thy peace he glosses as
``the things, that is, useful and necessary for you to make your peace with
God,'' and he reads the hiding through 2 Corinthians 3 (the veil) and Romans
11:25, where the blindness is \textit{in part}. He treats the siege as
fulfilled --- without ever naming Titus, Vespasian or the Romans --- and
immediately softens it: Israel ``did not perish from the very roots,'' the
apostles being the firstfruits.
\end{witnessnote}
...
wept.'' That elision is the one grammatical fact of the Gospel that the Douay
cannot show, because its ``If thou also hadst known \dots\ the things
that are to thy peace'' reads as a completed sentence and the Latin does not:
\latin{quæ ad pacem tibi} has no verb at all. He names the agents of the
destruction, Vespasian and Titus, and argues that not one stone was left from
the city's own later migration to the ground outside the gate where the Lord
was crucified. The cause is the unrecognised visitation, clinched with
Jeremiah 8:7, where kite, turtledove, swallow and stork all keep their seasons.
\end{witnessnote}
...
This second pass is where the homily's weight falls, and the Roman
Breviary's Matins lessons for this Sunday stop at §§1--2 --- the historical
reading --- and never reach it.

\subsubsection*{The Temple, and who the tradition thinks the thieves are}

The striking fact about the patristic handling of the den of thieves is how
consistently it is turned on the clergy.
...
orationis} or \latin{spelunca latronum}. The passage is Book~IX, not Book~X,
where it is sometimes placed.

\textbf{The same passage of Ambrose also expels the Synagogue.} In the same
section, at §22, he writes that the Jews are expelled
...
very passage, and an account without it falsifies the reception history of
this pericope.

\textbf{Correction 4: Bede's exposition of this pericope is largely
Gregory's.} Bede, \work{In Lucae Evangelium Expositio} V (PL 92, 570C--574B),
reproduces Gregory's Homily 39 closely enough that whole clauses recur
verbatim --- \latin{ruinam perfidae civitatis}, \latin{ex culpa sacerdotum
fuit}, \latin{Sicut templum Dei in civitate est}, \latin{quotidie Veritas in
templo docet}. Bede told Acca that he marked patristic borrowings with
marginal initials; Migne does not preserve them. What \textit{is} Bede's own
is the closing block at 573C--574B: an Exodus 12 typology in which the lamb
taken on the tenth day corresponds to the five days between the reception of
the Lord near the Mount of Olives and the Pasch --- lamb because he takes away
sin, kid because he was charged with it; the crowd singing \latin{Benedictus
qui venit} brought in the lamb, and the Pharisees' \latin{Magister, increpa
discipulos tuos} the kid. This is the pericope's own bridge to the Passion,
and it is Bede's.

\subsubsection*{Augustine and the \work{Summa} on this Gospel}
...
latronum} at \work{Enarr.\ in Ps.} 130 (LXX) §§1--3, and the sentence there,
though not written on Luke, is the one that most nearly answers this Gospel:
...
what is shown above for each of them. The compilation is a map of reception, not a
...
and that strain is part of this pericope's reception history. The most
convenient witness is a hand missal companion long used with these very
propers: Dom Laurence Shepherd's English of Dom Lucien Fromage's continuation
of Guéranger's \work{The Liturgical Year}, whose 1909 volume introduces the Mass of this Sunday with ``Israel had
made himself the enemy of the Church; and God \dots\ punishes and disperses
his children'' (p.~224), and on the Gospel writes of ``the Jewish deicides''
and ``the apostate nation'' (pp.~227, 230). That book supplies none of the
English printed in this guide --- the Douay--Rheims and the 1861 Cummiskey
missal do --- but it shows what the devotional reception of this formulary
actually said in living memory.
...
The pericope's own quotations settle the
register. Christ indicts the Temple with Jeremiah's
...
\latin{Et erat docens cotídie in templo}, ``And he was teaching daily in the
temple.'' The imperfect periphrastic is durative: not ``he taught'' but ``he
was teaching, daily,'' and the Douay's English happens to preserve it exactly.
Gregory reads it as grace following discipline, and glosses it in the moral
pass as \latin{quotidie Veritas in templo docet} --- when Truth patiently
instructs the mind of the faithful to avoid evil, Truth is teaching daily in
the temple. The missal's cut, here rather than four words later where the
plot begins, means the assembly's last impression of the
day's Gospel is of a teacher who did not leave.

\elementguard
\subsection*{Offertory \cue{Off.}}

\elementid{Iustítiæ Dómini rectæ}{\latin{Antiphona ad Offertorium} --- Ps. 18, 9, 10, 11 et 12}{1528}

The Offertory is the one appointed element for which the registered English
offers no continuous counterpart, because the psalm offers no continuous Latin
one either: the antiphon is built out of four separated parts of four verses.
Stitched into a seamless paragraph, the Douay would present the seam as a
translation; the four verses stand whole below, with the parts the antiphon
takes marked.

\begin{namedtranslation}{English: Douay--Rheims (Challoner), Ps. 18:9--12 in full, with the antiphon's four fragments in bold}
...
\textbf{sweeter than honey and the honeycomb.}

\textbf{v.~12} \textbf{For thy servant keepeth them,} and in keeping them
there is a great reward.
\end{namedtranslation}

Read in the antiphon's order the four fragments say: the justices of the Lord
are right, rejoicing hearts, and the judgments of the Lord sweeter than honey
and the honeycomb; for thy servant keepeth them. The construction is faithful
to the psalm's own grammar --- in vv.~10--11 it is the judgments that are more
desirable than gold and sweeter than honey --- but the appointed text is a
made thing, not simply ``Psalm 18:9--12.'' One Latin detail does not survive into the Douay at all: the missal
replaces the psalm's \latin{Etenim} with \latin{nam et} at the join to v.~12,
and the Douay reads ``For'' either way.
...
proof, he says, is twofold --- by experience, the servant who keeps them, and
by effect. Then he presses the preposition: Scripture does not say \latin{pro
custodia} but \latin{in custodiendis illis}, because the keeping of them is
itself the great reward. The distinction is exactly the one the Douay's ``and
in keeping them there is a great reward'' preserves and the antiphon, which
...
unitatis}. The second sermon is not in the public-domain NPNF English, which prints only the first; it was read in Latin.
\end{witnessnote}
...
Johner's book was published in the United States in 1940; a search of the standard renewal record found no renewal, which points
...
\elementid{Concéde nobis, quæsumus, Dómine}{\latin{Secreta}, composed oration}{1529}

\begin{namedtranslation}{English: Cummiskey, \work{The Roman Missal \dots\ for the use of the laity} (Philadelphia, 1861), Secret of this formulary, printed p.~415}
...
petition follows from it. Three Latin words carry it, and one of them the 1861
English has to split in two. \latin{Frequentáre} does not mean ``to frequent''
in the modern sense but to do a thing repeatedly and attentively --- hence
``frequently and worthily to celebrate,'' where the missal has a single verb
and one adverb, \latin{digne}. \latin{Quóties} makes the relation
distributive: not ``because this is a great mystery'' but ``as often as.'' And
\latin{exercétur} is present passive: the work is being carried on, now, here,
in the celebration.
...
clause --- \latin{In mysterio Sacrificii Eucharistici, in quo munus suum
praecipuum sacerdotes adimplent, opus nostrae redemptionis continuo
exercetur} --- and its note 105 identifies the same prayer. The two conciliar
uses are not identical: the Decree inserts \latin{continuo}, so the Decree's
is a documented reuse of the clause and not a verbatim repetition. Here, more
than anywhere in the formulary, the Latin is itself the evidence: four particular Latin words
were carried into a conciliar constitution.
...
where Benziger prints only \latin{Per Dóminum} and the 1861 hand missal prints
only ``Thro'.'' Since the Secret is said silently and this conclusion is the
point at which the celebrant's voice returns aloud, the difference is not
merely typographical for anyone using the book.

The rubric \latin{Præfatio de Ssma Trinitate} --- the Preface of the Most Holy
Trinity --- is printed immediately after this prayer, with \latin{Ssma} under
a tilde abbreviation for \latin{Sanctissima}.

\elementguard
\subsection*{Communion \cue{Comm.}}

\elementid{Qui mandúcat meam carnem}{\latin{Ant. ad Communionem} --- Io. 6, 57 (Clementine; 6:56 in the modern critical numbering)}{1530}

\begin{namedtranslation}{English: Douay--Rheims (Challoner), Jn. 6:57}
He that eateth my flesh and drinketh my blood abideth in me: and I in him.
\end{namedtranslation}

\englishgap{The antiphon closes \latin{dicit Dóminus}, which is not part of the
Johannine verse and therefore not in the Douay. It is the liturgy's own
attribution formula, and with it a first-person sentence is sung as the
Lord's, not the singers'.}

The antiphon also reads \latin{et ego in eo} where the Clementine Vulgate
reads \latin{et ego in illo}. Both were checked directly against the
Clementine text of John 6:57, and the difference is invisible in English:
``and I in him'' either way.

\textbf{Why the verse number differs between editions.} The Clementine chapter has seventy-two verses, and so does the
Douay--Rheims that renders it; the critical text has seventy-one. The offset
begins at critical v.~51, which the Clementine divides in two: its v.~51 is
\latin{Ego sum panis vivus, qui de caelo descendi} and its v.~52 begins
\latin{Si quis manducaverit ex hoc pane}. From that point on, Clementine
equals critical plus one --- which is exactly why the missal prints \latin{Io.
6, 57} for a clause most current editions number 6:56. The missal's number
stands here with the other beside it, and the Douay is quoted at its own
v.~57, where the same words stand.
...
on the first, which is why the Douay's colon does the work an English verb
would otherwise have to. One act of eating, two directions of indwelling. Of
the ten propers this is the only one whose motion is reciprocal: every other
text of the day runs either from God toward the assembly or from the assembly
toward God.
...
public-domain NPNF first series, vol.~7, tr.\ John Gibb. \textbf{Correction 3:}
1 Corinthians 10:17 is quoted in Tractate 26 only, not in Tractate 27.
\end{witnessnote}
...
Johner hears the same structure in the melody, and his observation carries
weight because it is arrived at independently of the exegesis: the
...
\elementid{Tui nobis, quæsumus, Dómine}{\latin{Postcommunio}, composed oration}{1531}

\begin{namedtranslation}{English: Cummiskey, \work{The Roman Missal \dots\ for the use of the laity} (Philadelphia, 1861), Postcommunion of this formulary, printed p.~415}
...
\textit{and then} unity, but both at once from one act. The 1861 English keeps
the pairing with ``both \dots\ and,'' which is the whole of what the argument
needs. What it cannot keep is the word order: the genitive phrase \latin{Tui
\dots\ sacraménti} is split around the address, which throws \latin{Tui} into
first position. The sacrament is \textit{thine} before it is ours, and no
English sentence of this shape can put that word first.
...
for a cleansing and a unity that are still being asked for.
