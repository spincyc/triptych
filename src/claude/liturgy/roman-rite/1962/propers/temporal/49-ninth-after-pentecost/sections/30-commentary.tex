...
Douay--Rheims. Nothing in the registered public-domain English answers it, and
this guide does not supply a rendering of its own. What it asks is plain enough
...
divergence is left standing rather than papered over. \textit{Third}, and least
...
petitioners the recipients. This guide quotes the 1861 English because it is
the registered public-domain witness for this formulary, and points out where
it will not bear the weight of the argument. The argument itself is conducted
on the Latin, and the Latin is quoted for that reason.
...
Here the chant and the Vulgate agree exactly, and the Douay silently proves
the guide's point about the chant's construction: the whole Gradual, respond
and verse together, is one verse of the Douay--Rheims, printed as a single
sentence. The division into respond and verse falls on the \latin{quóniam}
...
made thing, and this guide says so rather than describing it as ``Psalm
18:9--12.'' One Latin detail does not survive into English at all: the missal
...
uses are not identical: the Decree inserts \latin{continuo}, so it is
documented reuse rather than verbatim repetition, and this guide reports it as
such. This is the clearest case in the formulary where the Latin must be on
