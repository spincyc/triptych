...
use that moves the phrase into a register its author did not occupy. None of
them is exegesis, devotional reuse, or bare quotation. Two of the three come
from the same four words of the Gospel, and the concentration is telling: of
everything the appointed texts contain, \latin{spelúncam latrónum} is what English took, kept,
and turned loose.
...
cadat}, Douay--Rheims ``Wherefore, he that thinketh himself to stand, let him
take heed lest he fall.'' The epitaph below turns on the English idiom that
renders the Latin.
...
latrónum}, Douay--Rheims ``But you have made it a den of thieves.''
...
\textbf{The turn.} This is a double reversal, which sets it apart from a
hundred sermons on financial greed. Bierce first performs the
...
Douay--Rheims and King James wording ``den of thieves''; Bierce does not cite Luke, and
the dependence is on the naturalised English idiom rather than on this
pericope specifically. The money-changers usually invoked alongside this
phrase are \textit{not} in the appointed Gospel: Luke names only
...
\textbf{Appointed phrase.} As above, \latin{spelúncam latrónum}, Douay--Rheims
``a den of thieves.''
...
The biblical wording is the translator's, and it shows that by 1908 ``den of thieves'' had become so natural an
...
side by side; it is not evidence of any biblical allusion by Molière, and
