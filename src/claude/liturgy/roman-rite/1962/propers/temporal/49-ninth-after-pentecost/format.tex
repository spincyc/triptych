...
% The canonical full edition also prints the complete appointed Latin.
...
\renewcommand{\latinpolicynote}{The complete appointed Latin has already been
...
\renewcommand{\editionnote}{\textbf{Which edition this is.} This canonical full
edition prints the complete appointed formulary --- the Latin of the 1962
Vatican \latin{editio typica} with the English of the registered public-domain
witnesses --- and then carries the map, dossiers, commentary, synthesis, and
apparatus from the same source leaf.}
...
% The thesis of the thematic movement, which opens that section directly as
% prose: no box and no label, as the profile's reader-first rule requires.
\newcommand{\movementthesis}[1]{#1\par}
