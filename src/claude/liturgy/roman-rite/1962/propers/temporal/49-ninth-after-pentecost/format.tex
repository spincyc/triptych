...
printed above, in liturgical order and beside the same English; below, it
recurs only where an argument turns on the wording.}
...
\toprule
\textbf{The claim as usually made} & \textbf{What the sources actually show} & \textbf{Proper}\\
\midrule
\endhead}
{\bottomrule\end{longtable}}
