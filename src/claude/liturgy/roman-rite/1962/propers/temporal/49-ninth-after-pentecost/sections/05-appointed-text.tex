...
a tracked public-domain witness; the basis and its bounds are set out in full
in the terminal appendix. No rights are claimed
in this text, and none of it has been composed, translated, modernised,
conflated or adapted for this edition. Every form below was visually
...
altar book or a hand missal, and none of it was composed, translated, adapted
or paraphrased for this edition. Where the registered
English does not answer the missal's Latin --- and it fails to at four points
in this formulary --- each gap stands at its element, unfilled.
...
\englishgap{Three clauses of the antiphon are not answered by that English,
which stands as the Douay prints it. The antiphon's closing vocative
...
\englishgap{Not a missing clause but a shifted subject, and one that matters.
\latin{Ut peténtibus desideráta concédas} makes God
...
succeed. The rendering is the registered public-domain witness for this
formulary; the Latin carries the argument built on the prayer's grammar, in the
detailed commentary.}
...
marked; stitched together, the fragments would make an English paragraph that
no registered English witness prints. Read in the antiphon's own order the
