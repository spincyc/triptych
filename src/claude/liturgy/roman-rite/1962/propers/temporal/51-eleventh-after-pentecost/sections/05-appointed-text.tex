...
The ten elements follow in the order the missal prints them. First comes the
complete appointed formulary, against which every later claim can be checked;
then what two 1962 editions actually print, and where the appointed text
differs from the Bible's; then each element in turn, from the complete
canonical context of its passage, through the direct exegesis of witnesses who
had it in front of them, to later reception --- each witness with what he
actually argues, and the witnesses divided where the tradition divides.
...
identified public-domain witness. These texts stand here complete, as only
the canonical full research edition prints them.
...
and all ten again in the Venice Missal of 1570, both of them tracked
public-domain witnesses; the basis and its bounds are set out in full in the
terminal appendix. No rights are claimed in this text, and none of it has been
composed, translated, modernised, conflated or adapted for this edition. Every
form
...
is the text of the 1962 books: this English is printed for study, not as an
altar book or a hand missal, and none of it was translated for this edition.
Where the registered English does not answer the missal's Latin --- and it
fails to at several points in this formulary --- each gap stands at its
element, unfilled.
...
\englishgap{Two facts about this antiphon govern its English. \textit{First}, the
...
whole with the sung fragments marked; stitched together, the fragments would
make an English sentence that no registered English witness prints. \textit{Second}, at
...
manner.'' The Douay cannot be quoted for the chant's word, so the word stands
here without English; the older-psalter reading behind
...
\englishgap{The English shifts one subject. The Latin's last
...
petitioners the ones who dare not ask. The rendering is the registered
public-domain witness; the Latin carries the argument built on the prayer's
grammar, in the element commentary below. The 1861
...
\englishgap{Three differences. \textit{First}, the chant opens \latin{In Deo
...
counterpart in the Clementine verse and therefore none in the Douay, and it
stands here in Latin alone. One American-edition difference falls inside
...
own order they say: take a pleasant psalm with the harp. No registered
English joins them into one sentence.}
...
The liturgical incipit is the missal's own and is not translated here. Missal
and Douay also differ in one transliteration: the missal prints
\latin{Ephphetha}, with the second aspirate, and the Douay prints
``Ephpheta.''}
...
does not carry. The verses are printed whole with the sung words marked, so
the unsung words stay visible beside the sung ones.}
...
The 1861 book prints no incipit for this Secret; its lines answer the
appointed Latin clause for clause --- ``our homage'' answering \latin{nostram
\dots\ servitútem}, ``a help to our weakness'' answering \latin{nostræ
fragilitátis subsídium} --- and the neighbouring Sundays' orations confirm that
the filing does not slip by one.
...
Latin above, and no registered English joins it.}
...
\englishgap{Two things shift in the English. The Latin's pair is
