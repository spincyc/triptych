...
One word of the Introit is a small marvel of transmission, and the evidence
stands at the element in the full edition. The chant sings \latin{unánimes},
``of one mind,'' where the Clementine reads \latin{unius moris}, ``of one
manner,'' and so, in one form or another, does every checked Latin psalter lemma
but one.
...
missal's ``we dare not presume to ask''; the two stand side by side at the
element in the full edition. St.~Thomas states the principle without commenting on the prayer:
...
mid-verse ending stands in the Missals of 1570 and 1862. Two things follow.
The Fathers' teaching on grace from this verse cannot be credited to this
lesson: they expound one clause further. And the
...
charged them the more they published it. St.~Augustine, in the works checked, treats only this, and
...
gifts are set out. One fact changes that claim: the entire checked tradition, Latin and Greek alike,
