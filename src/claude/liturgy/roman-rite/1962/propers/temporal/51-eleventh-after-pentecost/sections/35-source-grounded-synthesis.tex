...
and the reception actually checked at its own loci carry the conclusions below.
The transmission evidence forbids any conclusion about why these ten texts
stand together: the Old Gelasian carries the three orations
...
other by a realignment nobody documented. Each conclusion below therefore
concerns the formulary as the 1962 book prints it, and none concerns a
compiler's mind.
...
what stands is only that all four are there.
...
rests on two checked expositions, and nothing shows that either text was
