...
The appointed wording, the documented historical orientation of the texts,
and the reception actually checked at its own loci alone carry the conclusions
below, which concern the formulary as the 1962 book prints it. Its
transmission is uneven: the Old Gelasian carries the three orations as an
unassigned Sunday mass, the Hadrianum files them at its own twelfth Sunday,
the Frankish Gelasians at the thirteenth, and the Ottobonianus margins cue
this Sunday's antiphons two masses away. Chants and orations reached each
other by a later realignment.
...
his speech is that it was right. All four boundaries are verified,
and no checked witness reads them together.

\textbf{The reception of five separate elements converges on the
Resurrection, and the convergence belongs to the commentators rather than to
the Mass.} Hilary, Augustine and Bellarmine read the Introit's
...
this Sunday. A reader who arrives with the tradition in hand will hear a
resurrection Mass here, and the texts themselves supply that reading only
...
are not variants of one reading. They yield different sermons, and they stand
as four positions, not one consensus.
...
cases the traffic between exegesis, chant and ritual is documented.

\textbf{The Epistle's boundary constrains what may be preached from this
Sunday, and the constraint has a positive form.} What the Church
...
Communion make one claim in two idioms, personal and economic. The link
rests on two checked expositions.
...
Gelasian onward, as the sacramentaries document. Their shared shape
--- one act of God, two effects, the second of them ours --- is the nearest
thing this Mass has to a thesis.
