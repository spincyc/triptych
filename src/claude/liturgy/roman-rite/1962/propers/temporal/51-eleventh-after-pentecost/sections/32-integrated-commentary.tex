...
Five claims follow that no single proper establishes and that only the whole
formulary, read against its checked reception, makes visible; they stand in
place of the full edition's complete appointed texts and element-by-element
sweep. Every appointed element informs them, though none has a heading of its
own. The complete appointed Latin and English, the collation against two 1962
editions and against the Clementine Vulgate, and the individual dossiers of
every witness cited here stand in the full edition and in the source records
...
The Introit sings \latin{Deus qui inhabitáre facit unánimes in domo}. Only
one checked Latin witness reads \latin{unánimes} there: the Clementine has
...
No line of descent is established here --- no \work{Psalterium Romanum}
witness was collated --- but the effect is that the assembly's first words on this
...
two stand side by side in the full edition, where the English is printed. The Communion antiphon
...
Two conclusions, one negative and one positive. Negatively, the Fathers'
teaching on grace from this verse cannot be credited to this lesson: their
expositions quote past its last word, and cited without saying so they become
a comment on a text the Church does not read here.
...
and the convergence is striking. On the
...
Yet not one of those witnesses is commenting on this Sunday;
...
Theodoret. Four elements, one direction, and three named refusals. A reader
arriving with the Latin tradition in hand will hear a resurrection Mass here; the texts supply that reading only through their
...
hedging twice; a Lapide has it both ways. Augustine, in the one place in the
works checked where he touches this pericope, ignores the gestures entirely and
asks only why silence was commanded of people who could not keep it.
...
\subsection*{5. How the orations and the chants were transmitted}

The three orations stand together as one mass-set in the Old Gelasian (Wilson, p.~228), among the
...
book altogether --- as a search of the whole of Feltoe's text for five
distinctive phrases establishes --- so its oldest verified witness is the
Gelasian.
...
carries the chants that 1962 sings on its Thirteenth Sunday. The pairing of the
\latin{Honora Dominum} Communion with the \latin{abundantia pietatis} Collect
is the product of a later realignment of two cycles that had been moving
independently.
...
located, and the reuse stands at exactly that strength. And the Secret's
variants differ, each with its witnesses: \latin{fragilitati} in the
...
Venice Missal of 1570. The 1962 book chose among these; it did not invent
them.
