...
not here. Two of the four come from one Aramaic word, and that
concentration is itself the finding: of everything on these three missal pages,
\latin{Ephphetha} is what the world took and put to other work. A fifth
verified candidate, held back, and the searches that came up empty stand with
the rest of the audit in \texttt{research/scope.md}.
...
Gutenberg Part~II e-text, so the first-edition scan is the witness.
\end{afterlife}
...
reproduction. Both bodies are church-affiliated, and their names are
proper names of functioning institutions, not sermon reuse. The Scranton
