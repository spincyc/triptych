...
Pentecosten} and p.~398 \latin{Dominica XVII post Pentecosten} --- so no running
head anywhere in the book leads to this formulary.
...
before 1962 is the ten texts and their order}, and the psalm citations of those two books, as their layers give them, do not
show it. What changes around the texts is the
...
The Bible text beside these propers is the Clementine Vulgate, the Latin behind
the Douay--Rheims Challoner English printed with them. Fifteen
...
not a critical edition}, so each of those four agreements rests on one lemma of
a single printing. Theodoret's Greek names the Alleluia's subject too. \textbf{The Greek cuts the other way at two of the four}:
...
\begin{witnessnote}
\wlocus{Augustine, \work{Enarratio in Ps.~85}, one sermon, entire}
...
Theodoret's Symmachus's ``on each day'' and nothing further. The fourth of them
stands against any reading that leans on the singularity of one long day.
...
The appointed words stand in four canonical relations. \latin{Mitis} as a whole
...
\begin{witnessnote}
\wlocus{The continuation of Prosper Guéranger, \work{The Liturgical Year} (Dom Lucien Fromage), vol.~XI, printed p.~357}
Above this Collect he sets out the distinction the two verbs make, here in Dom
Laurence Shepherd's English: ``unless grace prevent, that is, anticipate, us, we cannot have so
...
uninterrupted tissue of good works.'' The English page sets \emph{follow},
\emph{grace} and \emph{good works} in italic; \emph{prevent} is Shepherd's word
in this exposition and not in his English of the prayer, which renders
\latin{prævéniat} as ``ever go before us.''
\textbf{Fromage witnesses that the Collect is read this way; the technical
distinction is Augustine's and Trent's}; and
``persevering continuity of this most precious aid,'' his \emph{continuité
persévérante}, is his phrase and not a rendering of \latin{iúgiter}.
\end{witnessnote}
...
vos}, which is the same verb the liturgical incipit put at the front --- the
two Latin texts coinciding in one verb. Every petition inside
...
dimensions of a solid body, ``pointing as it were to a man.'' The words quoted
are Gross Alexander's English in the \work{Nicene and Post-Nicene Fathers},
first series, vol.~13, and not Chrysostom's Greek.
\end{witnessnote}
...
\begin{witnessnote}
\wlocus{The continuation of Prosper Guéranger, \work{The Liturgical Year} (Dom Lucien Fromage), vol.~XI, printed pp.~358--360}
...
refers it to Jerusalem restored. And Fromage, above this Gradual at printed
...
later reuse: ``the Gentiles shall fear thy name'' matches no page at all in the
...
Apoc.~5:9 and 14:3, and nowhere else; four of the nine carry the
...
\textbf{Cyril's commentary survives entire only in Syriac}, and the English quoted
is R.~Payne Smith's 1859 rendering of that Syriac, so its words
...
The fullest continuous Latin exposition, and the one nearest this
...
matter this Mass's Collect and Communion state doctrinally, grace going before
merit and a justice that is God's alone, and is why he is the witness that most
nearly meets the formulary. \textbf{At \latin{Tunc erit tibi gloria}
...
and a Chrysostom excerpt at lect.~2 rest on the Catena's attribution alone, in its
medieval Latin, which for the three Greek Fathers is not their Greek.
...
\begin{witnessnote}
\wlocus{The continuation of Prosper Guéranger, \work{The Liturgical Year} (Dom Lucien Fromage), vol.~XI, printed pp.~365, 367--368}
...
The appointed words stand in two further canonical relations. \latin{Amice}
...
respice}. \textbf{None of these commentaries has a counterpart to the printed refrain},
...
them is a Latin reading and not the tradition's. \textbf{Fromage, above this Offertory at
...
who reads it is Fromage}, above this Secret at printed p.~370: ``the Sacrifice,
...
\latin{brachium} is right. \textbf{He adjudicates the wording of the antiphon's
own three verses, and the exact words it sings at one clause of the two}:
\latin{Deus, docuisti me a iuventute mea} is the first half of Ps.~70:17 and
stands in the antiphon word for word, and \latin{donec annuntiem brachium tuum}
stands in Ps.~70:18 past \latin{ne derelinquas me}, where the antiphon stops.
\end{witnessnote}
...
in the ordinary sense.} And Fromage, above this antiphon at printed
...
verse Fromage reaches for there. \textbf{Only \latin{solíus} is inside
...
else, and ``I will be mindful of thy justice'' matches no newspaper page in
\work{Chronicling America}. The Authorized Version prints neither phrase at
these verses.
...
received sacrament --- neither text says.} Fromage gives a direction of
...
conjunction \latin{et} before \latin{rénova} included, at its printed
