...
The Bible text that matters here is the Clementine Vulgate, the Latin behind
...
\textbf{Fromage witnesses that the Collect is read this way and is not the
...
later reuse: ``the Gentiles shall fear thy name'' stands on no page at all of the
...
else, and ``I will be mindful of thy justice'' stands on no newspaper page of
