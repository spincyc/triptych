...
other. At the Gospel: Luke~14 in three separated blocks, with vv.~12--15 and
v.~25 appointed nowhere in it. It holds no votive Masses at all, so the
...
47 (1955) 218--224, Tit.~II nn.~1 and 5, Tit.~V~a) n.~1 and Tit.~V~b) nn.~7--8.
...
pp.~356--371, quoted above at pp.~357 (the Collect), 358--360 (the Epistle and
...
every divergence tabulated above, and the corpus behind the exhaustive lists of
...
\texttt{src/sources/bibles/douay-rheims}. \textit{The registered public-domain
...
lect.~4--5, Corpus Thomisticum, Marietti text; \work{Catena aurea in Lucam}
...
chants, and no critical text was collated at those four words.}
...
was opened.}
\fi
\item Council of Trent, Session~VI, cap.~X, cap.~XVI and can.~32, from the
...
and vol.~III, articles 03738a and 03731a for the two Nativity labels.
...
psalms. Its bytes are registered restricted; nothing of it is reproduced here
beyond the one label the chronology contract requires printed in the Date
column.}
