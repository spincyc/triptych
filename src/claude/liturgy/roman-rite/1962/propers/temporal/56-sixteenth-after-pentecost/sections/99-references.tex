...
pp.~356--371,%
\ifdefined\TriptychSynthesisEdition{} quoted above at pp.~357 (the Collect),
358--360 (the Epistle and the four measures), 365 and 367--368 (the Gospel, the
wedding and Ecclus.~3:20--21), 370 (the Offertory and the Secret) and 370--371
(the Communion and the Postcommunion), with his reading of the Gradual at p.~363
reported and not quoted. \textit{The chapter heading, the printed folio
