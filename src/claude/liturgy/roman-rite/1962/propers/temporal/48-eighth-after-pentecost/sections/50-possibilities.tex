...
figure within a few minutes, and only the Epistle's is explained in the
witnesses checked. The
...
two psalms, quoted as though it were two witnesses --- and no witness checked
explains it. The proposal is to read the Gradual's redundancy by the light of the
...
\pfield{Fruit}{It supplies a positive account of a doubling that otherwise
reads as mere repetition: on this reading the Gradual quotes a prayer which
outlived its first speaker, and the Mass sets it beside a verse whose whole
doctrine is that one cry can have two origins.}
