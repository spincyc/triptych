...
one. Five of the documented later uses of wording from the appointed Gospel
genuinely turn the register or force of the phrase --- into satire, into anti-clerical
polemic, into a swindler's private code, into a theory of political language,
into a parliamentary insult. None of them is straight exegesis or devotional
citation; those stand in the commentary above.

Throughout, the English phrases that entered the language are the Authorised
Version's --- ``the mammon of
...
author's own wording, and the difference between the two wordings bears on
every entry.
