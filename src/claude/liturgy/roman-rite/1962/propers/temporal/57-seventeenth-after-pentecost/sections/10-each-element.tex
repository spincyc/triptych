...
The ten elements of this Mass come from several books. Four psalms give the
Introit, the Gradual, the Alleluia and the Communion; the ninth chapter of
Daniel gives the Offertory; the Letter to the Ephesians and the Gospel of
Matthew give the lessons; and the three orations come from the
sacramentaries. Each element's principal witnesses are those on which the
three readings draw, and each witness's argument is fullest in the reading
that relies on it.
...
The psalm's two principal witnesses divide over who prays it. Augustine hears Christ, head and
...
In the 1962 Missal the pericopes that precede it in
...
sense. Which Latin version the chant followed has not been identified. St Jerome's
...
sequence, and not every part reached the Sunday at the same time. The three old chants already belonged together before
...
this formulary. Each element therefore carries its own scriptural argument
into the Mass, and the liturgical sequence adds what it makes audible between
the elements.

That sequence is heard from three different places. One reading begins
