...
commentator William Durandus reads its second half as Christ reproving the
Pharisees \latin{de infidelitate, quia non credebant ipsum esse Deum}: for
their unbelief, because they did not believe him to be God (\work{Rationale}
VI.135).
...
the poor of Christ. The two are not reconciled; only Augustine's reading
belongs to the confession of the Word.
...
(\work{Commentarii in Danielem}, on 9:21--24). The 1962 antiphon ends at the
petitions of 9:17--19; the answer Jerome reads comes in the verses that follow
them (9:20--27).
...
\subsection{Three texts that resist, and two that hold}
...
Cassiodorus. The Offertory's Christological weight lies in verses of Daniel~9 that the
1962 antiphon does not sing, where Jerome reads the answer the prayer
received. The Preface, finally, is the ordinary Sunday Preface of the season
