\section{David's Son and David's Lord: The One God Confessed in His Word and Spirit}
...
\latin{spíritu}, as it prints the \latin{spíritus} of the Epistle. The
Trinitarian sense of the verse is the Fathers' reading and not a signal of the
page. The same Missal, setting the Gradual in the votive Mass of the Holy
Spirit, prints \latin{Spíritu}.
...
Word deigned to take our death. In the same place he makes a distinction that
belongs to this reading. Christ and the Church are one, \latin{sed Verbum et
caro non utrumque unum; Pater et Verbum utrumque unum}: the Word and the flesh
are not one thing, while the Father and the Word are one
(\work{Enarrationes in Psalmos} 101, s.~1, 2). Cassiodorus, by contrast,
declines to put the psalm in Christ's mouth and hears the prophet speaking for
the poor of Christ. Both readings stand; only Augustine's belongs to the
...
the Offertory's prophet that is his own. The Postcommunion's
\latin{Sanctificationibus tuis} names a holiness that is God's own and given in
the sacrament.
