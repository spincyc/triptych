...
threefold ``whole'' of the first as an exclusion: when the commandment says
``with all thy heart, and with all thy soul, and with all thy mind'', it means
``that no part of our life is to be unoccupied, and to afford room, as it were,
for the wish to enjoy some other object'', so that whatever else presents
...
Expounding the wedding garment of the parable that stands just before this
Gospel in Matthew, he calls the garment charity, held like a woven cloth
between two beams, \latin{sicut in duobus lignis}. In the love of neighbour a
...
that, and by it is again established'' (\work{Homilies on Matthew} 71). He also
notices that Jesus answers more than he was asked, and reads the unbidden
second commandment as exposing where the question came from --- ``from having
no charity, from pining with envy''. St Thomas Aquinas gathers these and adds
...
(Augustine), a measure set against measurelessness (Gregory), mutual
establishment (Chrysostom), the image of God in the neighbour (Aquinas). The
Collect asks as a gift what the Gospel commands, \latin{te solum Deum pura
mente sectari}; Augustine joins following to loving in so many words --- ``We
...
before the father of his flesh; and he meets a reading that applied the psalm
to Abraham with the psalm's own ``from the womb before the day star I begot
thee'' (\work{Commentarii in Matthaeum} IV, on 22:41--46).
...
confess Him also to be God'', and the added clause about the footstool is there
``in order to move them to fear''. On that reading the God whom the first
commandment requires to be loved with the whole heart is not loved apart from
his Christ, and the reading anchored in the commandment does not have to
abandon the second half of its own Gospel. The reading anchored in the
...
William Durandus, whose own Sunday kept another Gospel and who knew churches
that read this one a week later, takes its second half as Christ reproving the
Pharisees \latin{de infidelitate, quia non credebant ipsum esse Deum}
...
unite those who are separated by race and by different manners'', as fire fuses
dry wood into one blaze and cannot fuse wet timber (\work{Homilies on
Ephesians} 9). St Jerome reads the same verses with an eye for the weak: true
...
why lowliness comes first at all: the gifts of the Spirit could puff up those
who received them, whereas all have received one grace and one spring sends out
the different streams, so that they bear with one another by the law of love.
...
At verse 6 the witnesses divide, and the division is the one place in this
formulary where two lines of exegesis run against each other. Jerome, writing
against Sabellius and the Arians, gives the three phrases to the three Persons:
...
sanctus, quia nihil absque eo est}. Chrysostom reads them instead of the one
...
power and the largesse of his grace, and only then appropriates the first
phrase to the Father as \latin{fontale principium divinitatis}, the second to
the Son and the third to the Holy Spirit.
...
directions, and it prints them against their own order in the psalm. On the
respond, verse 12, Augustine finds the happiness all men want and answers it in
...
command in the first chapter of Genesis, beside the mystery: ``there is no
...
separated, by reason of the unity of essence''. The Missal prints this versicle
at this Sunday with a small letter, \latin{spíritu}, and prints \latin{Spíritu}
when it sets the same Gradual in the votive Mass of the Holy Spirit; the
Trinitarian sense of the verse is the Fathers' reading of it.

\subsection{The voice in which this people prays}

The Alleluia is one verse long and divides its witnesses more sharply than any
other element. For Augustine the poor man of Ps~101 is Christ, head and body:
...
nowhere said to have been ``anxious'' and the ashes and tears of the psalm do
not befit his incarnation, and hears instead the poor of Christ, \latin{qui non
...
of the whole world. The three readings need not choose the same answer:
Augustine's one voice of head and members is what the reading of the one body
uses, that Word made poor for us is what the reading of David's Lord uses, and
Cassiodorus's interceding poor is what the reading of the humbled people uses.
...
preparation for every other petition, and that what hinders prayer is ``want of
faith, of confidence, of humility, desire''.

The Offertory is the one element where a disagreement touches the praying
subject himself. St Jerome observes that Daniel confesses the people's sins in
...
Daniel ``expresses himself in language so distinct and precise, as if he were
full of the distinction himself \dots\ `My sins,' says he, `and the sins of my
people.''' Aquinas cites the verse the antiphon does not sing, ``not for our
...
lies, Hilary saying \latin{ex nobis autem initium est, ut illa perficiat} where
Augustine gives the whole of it to God; they agree that the Introit asks mercy
and not reward. Hilary also turns the confession into a rule for affliction:
in persecution, sickness, loss and bereavement, \latin{semper utamur hac, qua
nunc propheta usus est uoce dicens: iustus es, domine}. Cassiodorus gives the
verse the same use and adds a link of his own, that by this saying Daniel was
...
The three orations are treated modestly by all three readings, as prayer rather
than as the anchor of an argument, and two of the three ask what the sacrament
...
daily faults and preserves from mortal sins. The reading of David's Lord does
not need that doctrine and does not use it. It hears the same three prayers as
confession: the Collect's \latin{te solum Deum}, which Chrysostom's point keeps
from being read against the Son; the Secret's \latin{maiestas}, which meets the
Preface the Missal directs immediately after it, confessing ``one God, and one
Lord not in a singularity of one Person, but in a Trinity of one substance'';
and the Postcommunion's \latin{sanctificationes}, a holiness that is God's own
and is given in the sacrament.
...
Father with its many mansions; Aquinas's beatitude, begun in hope, is held
perfectly hereafter, and Bellarmine reads the blessed nation as most happy
...
superbos deprimit}, and promises that those who take the last place here will
be exalted in paradise. Both read these chants within an office whose Gospel
was Luke~14. Bellarmine reads the verses just before the Communion's, ``When
God arose in judgment, to save all the meek of the earth'', of the general
