...
daily faults. The reading of David's Lord does
not need that doctrine and does not use it. It hears two of the three prayers
...
substance''. Of the Postcommunion it says outright that the prayer adds
nothing distinctive to it: the address is to the \latin{omnípotens Deus} with no
