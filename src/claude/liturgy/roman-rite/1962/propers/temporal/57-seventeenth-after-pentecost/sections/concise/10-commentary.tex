...
William Durandus takes its second half as Christ reproving the Pharisees
\latin{de infidelitate, quia non credebant ipsum esse Deum} (\work{Rationale}
VI.135).
...
still speaking, of which Jerome says \latin{grandis orationis effectus}; but the
1962 antiphon ends at the petitions of verses 17--19, so that weight rests on
words this Mass does not sing.
...
daily faults. That chapter has no place in the reading of David's Lord,
which hears two of the three prayers as confession: the Collect's \latin{te solum Deum}, which Chrysostom's point
...
``when we shall see him as he is''. William Durandus hears the Introit's
\latin{rectum iudicium} as the judgment \latin{quo Deus exaltat humiles, et
superbos deprimit}, by which God exalts the humble and casts down the proud.
Bellarmine takes the Introit's \latin{iudicium} otherwise, holding
