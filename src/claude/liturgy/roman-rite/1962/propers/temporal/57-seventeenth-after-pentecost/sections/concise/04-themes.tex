...
The Introit sets that opening note in two half-verses of the long alphabetical
psalm on God's law. Its antiphon joins verse 137, which opens the strophe
\latin{Sade} on the justice of God, to the first half of verse 124, from the
strophe \latin{Ain}, in which the servant asks for help; the words that
complete verse 124, ``and teach me thy justifications'', are not sung. The
...
is and meets the answer ``David's'' with Ps 109:1. The Missal's opening,
...
Two habits of speech run through the whole of it. The first is the word
``one'': seven times in three verses of the Epistle, once in the Collect's
\latin{te solum Deum}, and once more in the Gospel, where the Lord of David's
