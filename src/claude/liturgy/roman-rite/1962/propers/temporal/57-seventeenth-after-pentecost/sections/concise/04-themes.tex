...
That history bears on how the chants are heard: they do not merely echo the
...
whom they are confessing. The chant cycle is thus not reduced to an
illustration of Matthew, nor the Gospel isolated from the prayer that
receives it.
...
Nothing one identifies does another deny, and they differ in emphasis: the
first two divide the Gospel between them and give the Mass its doctrine, while
the third rests on the chants that have stood at this Sunday longest and gives
it its tone. They meet below at the points where they answer the same
