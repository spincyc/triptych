...
Pentecost}, which develops the three readings at length, treats each appointed
element in its own setting, and prints the complete appointed Latin with its
public-domain English. Nothing evidence-dependent is added here. The four rows
on the first page orient a reader and do not replace those readings' own four
senses; the map and the scriptural dossier reprint the study's own, with the
dates, relation labels, alternatives and unresolved states exactly as the
generated chronology record gives them.

\textbf{Text, English and rights.} Every Latin form quoted here was read for
the study on the page images of the CMAA facsimile of the typical edition and
compared with the Pustet \work{Missale Romanum} of Ratisbon, 1862 and with the
...
translation printed by Eugene Cummiskey in Philadelphia in 1861. Neither is an
...
Bellarmine only in O'Sullivan's abridged English of 1866; Hilary on Ps~118 at
the strophes \latin{Ain} and \latin{Sade} alone. Greek commentaries on the four
...
\textbf{Chronology and records.} Every date on the second page comes from the
Scripture chronology corpus through the record generated for this formulary.
...
traditional dates reported by the \work{Catholic Encyclopedia}, so the modern
critical positions are named there without figures. The Gospel's narrated event
...
\item H.~A. Wilson, ed., \work{The Gelasian Sacramentary} (Oxford, 1894), pp.~231--232 (Liber III, sect.~XIII), and \work{The Gregorian Sacramentary under Charles the Great}, HBS 49 (1915), pp.~174--175; R.-J. Hesbert, \work{Antiphonale Missarum Sextuplex} (1935), as indexed at gregorien.info, day 819.
\end{itemize}

\subsubsection*{Fathers, Doctors and saints}
\begin{itemize}\setlength{\itemsep}{0.15em}\setlength{\parskip}{0pt}
\item St Augustine, \work{Enarrationes in Psalmos}, Latin text of Migne, PL 36--37: on Ps~32, I, 12, and II, s.~2, 5, 15--18; Ps~75, 16--18; Ps~101, s.~1, 2--3; Ps~109, 3--6; Ps~118, s.~26, 5 and s.~28, 1.
...
\item St Gregory the Great, \work{Homiliae in Evangelia} 38.9--10, Latin.
...
\item St Robert Bellarmine, \work{A Commentary on the Book of Psalms}, trans. J. O'Sullivan (1866, abridged): on Pss~32:6, 12; 75:9--13; 101:2; 118:124, 137.
