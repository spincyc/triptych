...
Verify warning-free builds, correct contents and appendix destinations, one-page summary boundaries, readable tables, and byte-identical installed/build PDFs. The treatise’s title-page metadata must display its tracked revision timestamp and AI contribution provenance once; do not duplicate the same block at the end.
