...
On a public repository, every pushed commit immediately publishes its tracked source and history even if the reader-site workflow later fails. Before pushing, verify that new protected content, changed PDFs, and future publications have the authority and rights review required for public repository exposure. Keep uncleared experiments and private-review material off public refs.
