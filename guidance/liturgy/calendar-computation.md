...
| --- | --- | ---: | --- | --- |
| Week-keyed | the Monday after the First Sunday of Advent (28 November – 4 December) to 16 December | 18 | 12 to 17 | Universal Norms 39–42; 59 table 13 |
| Date-keyed | 17 to 24 December | 8 | 6 or 7 | Universal Norms 39–42; 16 b; 59 table 9 |

The week-keyed run holds the Monday through Saturday of the first, second and third weeks of Advent. It has no fourth week: the Fourth Sunday of Advent falls 18 to 24 December, so its weekdays lie wholly inside the date-keyed run, and in no year of the span does a weekday of the fourth week fall on or before 16 December. Every position the week-keyed run loses is one of the third week's — the second week's Saturday falls 10 to 16 December and is always held, while the third week's Monday falls 12 to 18 December and is not. The third week loses one position in 15 years of the span, two in 15, three in 15, four in 14, five in 14, and all six in 28, the last being the years in which the Third Sunday of Advent falls on 16 or 17 December. The date-keyed run loses at least one of its eight positions to a Sunday in every year, the Fourth Sunday of Advent always falling inside it; in the 14 years of the span in which 17 December is itself a Sunday the Third Sunday falls inside it as well and only six positions are held.

**Open, and not to be closed by inference.** The two runs' *key grammar* — that the Missal and the Order of Readings key the first run by week and weekday and the second by civil date — is the arrangement those books print, and no witness held here has been read for it. The Norms band the days; they do not head a formulary. Read the Advent headings in the *Ordo lectionum Missae* and in the Missal's Proper of Time before minting keys under either grammar.
...
| Run | Days it covers | Positions | Held, 2020–2120 | Locus |
| --- | --- | ---: | --- | --- |
| Days within the Octave of the Nativity | 29, 30 and 31 December | 3 | 2 or 3 | Universal Norms 35; 59 table 9 |
| Weekdays of Christmas Time | 2 January to the Saturday before the Baptism of the Lord | the year's own: 4 to 10 | — | Universal Norms 32–38; 59 table 13; the Missal's heading *In feriis temporis Nativitatis a die 2 ianuarii usque ad sabbatum ante festum Baptismatis Domini* |
...
**Fail closed on two points, and place nothing by preference.**

*The transferred Epiphany.* Universal Norms 7 makes the transfer a decision of the competent authority and never a computation, and the rule at the head of this file already forbids computing one. What the books do with the weekdays between 2 January and the Baptism when the transfer has been made — whether the same series is used, shortened, or replaced — is not stated by any locus read here. Emit both branches tagged with the option they hold under, exactly as the Epiphany and the Baptism themselves are emitted, or refuse the days; do not choose. In particular, do not assume that a series keyed to the days after the Epiphany exists under both branches, and do not derive the number of its members from the fixed-date branch.
...
- a weekday position the year's arithmetic never reaches was recorded as unplaced rather than anticipated, folded into a neighbouring week, or renumbered, and a weekday series whose printed key grammar has not been read in a witness was left unkeyed rather than keyed by inference;
...
Four open points belong to it, and each is a refusal rather than a gap to be filled by inference. The printed key grammar of the Advent runs — week and weekday before 17 December, civil date from 17 to 24 December — is the arrangement the Missal and the *Ordo lectionum Missae* print, and no witness held here has been read for it; the Norms band the days and do not head a formulary. The same is true of the Christmas Time run between 2 January and the Saturday before the Baptism, where the Missal's heading fixes the window and not the keys inside it, and where the design proposal to key part of the run to the days after the Epiphany is unsourced. Where the Epiphany has been transferred, what the books do with those weekdays is stated by no locus read here, and Universal Norms 7 forbids computing the transfer at all, so both branches are emitted tagged or the days are refused. And Universal Norms 35 a, which is reported to seat the Holy Family on 30 December in the 15 years of the span in which no Sunday falls within the octave, has not been read in a witness for this file, so that date fails closed in those years and no weekday position is placed on it.
