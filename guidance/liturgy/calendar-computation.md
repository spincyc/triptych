...
- any feast collision was applied after, and without rewriting, the nominal fixed-slot map; and
- a `P = 23` year or unresolved proper-calendar overlay failed closed rather than receiving an inferred winner.
