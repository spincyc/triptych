...
- in weekly and ritual Mass guides, `References` is the penultimate section, contains every source actually cited, contains no unused study leads, and ends with a compact labeled `Search Scope and Limitations` panel rather than operational provenance prose; `propers/verified.md` and `research/scope.md` retain the full text and research audits;
