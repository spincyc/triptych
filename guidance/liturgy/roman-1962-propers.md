...
The present set covers Trinity Sunday and the Second through Eighth Sundays after Pentecost in the 1962 temporal cycle and the 1962 Nuptial Mass. The shared sacramental reference works supply additional theology without becoming part of this profile’s catalog.
...
- **Generation:** `G0` not generated; `G1` legacy AI-assisted generation whose exact model, agent, and runtime were not recorded; `G2` generated with fully qualified provenance; `G3` substantially revised with fully qualified final-event provenance. The present `G3` cohort records `gpt-5.6-sol`, `effort=ultra`, OpenAI Codex agents, Codex CLI `0.144.1` or `0.144.4`, and an API workspace; the document-local structured record identifies the exact client version, roles, and any specifically unavailable component.
...
- **Production evaluation:** `Q0` no artifact; `Q1` tracked PDF using the legacy architecture, without a durable specification-level QA attestation; `Q2` two-pass, warning-checked, visually inspected PDF under the source-audited macro-order that preceded `In Illo Tempore...`; `Q3` the former macro-order with the historical table immediately after page 1; `Q4` the reader-first macro-order in this revision, with the two-page synthesis immediately after page 1 and historical coordinates, scope, and qualifications in terminal appendices, together with a settled build, warning check, and every-page visual inspection. The `Q` prefix denotes production QA. Do not relabel an installed `Q3` guide as `Q4` until its source and artifact have actually been reorganized and reviewed.
...
| 15 | Trinity Sunday | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/15-trinity-sunday/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/15-trinity-sunday/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/15-trinity-sunday.pdf)) | G3 | S2 | T0 | Q3 |
| 16 | Second Sunday after Pentecost | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/16-second-after-pentecost/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/16-second-after-pentecost/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/16-second-after-pentecost.pdf)) | G3 | S2 | T0 | Q3 |
| 17 | Third Sunday after Pentecost | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/17-third-after-pentecost/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/17-third-after-pentecost/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/17-third-after-pentecost.pdf)) | G3 | S2 | T0 | Q3 |
| 18 | Fourth Sunday after Pentecost | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/18-fourth-after-pentecost/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/18-fourth-after-pentecost/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/18-fourth-after-pentecost.pdf)) | G3 | S2 | T0 | Q3 |
| 19 | Fifth Sunday after Pentecost | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/19-fifth-after-pentecost/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/19-fifth-after-pentecost/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/19-fifth-after-pentecost.pdf)) | G3 | S2 | T0 | Q3 |
| 20 | Sixth Sunday after Pentecost | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/20-sixth-after-pentecost/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/20-sixth-after-pentecost/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/20-sixth-after-pentecost.pdf)) | G3 | S2 | T0 | Q3 |
| 21 | Seventh Sunday after Pentecost | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/21-seventh-after-pentecost/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/21-seventh-after-pentecost/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/21-seventh-after-pentecost.pdf)) | G3 | S2 | T0 | Q3 |
| 22 | Eighth Sunday after Pentecost | Historically situated, source-audited working draft ([propers](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/22-eighth-after-pentecost/propers/verified.md); [scope](../../src/gpt/liturgy/roman-rite/1962/propers/temporal/22-eighth-after-pentecost/research/scope.md); [PDF](../../doc/gpt/liturgy/roman-rite/1962/propers/temporal/22-eighth-after-pentecost.pdf)) | G3 | S2 | T0 | Q3 |
...
## Shared Sacramental Reference Dependency

The full sacramental treatise ([research scope](../../src/gpt/theology/sacraments/research/scope.md); [PDF](../../doc/gpt/theology/sacraments.pdf)) follows each sacrament through Scripture, patristic reception, and Thomistic synthesis, distinguishes sacramental from substantial form and states what each sign changes, separates outward operation, intermediate sacramental reality, proper grace, primary and secondary ends, and the common ultimate order to God's glory and beatitude. Its terminal appendices collect the common terminology, seven-sacrament matter–form–minister matrix, initiation-practice table for all twenty-four Catholic Churches *sui iuris*, and one reusable one-page summary for every sacrament. Its summary fragments live in `src/gpt/theology/sacraments/summaries/`; ritual-Mass guides import those fragments rather than keeping independent condensed accounts.

The compact *Sacraments at a Glance* ([PDF](../../doc/gpt/theology/sacraments-at-a-glance.pdf)) collects, in order, the same canonical master matrix, metaphysical lexicon, seven one-page sacrament summaries, and twenty-four-Church initiation table. It is a retrieval companion rather than an independent doctrinal authority or research ceiling: its contents are composed directly from the full treatise's shared fragments and must never be maintained as duplicate theological copies.
...
The guide is a companion to an open hand missal, not a replacement for it. Research and repository records retain the complete appointed texts, but the PDF normally uses an incipit, reference, or decisive clause rather than reproducing a complete proper. `Appendix: Scriptural and Historical Coordinates` identifies every distinct directly appointed biblical passage by citation only and does not reproduce its wording; composed orations remain selective throughout. Translate or parse a quoted fragment elsewhere when its wording carries the argument or when common hand-missal renderings may obscure the point.

The reader-facing rhythm is **survey, themes and movement, detailed commentary, interpretive possibilities, historical apparatus, verification**. Research still establishes historical coordinates before synthesis, but the publication lets the reader move directly from the Propers map and four senses into the two-page source-grounded synthesis and detailed exposition. Scriptural composition, audience, geography, date ranges, and work-wide qualifications remain available in the terminal appendices before the final references.

## Required Weekly Document Order

Every new or substantially revised guide follows one fixed macro-order. The content and internal teaching forms remain adaptive to the Sunday, but the section sequence does not. Page 1 contains the survey below. It is followed immediately by `The Propers: Themes and Movement`, `The Propers: Detailed Commentary`, and `The Propers: Interpretive Possibilities`; insert `Notable Quotables` after the interpretive possibilities when verified examples exist, followed by any required sacramental appendix. The terminal apparatus then uses `Appendix: Scriptural and Historical Coordinates` (the former `In Illo Tempore...` material), `Appendix: Scope and Qualifications`, `References`, and terminal `Generation Metadata`, in that order.

### Sacramental appendix rule for ritual Masses

When a Mass is celebrated with or specifically for Baptism, Confirmation, Penance, Anointing of the Sick, Holy Orders, or Matrimony, its guide includes the relevant one-page sacrament summary as a clearly labeled `Sacramental Appendix`. Import the canonical fragment from `src/gpt/theology/sacraments/summaries/` after `The Propers: Interpretive Possibilities` and any `Notable Quotables`, but before the historical and scope appendices; `Generation Metadata` remains terminal. If more than one non-Eucharistic sacrament is actually conferred, include each relevant summary. The Eucharist needs no routine appendix because every Mass guide already treats the Eucharistic sacrifice and reception as the liturgy's intrinsic center; a Mass specifically focused upon Eucharistic doctrine may include its summary when that adds real value.

The one-page appendix is a retrieval aid, not the research ceiling. In generating or substantially revising the exposition, use the complete sacramental treatise, its [research record](../../src/gpt/theology/sacraments/research/scope.md), and the primary and scholarly documents to which they point as additional source material. The verified Mass formulary still governs what is appointed and what can be claimed about its compositional unity; the sacramental sources govern doctrinal context, distinctions, inherited interpretations, and cross-sacramental connections. Do not infer that a general sacramental theme was the historical reason a particular chant or oration entered the formulary unless a source establishes that claim.
...
### Pages 2--3: The Propers: Themes and Movement

Pages 2 and 3, immediately following the page-one survey, form exactly two pages of source-grounded, scan-first synthesis, not a miniature continuous essay. A reader scanning only the governing thesis, orienting form, relationship-titled units, and callout titles must be able to recover the Sunday's central claim, direction of movement, decisive witnesses, and interpretive limits. Begin with a one- or two-sentence thesis and one compact sequence, paired track, relationship map, or comparison containing no more than four primary stages.
...
Where Psalm numbering differs, give the missal's Vulgate/Septuagint number first and the common modern number in parentheses. Give secure ancient places with present-day geographic equivalents in the description when useful. Use edition-identified biblical introductions, commentaries, historical studies, and geographic references, with exact citations sufficient to verify the claims. Record materially competing judgments and unresolved questions in `research/scope.md`, cite every source actually used in `References`, and avoid duplicating this background later unless the detailed exposition requires a particular point.

The table must remain readable at ordinary print size while fitting with the appendix heading and any one-sentence interpretive key on one page. Do not add a second table, biblical quotations, a concluding recap box, or prose outside the table that forces a spill page. A textually extensive formulary may expand rather than omit or compress material.

### Appendix: Scope and Qualifications

After the historical-coordinates appendix, `Appendix: Scope and Qualifications` gives one compact account of the guide's edition and formulary identity, text-verification state, biblical and reception source scope, included and excluded material, geographic and chronological bounds, search method, material global limitations, rights boundary, and review state. It points to `propers/verified.md` for the text audit and `research/scope.md` for the research survey. Retrieval mechanics, checksums, query logs, discarded leads, and repeated verification explanations remain in those repository records. A limitation that changes a particular claim remains beside that claim. Do not duplicate this appendix on page 1 or inside `References`.

### References

For weekly and ritual Mass guides, `References` is the final scholarly section and immediately precedes `Generation Metadata`. Its bibliographic entries contain only sources actually used, with sufficiently exact works, books, homilies, chapters, or sections to permit verification; distinguish primary sources from any secondary work actually relied upon. Every historical dossier cites the sources governing its authorship, date, place, audience, and chronology, distinguishing traditional attribution from historical judgment when both are reported. No conclusion, listening guide, limitation panel, or other expository prose follows `References`.

### Generation Metadata

For weekly and ritual Mass guides, `Generation Metadata` is the terminal section of the document. Keep the metadata compact—normally three short labeled lines with semicolon-separated key-value fragments rather than six repetitive fields or explanatory sentences:
...
The three lines are rendered by importing the guide leaf's `generation-metadata.tex`, not handwritten in `main.tex`. The record begins with one strict UTC `\AIDocumentRevisionTimestamp` and then uses one or more `\AIModelContribution` commands; separate contribution commands are required only when materially contributing model, qualifier, or runtime values differ.

Use the UTC whole-second timestamp at which the publishable source revision was finalized, and update every affected guide when a render-relevant shared source changes. Preserve the complete model label exposed by the runtime verbatim; do not shorten it to a family name or drop a numbered version, named variant, preview status, modality, reasoning mode, reasoning profile or tier, deployment channel, or similar qualifier. For example, the present runtime's exact `gpt-5.6-sol` identifier and separate `effort=ultra` qualifier must both be recorded, not reduced to `GPT-5`. If the runtime exposes qualifiers separately, list each once in compact `key=value` form; do not repeat a derived combined designation when the exact identifier and its qualifiers already supply the same information.
...
Study every oration and chant in full during research. Publication remains selective because the reader is expected to have a hand missal open: the historical-coordinates appendix gives citations without biblical wording, and the analysis uses the incipit or smallest clause it needs, while the complete verified wording remains in `propers/verified.md`.
...
The analysis need not repeat ten prose rows. It may encode the sequence in a diagram, paired track, timeline, matrix, or annotated map, provided no proper disappears from the interpretation. Make the Gradual, Alleluia, Secret, and Postcommunion do real interpretive work. A cross-passage connection may enter the source-grounded exposition only when it is demonstrable from the texts or responsibly grounded in cited tradition.

### 5. Maintain a strict boundary around exploratory AI proposals

“Source-grounded” in this project means traceable to Scripture, the verified missal text, identified and checked biblical-historical scholarship, or an identified and checked patristic, saintly, doctrinal, or liturgical witness. It does not make the guide a magisterial document or every cited judgment equally binding. Classify every substantial claim before drafting:
...
- **Exploratory proposal:** a new analogy, symbolic proposal, typological extension, compositional inference, pastoral application, or theological conclusion not explicitly established by the evidence.

The first four classes may appear in the source-grounded sections. The fifth appears only in `The Propers: Interpretive Possibilities`. A canonical or liturgical analogy supported by cited tradition may be source-grounded; an AI-generated analogy without that support is exploratory. An unverified study lead supports no final claim. Never place an AI-generated connection in a Father's mouth, imply consensus by proximity, or hide an exploratory proposal in the four-senses table.

This boundary is intended to license responsible invention rather than suppress it. After the source-grounded case is secure, generate multiple possible syntheses, including serious alternatives, and retain those that are textually anchored, coherent, theologically plausible, and capable of changing attention to the Mass. Their value lies in disclosed exploration, not borrowed authority.

### 6. Produce the source-grounded synthesis and exposition
...
- use concise, source-governed, syntactically complete claims with no exploratory proposals or telegraphic fragments.

The source-grounded exposition supplies the detailed exegesis, source comparisons, lexical work, distinctions, and sacramental development behind the synthesis. The two-page synthesis states the architecture and leading conclusions; the exposition demonstrates, complicates, and qualifies them. A witness may be named compactly in the synthesis and treated fully later, but quotation, extended paraphrase, evidence, and caveat receive one fullest home rather than being duplicated.

### 7. Assemble the guide in the required order

Assemble the guide according to `Required Weekly Document Order`. Make `The Propers: Themes and Movement` occupy pages 2 and 3, then force a boundary so that `The Propers: Detailed Commentary` begins on a fresh page. Fit the complete historical table in its terminal appendix and keep the scope appendix separate from `References`. Edit the historical table and both synthesis pages to be genuinely full, readable, and scan-first. The synthesis requires one compact orienting form; its internal headings, tables, matrices, source cards, short lists, and diagrams may otherwise vary with the Sunday, but the macro-order may not.
...
- ensure the synthesis summarizes while the exposition proves and qualifies;
...
- scan only the synthesis thesis, visual labels, unit titles, and callout titles; together they must recover the central claim, direction of movement, decisive witnesses, and interpretive limits;
...
Finally, compile twice and visually inspect every page. Confirm the exact section order and page boundaries, readable density, intact tables and callouts, any `Notable Quotables` section before the sacramental appendix (when required), the historical and scope appendices after the exposition, `References` as the penultimate section, `Generation Metadata` as the terminal section, and the absence of overflow, split headings, sparse spill pages, and layout warnings.

## Analytical and Visual Forms

Use visual and analytical forms selectively. The source-grounded synthesis is the exception in requiring one compact orienting form, but its type must be chosen for the actual Sunday rather than copied mechanically:
...
| Listening or examination card | Converting sourced findings into attention; any new AI application belongs in `The Propers: Interpretive Possibilities` |
...
| Eighth | How the rich Lord's prior assumption of humanity's debt makes repentance, Spirit-led heirship, truthful stewardship, offering, and whole-person restoration possible without identifying Christ with the unjust steward | One-page canonical historical table, Chrysologus role-and-payment dossier, Romans debt--adoption bridge and 8:17 boundary, divergent Chrysologus--Gaudentius--Cyril--Augustine--Anthony Gospel readings, compact debt--account--gift lexical map, Origen--Irenaeus handwriting-and-Cross study, Secret grammar, and Eucharistic restoration |
...
The Sunday sequence moves from divine gift to embodied discernment: the Trinity is adored, charity answers invitation, mercy finds the lost, Christ's word orders mission, reconciliation makes sacrifice truthful, baptismal life is fed, sacramental medicine produces holy fruit, and the Lord's costly assumption of human debt frees heirs for accountable stewardship and restored life. The first non-Sunday guide then applies the same method to a ritual Mass, where created covenant is elevated, offered, nourished, and ordered toward the Lamb's wedding.

## Stored Propers and Profile Layout
...
```text
src/gpt/
  liturgy/roman-rite/1962/propers/
    temporal/NN-sunday-name/
      main.tex
      propers/
        retrieved.txt
        verified.md
...
The sacramental reference work is maintained separately under `src/gpt/theology/sacraments/`. Its `fragments/`, `sections/`, and `summaries/` are shared deliberately with the at-a-glance companion and ritual guides; they are not a model for unrelated cross-document copying. Installed PDFs mirror document paths under `doc/gpt/`.
...
The evidence classes in the workflow above govern what may be published in each section. Research notes additionally use four evidence statuses:
...
- **Editorial or AI proposal:** the project's own relationship among texts; it appears only in `The Propers: Interpretive Possibilities`, even when plausible.
...
- the generator studied every complete appointed text, while the hand-missal companion PDF gives citation-only historical metadata in the terminal historical-coordinates appendix and otherwise only the incipits, references, and clauses needed for its analysis;
...
- proper-focused subsection headings and exploratory-proposal leads end with ordinary parentheses containing the standard italic abbreviations in liturgical order; the page-one table retains full proper names, and the guide uses no numeric badges, boxes, arrows, dots, or icons for this navigation;
- both opening tables share the same horizontal extents and first-column width and fit entirely on page 1;
- `The Propers: Themes and Movement` begins immediately on page 2, and the terminal historical-coordinates appendix contains no unsupported reconstruction;
...
- pages 2 and 3 contain exactly two full, readable pages of `The Propers: Themes and Movement` and no exploratory AI proposals;
...
- `The Propers: Detailed Commentary` begins on the fresh page after the two-page synthesis, gives the evidence and qualifications behind it, and does not duplicate either the historical appendix or the synthesis paragraph for paragraph;
- every original AI analogy, typological extension, compositional inference, or unsourced cross-proper connection appears only in `The Propers: Interpretive Possibilities`;
- `The Propers: Interpretive Possibilities` begins with one global boundary notice, then gives proposals room to develop without repetitive hedging; substantial proposals expose their proper anchors, while material limits or serious alternatives appear where needed rather than as a repeated formula; the section remains free of invented facts, quotations, attributions, or doctrinal contradiction;
- exploratory proposals are selected for anchoring, novelty, coherence, theological plausibility, fruitfulness, and awareness of alternatives rather than by a prescribed number, length, or source precedent;
- `Notable Quotables`, when included, appears after `The Propers: Interpretive Possibilities` and before any required sacramental appendix and `References`, normally contains two to four verified examples from varied works or media, and never adds a weak item merely to reach that range;
...
- uncertain cultural parallels remain in `The Propers: Interpretive Possibilities`, copyrighted excerpts remain brief, and an empty `Notable Quotables` section is not retained when no verified example exists; unsuccessful leads remain in `research/scope.md` rather than padding the PDF;
- in weekly and ritual Mass guides, `Appendix: Scope and Qualifications` contains the work-wide edition, source, search, date, rights, limitation, and review apparatus and points to the fuller records; `References` is the penultimate section, contains every source actually cited, contains no unused study leads, and contains no duplicate limitation panel; `propers/verified.md` and `research/scope.md` retain the full text and research audits;
- in weekly and ritual Mass guides, `Generation Metadata` is the terminal section, imports the leaf's structured record, and normally renders three compact labeled lines that unambiguously give the latest tracked UTC document revision in `YYYY-MM-DDTHH:MM:SSZ` form, the full verbatim AI model label, every exposed model qualifier, the AI agent and its role, every exposed and accurately labeled agent/client/build version, and the product/interface-level AI environment;
...
- the revision timestamp is refreshed for the finalized publishable source and the contribution fields remain accurate, while all metadata excludes hostnames, usernames, paths, network addresses, container or session IDs, hardware identifiers, credentials, and tokens;
...
- quotation, paraphrase, source-grounded synthesis, and exploratory proposals remain distinguishable;
...
- all sections after page 1, beginning with `The Propers: Themes and Movement`, use the scoped `deepstudy` size; page 1 is not globally reduced.

## Profile Build and Validation
...
The root Makefile discovers all document leaves recursively. It compiles these guides under the matching transient `build/gpt/liturgy/roman-rite/1962/propers/` hierarchy and installs reviewed PDFs under the corresponding tracked `doc/gpt/` hierarchy. Both `make clean` and the backward-compatible `make distclean` remove only `build/`; installed documents remain in `doc/`.
...
Do not preserve weak material merely to maintain length, and do not pad the two-page synthesis. Within the fixed macro-order, allow the appointed formulary's actual texts and witnesses to determine the internal architecture. Prefer fewer strong source-grounded axes, then give clearly bounded exploration freedom to test unfamiliar patterns, competing models, and questions. Stamp the finalized source revision in `generation-metadata.tex`, keep its AI contribution fields accurate, build and inspect the PDF, run `make clean`, and commit each proper-guide creation or substantial revision together with its stored `propers/` source record as one coherent change in this repository.
