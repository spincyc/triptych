...
9. optional `Reception and Cultural Echoes`;
10. any required `Sacramental Appendix`;
11. fresh-page `Appendix: Liturgical Resolution`;
12. `Appendix: Scope and Qualifications`;
13. `References`; and
14. terminal imported `Generation Metadata`.
