...
The guide's order and teaching forms should follow the actual formulary and the reader's needs. A concise map, historical context, authoritative exposition, bounded editorial synthesis, references, and generation metadata may remain useful, but the 1962 guide's exact headings, page counts, tables, and macro-order apply only when this profile explicitly adopts them.
