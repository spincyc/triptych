...
| E1 Catena implementation | **Changes required** at pass-2 head `17f031b37840d8320c664a128d72b502108fe075` (fresh independent review 2026-08-12) | The bounded pass-2 correction preserves E0 and corrects most reviewed URL, history, asynchronous-state, truth-state, lead, print, focus, and accessibility-implementation defects, but a well-formed unsupported voice is rendered as an invented absence, malformed provenance values still reach visible text through JavaScript coercion, and the exact-head handoff contains contradictory URL-preservation prose plus a false AT-SPI-launcher absence claim. The generator/data, release, common-gate, B0/shared-shell, pre-release real-device-or-AT evidence, emulation-only forced-colors limitation, protected Liturgy, and PDF matters remain separately owned. E1 stays off main; only a smallest bounded Catena route/test and handoff correction may follow. |
