...
| E1 Catena implementation | **CHANGES REQUIRED** at V11 head `0255b84996e1dc24da3ce75ac318c4f774b7957c` (independent review on `review/catena-wave-1-e1-corrections-v11-independent`, 2026-08-17); actual Git parent `3b93f74f032e74de9a50c1e2f1b35aa5b567f8d8`, reviewed V10 baseline `ea15d16d22d7ceaed989ed9907c236f967738a03` | V11 closes the truthful malformed/unestablished wording, exact 36-field late vector, ownership journal, P8, privacy, handoff structure, ZIP metadata and arithmetic findings, while preserving ordinary refusal/absence/valid controls and existing ceilings. It does not close inherited/read-once request semantics: an inherited spine prefix is treated as absence and reopens carried fallback; `Object.prototype.text_refused` does not close an own-valid claim; and the carried path is descriptor-read twice, permitting validation of one path and projection of another. The final package also marks its superseded attempt authoritative and its actual final attempt unresolved while prose/outer logs claim the reverse; logs are reused or empty and discarded markers are not retained. Make one bounded V12 from exact V11 head fixing only those sinks and issuing a fresh internally terminal, uniquely logged package. Projection/orphan-source, source-only-fragment, translator, absence, selection, refusal-typing, unreadable-root, broader-terminal/oracle, CLI/web, model-budget, data-seam, release, common-gate, B0/shared-shell, real-device/AT, protected Liturgy and PDF blockers remain open or separately owned. E1 stays off main; no merge, re-sign, deploy, or cutover is authorized. |
