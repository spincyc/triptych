...
| E1 Catena implementation | **Changes required** at V4.1 head `f93757854b54c19e50bdcb97ca0fed9b48d22bb7` (fresh independent review, 2026-08-13) | The exact voice-key projection, neutral refusal umbrella, route truth for supported and unsupported voices, budgets, package integrity, and visual matrix pass. Typed presentation does not: raw language metadata, malformed collection members, absence findings, number-like values, verse data, and malformed bootstrap records can still produce coercions, false counts or claims, lost valid siblings, or an unterminated page. Correct that boundary and its route-completion regressions, issue corrected exact-head evidence, and return for fresh review. The authorized Catena data seam is not a general ownership transfer; the historical Day-reader guard, release bindings, common gate, B0/shared shell, real device/AT evidence, protected Liturgy, and PDFs remain separately owned. E1 stays off main; no merge, re-sign, deploy, or cutover is authorized. |
