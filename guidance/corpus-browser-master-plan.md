...
| E1 Catena implementation | **Changes required** at correction head `dfc636665` (review `8f8f424ec`, 2026-08-11); second correction candidate awaiting fresh independent review | The bounded pass-2 correction preserves E0 and the four-path ownership limit while answering the route-owned URL, asynchronous-state, blocked/empty, lead, licence, print, focus, and evidence defects; the generator/data, release, common-gate, and B0/shared-shell prerequisites remain separately owned; E1 stays off main, and only a fresh exact-head independent review may follow. |
