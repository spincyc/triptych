...
| E1 Catena implementation | **Changes required at independent integration review** | One bounded correction pass must fix the two production blockers and two integration corrections recorded on `review/catena-e1-integration`, followed by one confirmation Codex review. Do not edit unrelated global shell owners or protected Liturgy, merge, deploy, or reopen broad hardening. |
