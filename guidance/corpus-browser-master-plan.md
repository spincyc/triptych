...
| E1 Catena implementation | **Changes required** at pass-2 head `17f031b37` (independent review `4c30d86f7`, 2026-08-12); third correction candidate `impl/catena-wave-1-e1-corrections-v3` awaiting fresh independent review | The bounded pass-2 correction preserves E0 and the four-path ownership limit while answering the route-owned URL, asynchronous-state, blocked/empty, lead, licence, print, focus, and evidence defects; the generator/data, release, common-gate, and B0/shared-shell prerequisites remain separately owned; E1 stays off main, and only a fresh exact-head independent review may follow. |
