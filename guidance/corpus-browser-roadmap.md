...
| E1 Catena production implementation | V6 is **CHANGES REQUIRED** at exact head `4639b139f2179b1fca7f9cb1e4ba3ac19c9bbc46` after fresh independent review, 2026-08-14 | Preserve the V6 language, voice, refusal-copy, canonical-verse, null-termination, control-byte, formal-budget and ownership-boundary passes. Correct the remaining raw-path request sink, hollow semantic members, rights-prose contradiction, unreadable-root negative claims and incomplete terminal oracles; replace inaccurate sealed-package claims with exact reproducible evidence. Begin only the smallest typed fragment/absence/refusal projection and actual-sink regressions from the reviewed head. The exact Catena seam transfers no broader ownership; release, common-gate, B0/shared-shell, Day-reader guard, real-device/AT, protected Liturgy and PDF prerequisites remain separate. E1 stays off main. No merge, re-sign, deploy or cutover. |
...
| 2026-08-14 | E1 Catena correction V6 independent review | **CHANGES REQUIRED** at exact head `4639b139f2179b1fca7f9cb1e4ba3ac19c9bbc46`. Language normalization, guessed-English removal, exact voice support, refusal umbrella copy, padded-verse deduplication, null termination, final control-byte hygiene, formal budgets and scope boundaries pass. Raw fragment properties can still carry an unvalidated `text_path` to the request sink; hollow fragment/absence/refusal members can create rows, tallies or claims; contradictory findings still select visible rights prose; unreadable bootstrap roots still manufacture negative corpus claims; and stale/failure oracles omit terminal sinks. The package's 85-member manifest, ZIP digest and privacy scan are mechanically sound, but sealed members misstate the exact head, sizes, sealer/commit/diff/pair counts and probe provenance. The previous row's statement that every V6 class fails at the parent is superseded: the shipped decomposition itself says four new classes and one corrected-oracle class do not. Fresh reruns: focused 423/423; full 1,774 with the same inherited 14 failures, 13 errors and 11 skips; browser gate 2,290 = 1,836 pass + 226 fail + 228 skip in inherited shell categories; `make -k check` exit 2 at the same three inherited targets; promise ledger valid; Catena 1,351/1/73; four stale bindings fail-closed. | Candidate parent `19982ab433dd25704ed60b1ac6ddb678bc3a98f9`; evidence `ca2a8659010b3fca2ccada24f9c431796ca702b1`; package ZIP SHA-256 `eeddfa26321398f2f67959365dae9309c7f15186011e36bc6e9cb95ab5eb6e10`. Start only the bounded typed fragment/absence/refusal correction from the exact reviewed head; no integration or release authority. |
