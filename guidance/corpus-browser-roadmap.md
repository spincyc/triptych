...
| E1 Catena production implementation | **Changes required** at exact V7 head `e876b29e5797edcc6e86422daa807f4b1104ec81` (fresh independent review on `review/catena-wave-1-e1-corrections-v7-independent`, 2026-08-15) | The arbitrary top-level raw spread is gone and the valid voice/language/refusal-umbrella/verse/null and contradiction boundaries remain sound. The projection is nevertheless not the only semantic source: orphan raw sources still create voices/absences; same-stem non-Catena paths reach requests; source-only, malformed absence/partial/refusal, and unreadable-root shapes still make claims; unreadable `bibles.json` prose is locally suppressible; full failure/late-work sink proof and several corrected oracles are incomplete; and package member/count/provenance records are internally inconsistent. Combined always-loaded route JavaScript also has no enforced ceiling. Correct from this exact head, rebuild one truthful immutable package, and obtain another fresh independent review. Preserve accepted E0 and every sound V2/V3/V4/V4.1/V5/V6/V7 correction. Release, common-gate, B0/shared-shell, Day-reader guard, real-device/AT, protected Liturgy, and PDF prerequisites remain separate. E1 stays off main. No merge, re-sign, deploy, or cutover. |
...
| 2026-08-15 | E1 Catena correction V7 independent review | **CHANGES REQUIRED** at exact candidate `e876b29e5797edcc6e86422daa807f4b1104ec81`. The review verified the top-level closed-key projection, contradiction neutrality, preserved language/voice/refusal-umbrella/verse/null boundaries, unchanged CSS/HTML/data and formal ceilings, 505 focused tests, the 2,290-assertion browser-gate identity, and inherited repository-wide failures. It reproduced V7-owned defects at production sinks: orphan raw sources create voice/absence state; same-stem wrong-namespace `text_path` values fetch and render non-Catena data; a source-only member counts as a passage; malformed absence, partial and refusal shapes create or select claims; unreadable roots and locally suppressible unreadable-bible prose manufacture negatives; failure and late-work proofs omit required sinks; corrected oracles still bless several cases; the semantic Python/web model remains duplicated; combined route JavaScript is uncapped; and the final sealed package has stale size/hash/count/provenance records plus ambiguous supersession. | Review branch `review/catena-wave-1-e1-corrections-v7-independent`; reviewed package `20260815T174121Z-catena-e1-corrections-v7.zip`, SHA-256 `823ac17da5f0c0f79e11688f088638d73a453ecd4adb58cf46dcac01c275a5b8`; evidence `92c88ab8c2d2b671009e8cf9f36aa5dd352f9b61`; current main `9b9ff74a77d1bcd7d454d2a7fc448b8a6c8f1fd4`. No candidate modification, merge, re-signing, deployment, or outside-owner work occurred. |
