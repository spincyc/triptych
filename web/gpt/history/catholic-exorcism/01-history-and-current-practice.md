...
The controlled local witnesses are not a representative survey. Laodicea, Gellone, the PRG, Parker MS 79, and the later Roman Pontifical answer different disciplinary, ritual-book, and ordinal questions; together they establish neither a universal ordination form nor identity between an early office and the priest who would later perform a major exorcism.

One local medieval witness is Cambridge, Corpus Christi College, Parker Library MS 79, an English pontifical made in stages around 1400 and 1410, places the ordination of exorcists on fols. 43r–43v between the ordinations of readers and acolytes. Its rubric summons the candidates; the bishop is shown and directed to deliver a book. This manuscript architecture establishes neither ordinary duties nor a transfer of extraordinary intervention to priests. It is one English witness, not a representative sample or proof of direct descent from the PRG.
...
An older edited witness to the collection called the *Statuta ecclesiae antiqua* supplies a narrower ministerial control. In the Ballerini text reprinted at PL 56, cols. 887–888, item 7/XCV stands inside a recapitulation of ordination offices: after the acolyte and before the lector, the exorcist receives from the bishop a booklet containing exorcisms. The sequence and delivery of a book may be compared typologically with the later PRG, Parker MS 79, and the 1895 Roman Pontifical. They do not establish identical wording, direct descent, actual practice, frequency, or identity with modern major exorcism.

The collection itself requires a further ceiling. Maassen’s 1870 survey documents materially different titles, orderings, and placements across the Hispana and multiple Gallic, systematic, and Italian collections. The current MGH *Clavis canonum* notice accordingly describes the *Statuta* as a mid-fifth-century Gallic collection not extant independently and recoverable only from later compilers. Charles Munier’s CCSL 148 reconstruction remains protected and was not acquired. Its exact text, apparatus, numbering, versional choices, stemma, and attribution to Gennadius of Marseille are therefore unaudited here.
...
Parker MS 79 supplies a geographically distinct comparison at a much later date. The exact Stanford manifest identifies the book as an English pontifical and bounds the reader, exorcist, and acolyte units; the manuscript images verify that architecture on fols. 43r–43v. The manifest catalog describes London as a probable place of production and proposes successive patrons or owners from heraldic and codicological evidence. Those details remain catalog inferences, not facts independently established here. The similar ordinal position and book-delivery architecture may be compared with the PRG and the 1895 Roman Pontifical, but they do not establish textual identity, direct descent, continuity of use, or continuity with modern major exorcism.
...
The exact controls retained here establish a baptismal formulary in Wilson’s Gelasian edition, a bounded Gellone manuscript sequence, an older edited *Statuta* witness to book delivery within an ordination sequence, the architecture of the PRG exorcist-ordination unit and one later English pontifical comparison, and Aquinas’s theological distinction between baptismal preparations and the sacrament’s effect. They do not establish one unchanged medieval script or a uniform practice. The *Rituale Romanum* of 1614 belongs to a later, separately controlled stage of the history.
...
**Last revised (UTC):** 2026-07-28T05:30:04Z
