...
The three loci therefore establish an intellectual argument, not an operational protocol. They supply no diagnostic signs by which a reader could classify another person. They do not set out the authorization of a minister, the privacy due to an afflicted person, or a complete sequence of words and acts. They cannot prove the cause of a modern presentation, and they cannot license an unauthorized reader to imitate the activity under discussion.

Nor are Tertullian and Origen two independent measurements of success. They are two Christian advocates writing in different settings. Their agreement that Christian deliverance should be distinguished from magic is important reception evidence. It does not establish a rate, an unchanged formula, or a single early-Christian institution. Their disagreement in argumentative form is equally important: Tertullian’s imagined tribunal and Origen’s learned reply show how one Christian claim could be deployed through quite different literary strategies.
...
One local medieval witness can now be named. Cambridge, Corpus Christi College, Parker Library MS 79, an English pontifical made in stages around 1400 and 1410, places the ordination of exorcists on fols. 43r–43v between the ordinations of readers and acolytes. Its rubric summons the candidates; the bishop is shown and directed to deliver a book. This manuscript architecture establishes neither the ordinary duties of officeholders nor actual performance, frequency, efficacy, career paths, or a transfer of extraordinary intervention to priests. It is one English witness, not a representative sample and not proof of direct descent from the PRG.
...
**Last revised (UTC):** 2026-07-28T05:11:00Z
