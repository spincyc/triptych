...
**Where the registered English does not answer the Latin.** *First*, the antiphon’s closing vocative *protéctor meus, Dómine* has no counterpart in Psalm 53 and therefore none in the Douay–Rheims. Nothing in the registered public-domain English answers it, and this guide does not supply a rendering of its own. What it asks is plain enough to describe: after the imprecation, the singer turns and addresses God directly by the title the psalm had used of him in the third person a line earlier. *Second*, at the psalm verse the missal sings *líbera me* where the Clementine reads *judica me*; the Douay renders the Clementine, “and judge me in thy strength,” so it cannot be quoted for the missal’s verb, and no other registered public-domain witness carries this chant’s text. The divergence is left standing rather than papered over. *Third*, and least consequentially, the Douay’s opening “For” at v. 6 renders the *enim* the antiphon drops, so the English printed above begins one word longer than the antiphon does.
...
Here the chant and the Vulgate agree exactly, and the Douay silently proves the guide’s point about the chant’s construction: the whole Gradual, respond and verse together, is one verse of the Douay–Rheims, printed as a single sentence. The division into respond and verse falls on the *quóniam* that the Douay renders “For,” so that the responsorial form itself carries a logical relation: the wonder, then its reason.
