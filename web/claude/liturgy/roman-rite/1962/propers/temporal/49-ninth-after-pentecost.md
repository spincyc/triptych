...
| “there fell in one day three and twenty thousand” (v. 8) | Numbers 25: Baal-Peor | Numbers 25:9 reads *viginti quattuor milia* — four and twenty thousand — and so do the Hebrew and the Greek. No witness to Numbers gives twenty-three thousand: the difference is Paul’s, and it is left standing |
...
The appointed verse matches the Clementine psalter word for word — one of only two appointed scriptural texts of which that is true — so the Douay answers it directly and no gap has to be declared. Augustine, however, was reading an Old Latin text: his lemma runs *Erue me de inimicis meis, Deus meus, et ab insurgentibus super me redime me*, with different verbs in both halves. His exegesis is of that text.
...
The Offertory is the one appointed element for which no continuous English exists, because no continuous Latin exists either: the antiphon is built out of four separated parts of four verses. Rather than stitch the Douay into a seamless paragraph and present the seam as a translation, the four verses are given whole, with the parts the antiphon takes marked.
...
**Last revised (UTC):** 2026-09-24T12:21:08Z
