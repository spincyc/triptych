...
| roman-1962 | sanctoral | 307 | 993 | 166 |
...
| Masses | 490 | 268 |
| Propers | 2318 | 1031 |
| — named `Placeholder` | 184 | 210 |
| — inside a `forms` block | 97 | 117 |
| — carrying a `cycles` mapping | 0 | 252 |
| Masses holding only placeholders | 182 | 205 |
| Masses taking a formulary from another entry | 11 | 0 |
| Propers taking their text from another entry | 40 | 0 |
| Propers that are not placeholders | 2134 | 821 |
