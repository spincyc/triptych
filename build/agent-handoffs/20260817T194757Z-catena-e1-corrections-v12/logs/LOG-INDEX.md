...
- attempt: parent-20260817T192557Z-02yqk58r
- log root: attempt-02 (under logs/)
- tree at preflight: clean
- tree at postflight: clean

- `logs/attempt-02/focused-catena-parent.log`
    - slug focused-catena; order 1; exit 0; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/catena-check-parent.log`
    - slug catena-check; order 2; exit 0; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/promised-parent.log`
    - slug promised; order 3; exit 0; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/full-discovery-parent.log`
    - slug full-discovery; order 4; exit 1; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/make-check-parent.log`
    - slug make-check; order 5; exit 2; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/release-bindings-parent.log`
    - slug release-bindings; order 6; exit 2; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/public-site-parent.log`
    - slug public-site; order 7; exit 0; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/browser-gate-parent.log`
    - slug browser-gate; order 8; exit 1; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/gzip-sizes-parent.log`
    - slug gzip-sizes; order 9; exit 0; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after clean
- `logs/attempt-02/head-tests-against-parent.log`
    - slug head-tests-against-parent; order 10; exit 1; attempt parent-20260817T192557Z-02yqk58r
    - tree before clean; after DIRTY: 1 entries, 36 bytes; NOT CLEAN
- `logs/attempt-02/request-journals-parent.log`
    - slug request-journals; order 11; exit 0; attempt parent-20260817T192557Z-02yqk58r
    - tree before DIRTY: 1 entries, 36 bytes; NOT CLEAN; after DIRTY: 1 entries, 36 bytes; NOT CLEAN
- `logs/attempt-02/restore-parent-tree.log`
    - slug restore-parent-tree; order 12; exit 0; attempt parent-20260817T192557Z-02yqk58r
    - tree before DIRTY: 1 entries, 36 bytes; NOT CLEAN; after clean

## HEAD battery

- ledger: `logs/order-head.txt`
- attempt: head-20260817T191110Z-01x4g2mm
- log root: attempt-01 (under logs/)
- tree at preflight: clean
- tree at postflight: clean

- `logs/attempt-01/focused-catena-head.log`
    - slug focused-catena; order 1; exit 0; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/catena-check-head.log`
    - slug catena-check; order 2; exit 0; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/promised-head.log`
    - slug promised; order 3; exit 0; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/full-discovery-head.log`
    - slug full-discovery; order 4; exit 1; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/make-check-head.log`
    - slug make-check; order 5; exit 2; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/release-bindings-head.log`
    - slug release-bindings; order 6; exit 2; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/public-site-head.log`
    - slug public-site; order 7; exit 0; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/browser-gate-head.log`
    - slug browser-gate; order 8; exit 1; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/browser-static-head.log`
    - slug browser-static; order 9; exit 0; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/gzip-sizes-head.log`
    - slug gzip-sizes; order 10; exit 0; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
- `logs/attempt-01/request-journals-head.log`
    - slug request-journals; order 11; exit 0; attempt head-20260817T191110Z-01x4g2mm
    - tree before clean; after clean
...
- `logs/attempt-01/browser-gate-head.json` -- the gate's own JSON report, written by the recorded command; the log beside it is the short transcript
- `logs/attempt-02/browser-gate-parent.json` -- the gate's own JSON report, written by the recorded command; the log beside it is the short transcript
- `logs/attempt-05/gate-comparison.log` -- P1: the two gate reports compared object for object, as a recorded pipeline step
...
- `logs/v11-authority-reproduction.txt` -- (no role declared for this member)
...
- `logs/attempt-05/sealer-tests.log` -- P1: the sealer's own test suite
- `logs/attempt-05/seal.log` -- P2: every normalization pass, appended
- `logs/attempt-05/seal-check.log` -- P2: the check-only pass that closed the fixpoint
- `logs/attempt-05/derive-claims.log` -- P4: the derivation, as it printed
- `logs/attempt-05/head-consistency.log` -- P5: the consistency audit
