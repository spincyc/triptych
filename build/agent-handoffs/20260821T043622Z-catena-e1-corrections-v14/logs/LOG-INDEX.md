...
- attempt: parent-20260821T034821Z-04h7q7g5
- log root: attempt-04 (under logs/)
- tree at preflight: clean
- tree at postflight: clean

- `logs/attempt-04/focused-catena-parent.log`
    - slug focused-catena; order 1; exit 0; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/catena-check-parent.log`
    - slug catena-check; order 2; exit 0; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/promised-parent.log`
    - slug promised; order 3; exit 0; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/full-discovery-parent.log`
    - slug full-discovery; order 4; exit 1; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/make-check-parent.log`
    - slug make-check; order 5; exit 2; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/release-bindings-parent.log`
    - slug release-bindings; order 6; exit 2; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/public-site-parent.log`
    - slug public-site; order 7; exit 0; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/browser-gate-parent.log`
    - slug browser-gate; order 8; exit 1; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/gzip-sizes-parent.log`
    - slug gzip-sizes; order 9; exit 0; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after clean
- `logs/attempt-04/head-tests-against-parent.log`
    - slug head-tests-against-parent; order 10; exit 1; attempt parent-20260821T034821Z-04h7q7g5
    - tree before clean; after DIRTY: 1 entries, 36 bytes; NOT CLEAN
- `logs/attempt-04/request-journals-parent.log`
    - slug request-journals; order 11; exit 0; attempt parent-20260821T034821Z-04h7q7g5
    - tree before DIRTY: 1 entries, 36 bytes; NOT CLEAN; after DIRTY: 1 entries, 36 bytes; NOT CLEAN
- `logs/attempt-04/restore-parent-tree.log`
    - slug restore-parent-tree; order 12; exit 0; attempt parent-20260821T034821Z-04h7q7g5
    - tree before DIRTY: 1 entries, 36 bytes; NOT CLEAN; after clean

## HEAD battery

- ledger: `logs/order-head.txt`
- attempt: head-20260821T040548Z-05m4n52m
- log root: attempt-05 (under logs/)
- tree at preflight: clean
- tree at postflight: clean

- `logs/attempt-05/focused-catena-head.log`
    - slug focused-catena; order 1; exit 0; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/catena-check-head.log`
    - slug catena-check; order 2; exit 0; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/promised-head.log`
    - slug promised; order 3; exit 0; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/full-discovery-head.log`
    - slug full-discovery; order 4; exit 1; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/make-check-head.log`
    - slug make-check; order 5; exit 2; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/release-bindings-head.log`
    - slug release-bindings; order 6; exit 2; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/public-site-head.log`
    - slug public-site; order 7; exit 0; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/browser-gate-head.log`
    - slug browser-gate; order 8; exit 1; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/browser-static-head.log`
    - slug browser-static; order 9; exit 0; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/gzip-sizes-head.log`
    - slug gzip-sizes; order 10; exit 0; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
- `logs/attempt-05/request-journals-head.log`
    - slug request-journals; order 11; exit 0; attempt head-20260821T040548Z-05m4n52m
    - tree before clean; after clean
...
- `logs/attempt-04/browser-gate-parent.json` -- the gate's own JSON report, written by the recorded command; the log beside it is the short transcript
- `logs/attempt-05/browser-gate-head.json` -- the gate's own JSON report, written by the recorded command; the log beside it is the short transcript
- `logs/attempt-13/gate-comparison.log` -- P1: the two gate reports compared object for object, as a recorded pipeline step
...
- `logs/attempt-13/sealer-tests.log` -- P1: the sealer's own test suite
- `logs/attempt-13/seal.log` -- P2: every normalization pass, appended
- `logs/attempt-13/seal-check.log` -- P2: the check-only pass that closed the fixpoint
- `logs/attempt-13/derive-claims.log` -- P4: the derivation, as it printed
- `logs/attempt-13/head-consistency.log` -- P5: the consistency audit
