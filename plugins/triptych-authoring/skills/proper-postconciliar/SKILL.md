...
- Sunday or weekday cycle, proper and optional readings, selected presidential texts, chant sources, and other options to include.
- Desired analytical depth, comparison boundaries, source links, copyright constraints, and all free-form context, guides, limits, staging, or commit instructions.
...
3. Present the celebration’s operative structure and options before analysis. State why a choice is representative, prescribed, permitted, or merely illustrative.
4. Ground unit-by-unit exposition in the exact text and its biblical, patristic, liturgical, historical, and theological context. Calibrate claims about composition, reform, continuity, and discontinuity.
5. Treat current rubrics, calendar rules, sacramental discipline, permissions, and particular law as mutable facts with competent authority, jurisdiction, and as-of date.
6. Refresh generation metadata, build and visually inspect the complete PDF, install it, and update the README’s separate artifact columns when publication is authorized.

## Verification

Check edition and territory identity, cycles and options, official approvals, text ownership and quotation limits, mutable discipline, every source-record entry, generation metadata, PDF page, installed artifact, and catalog link under the postconciliar and universal gates.

## Summary

Report the exact celebration, editions and territory, selected cycles or options, source and copyright treatment, records and artifacts changed, verification, authorized commit, and any unavailable official text or unresolved jurisdictional issue.

## Next Steps

Name the one edition witness, episcopal source, liturgical review, or copyright determination most important next.
