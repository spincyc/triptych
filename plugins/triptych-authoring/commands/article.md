---
description: Create or substantially revise a source-audited Catholic faith, theology, canon-law, or mixed article.
argument-hint: "<question, title, or target> [thesis, sources, jurisdiction, as-of date, free-form guidance and limits]"
---
...
1. Apply `commands/_conventions.md` and read `guidance/articles.md` completely.
