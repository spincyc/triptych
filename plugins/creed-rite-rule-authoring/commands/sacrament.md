...
- Governing doctrinal texts, liturgical books, canon law, particular discipline, territory, Church, and as-of date where relevant.
- Known affected matrix cells, summaries, at-a-glance pages, ritual guides, or other consumers, plus all free-form context, guides, limits, staging, or commit instructions.
...
3. Update every logically affected section, master-matrix cell, lexicon entry, canonical one-page summary, research record, and structured generation-metadata field in the same coherent stage.
4. Keep the at-a-glance work mechanically derived: it imports canonical material, carries inherited provenance, and receives no independent theological prose or editable copy.
5. Update current discipline with the governing body of law, competent authority, jurisdiction, effective or as-of date, and pertinent amendments or interpretations.
6. Rebuild the treatise, at-a-glance companion, and every ritual guide that imports an affected summary. Confirm summary one-page boundaries, table readability, import identity, and metadata behavior.
7. Install every reviewed affected PDF and update separate README artifact columns only where identities or links changed.

## Verification

Run the sacramental-reference gates across the canonical source and all consumers: doctrinal and legal accuracy, matrix/section/summary agreement, single textual ownership, inherited provenance, twenty-four-Church table, seven one-page summaries, dependency rebuilds, warnings, every-page inspection, and installed/build identity.

## Summary

Report the canonical theological change, authorities and currentness boundary, affected fragments and consumers, PDFs rebuilt, verification, authorized commit, and unresolved doctrinal, canonical, liturgical, or Eastern Catholic review.

## Next Steps

Name the single specialist review or primary-source check most consequential to the revised sacramental material.
