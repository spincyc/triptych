---
name: tpt-xhigh
description: Triptych tpt workflow stage or lane worker dispatched at reasoning effort xhigh, which is the level the workflow declares for that stage. Not for direct invocation; the driver selects it from the packet's EFFORT header.
model: inherit
effort: xhigh
---
